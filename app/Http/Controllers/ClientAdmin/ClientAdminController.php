...
class ClientAdminController extends Controller
{
    ...
    protected $ClientAdminRepository;

    // protected $LeavesDashboardservice;
    ...
    {
        try {
            return $this->ClientAdminRepository->registered_empcode();
        } catch (\Exception $e) {
...
//    }
    ...
    {
        $arr1 = DB::connection('sqlsrv')->table("tb_users")->select('tour_status', 'update_sender')->where('email', '=', username())->where('company_id', '=', company_id())->first();
        return array(
