                ...
                <div class="noprint content-header row">
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <router-link to="/Inventory/GRN" style="text-decoration: none;">GRN Detail(s)</router-link>
                            </li>
                        ...
                        <div class="row invoice-add">
                            ...
                            <div class="col-xl-9 col-md-8 col-12">
                                <div class="card invoice-preview-card">
                                        ...
                                        <div class="row row-bill-to invoice-spacing" style="margin-top:0px">
                                            ...
                                            <div class="col-xl-4 p-0 ps-xl-2 mt-xl-0 mt-2">
                                                ...
                                                <div class="invoice-customer">
                                                    ...
                                                    <input type="text" v-model="poid" class="form-control" hidden />
                                                    <input type="text" v-model="reqid" hidden class="form-control" />
                                                        ...
                                                        <div class="col-12 d-flex product-details-border position-relative pe-0">
                                                            ...
                                                            <div class="row w-100 pe-lg-0 pe-1 py-2">
                                                                ...
                                                                <div class="col-lg-2 col-12 my-lg-0 my-2">
                                                                    ...
                                                                    <input name="third[]" readonly type="number" class="form-control" :value='get_po_detail11.Quantity' style="text-align:center" />
                                                                    <label class="card-text">Recieved Qty</label>
                                                                    <input  readonly type="number" class="form-control" :value='Math.floor(get_po_detail11.ReceivedQuantity).toLocaleString()' style="text-align:center" />
                                                                </div>
                                                                <div class="col-lg-2 col-12 my-lg-0 my-2">
                                                                    <p class="card-text col-title mb-md-2 mb-0">Add Qty</p>
                                                                    <textarea @keypress="onlyNumber" @change="sum_total()" style="min-height: 0px !important;padding: 5px !important;margin-top: 0px !important; text-align: center;" class="form-control mt-2" rows="1" name="fourth[]" placeholder="0"></textarea>
                                                                    <label class="card-text">Pending Qty</label>
                                                                    <input style="padding-left:0px;padding-right:0px;text-align:center" readonly class="form-control" :value='get_po_detail11.Quantity - get_po_detail11.ReceivedQuantity' />
                                                                </div>
                                                                <div class="col-lg-2 col-12 mt-lg-0 mt-2">
                                                                    <p class="card-text col-title mb-md-2 mb-0">Unit Cost</p>
                                                                    <textarea @keypress="onlyNumber" @change="sum_total()" style="min-height: 0px !important;padding: 5px !important;margin-top: 0px !important;" class="form-control mt-2" rows="1" name="fiveth[]">{{get_po_detail11.Price}}</textarea>
                                                                    <label class="card-text">Date of Expiry</label>
                                                                    <input name="sixth[]" type="date" class="form-control" />
                                                                </div>
                                                                <div class="col-lg-2 col-12 mt-lg-0 mt-2">
                                                                    <p class="card-text col-title mb-md-2 mb-0">Total Price</p>
                                                                    <p style="margin-top: 30px;border-radius: 2px;padding-left: 10px;max-width: 100px;height: 35px;" :id="'demo_'+(index)" class="form-control card-text col-title mb-md-50 mb-0">{{Math.floor(get_po_detail11.SubTotal)}}</p>
                                                                    <p class="card-text col-title mb-md-2 mb-0" style="margin-top: 65px;border-radius: 2px;padding-left: 10px;max-width: 100px;height: 35px;" >Unit</p>
                                                                    <input style="padding-left:0px;padding-right:0px;text-align:center;margin-top: 55px;" name="second[]" readonly class="form-control" :value='get_po_detail11.Unit' />
                                    ...
                                    <div class="card-body invoice-padding" v-if="grn_po!=''">
                                        <div class="row invoice-sales-total-wrapper">
                                            <div class="col-md-6 order-md-1 order-1 mt-md-0 mt-3">
                                                <div class="row form-row mt-50" style="border: 1px solid lightgrey;padding-top: 10px;padding-bottom: 10px;border-radius: 5px !important;">
                                                    ...
                                                    <div style="display:none" class="mb-1 col-md-12">
                                            ...
                                            <div class="col-md-6 d-flex justify-content-end order-md-2 order-2">
                                                <div class="invoice-total-wrapper" style="max-width: 300px;">
                                                    ...
                                                    <div class="invoice-total-item">
                                                        ...
                                                        <p class="invoice-total-amount">
                                                            <input v-model="delivery_amount" type="number" value="0" class="form-control" />
                                                        </p>
                                                    </div>
                            ...
                            <div class="col-xl-3 col-md-4 col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex">
                                            <span>
                                                <img v-if="url" :src="url" id="account-upload-img" class="uploadedAvatar rounded me-50" alt="profile image" style="width:100%;">
                                                <img v-else src="public/images/grn_images/document.jpg" id="account-upload-img" class="uploadedAvatar rounded me-50" alt="profile image" style="width:100%;">
                                            </span>
                                        </div>
                                        <div class="d-flex align-items-end mt-75 ms-1">
                                            <div>
                                                <button type="button" @click="clear_image()" id="account-reset" class="btn btn-sm btn-outline-secondary mb-75 waves-effect">Clear image</button>
                                                <h6 class="invoice-to-title" style="margin-bottom:5px">Attach GRN <span style="color: #DB4437; font-size: 11px;">*</span></h6>
                                            </div>
                                        </div>
                                ...
                                <hr/>
                                        <table v-if="get_po_detail1.length>0">
                               <h6 class="mb-2" style="font-weight:bold">PO Balance:</h6>
                               <tbody v-for="ledger_d_detail1 in get_po_detail1">
                                   <tr>
                                       <td class="pe-1">Item name:</td>
                                       <td>{{ledger_d_detail1.ItemName}}</td>
                                   </tr>
                                   <tr>
                                       <td class="pe-1">Received Qty:</td>
                                       <td>{{Number(ledger_d_detail1.ReceivedQuantity).toLocaleString()}}</td>
                                   </tr>
                                   <tr>
                                       <td class="pe-1">Received Amount:</td>
                                       <td>{{Number(ledger_d_detail1.ReceivedQuantity*ledger_d_detail1.Price).toLocaleString()}}</td>
                                   </tr>
                                   <tr>
                                       <td class="pe-1">Remaining Qty:</td>
                                       <td><strong>{{Number(ledger_d_detail1.Quantity-ledger_d_detail1.ReceivedQuantity).toLocaleString()}}</strong></td>
                                   </tr>
                                   <tr>
                                       <td class="pe-1">Remaining Amount:</td>
                                       <td><strong>{{Number((ledger_d_detail1.Quantity-ledger_d_detail1.ReceivedQuantity)*ledger_d_detail1.Price).toLocaleString()}}</strong></td>
                                   </tr>
                                   <tr></tr>
                               </tbody>
                           </table>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            handleStatus(){
                    ...
                    for (var g = 0; g < ordrqty.length; g++) {
                        var c = ordrqty[g];
                        cValues.push(parseFloat(c.value));

                    }
                        for (var h = 0; h < qty.length; h++) {
                        var d = qty[h];
                        dValues.push(parseFloat(d.value));
            ...
            issue_grn() {
                this.handleStatus();
                if(this.equal && this.status == 'Fully Completed')
                {
                   this.$toastr.e('Status cannot be Fully Completed as Received Quantity is less than Ordered Quantity', 'Error');
                   return
                }
                else if(this.check && this.status == 'Partially Completed'){
                   this.$toastr.e('Status cannot be Partially Completed as Received Quantity is equal to Ordered Quantity', 'Error');
                    return;
                }
                if (this.grn_po == '' || this.grn_po == null || this.vendor == '' || this.invoice_no == '' || this.status == '') {

                    if (this.vendor == '' && this.grn_po != '') {
                    ...
                    if (this.status == '') {
                        this.e_status = 'Select PO status';
                    }
                    else {
                        this.e_status = '';
                    }
                    ...
                    if (this.image == '' || this.image.name == '') {
                        this.image_e = 'Please attach image';
                    }
                    else {
                        this.image_e = '';
                    }
                ...
                else if (this.image == '' || this.image.name == '') {
                    this.$toastr.e("You cannot proceed GRN without an attachment!", "Caution!");
                    this.image_e = 'Please attach image';
               return;
           }
                else {
                    ...
                    var dateexp = document.getElementsByName('sixth[]');
                    ...
                    if(isZero){
                            this.$toastr.e("Add valid quantity amount", "Errors!");
                           return ;
                        }
                    ...
                    for (var x = 0; x < dateexp.length; x++) {
                        var dt = dateexp[x];
                        p = p + "|" + dt.value;
                    }
                    ...
                    formData.append('ordrqty', m);
                    formData.append('qty', n);
                    formData.append('unit', o);
                    formData.append('cost', l);

                    formData.append('dateexpiry', p);
                    formData.append('detail', itemdetail);
                    ...
                    axios.post('./accounts/insert_grn9', formData)

                        .then(data => {
                            if (data.data == "submitted") {
                                this.$toastr.s("New GRN added Successfully", "Congratulations!");
                                this.$router.push({ name: 'grn_detail' })
                            }
                            else {
        ...
        mounted() {
            ...
            axios.get('./accounts/get_POdetail9')
                .then(response => {
                    this.get_vendors = response.data;
                    this.options = [];
                    this.options = this.get_vendors.map((po) => ({
                        id: po.PurchaseOrderID,
                        label: `${po.PoCode}` + ' ' + `${po.VendorName}` + ' (For ' + `${po.DepartmentName}` + '-' + `${po.ProjectName}` + ')',
                    }));
                }
                )
