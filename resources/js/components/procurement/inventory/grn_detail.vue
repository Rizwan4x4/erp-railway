                    ...
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item">
                                <router-link to="/dashboards/procurement" style="text-decoration: none;">Procurement
                ...
                <div class="content-body">
                    ...
                    <section class="app-user-list">
                        ...
                        <div class="card top-radius bottom-radius border-0">
                                    ...
                                    <div class="col-md-12">
                                        <div class="row g-1">
                                            ...
                                            <div class="col-md-2 user_plan">
                                                ...
                                                <select v-model="status1" class="form-select mb-md-0 ">
                                            ...
                                            <div class="col-md-2 user_status">
                                                <label class="form-label"><img class="px-1" :src="images.solar_filter_linear" alt="icon">Checked Status</label>
                                                <select v-model="status2" class="form-select text-capitalize mb-md-0 ">
                                                    <option value="All">All Status</option>
                            ...
                            <div class="d-flex justify-content-between align-items-center header-actions  row p-2">
                                <div class="col-sm-12 col-lg-12 ps-xl-75 ps-0">
                                    <div
                                        class="dt-action-buttons d-flex align-items-center justify-content-center justify-content-lg-end flex-lg-nowrap flex-wrap">
                                        <div class="col-md-2 me-1">
                                            <router-link v-if="hasPermission('Inventory Grn create-grn')"
                                                to="/Inventory/create_grn"
                                                class="dt-button add-new btn btn-primary bg-primary" tabindex="0"
                                                type="button"><span>+ Create GRN</span></router-link>
                                        </div>
                                        <!-- <div class="col-md-6 me-1"></div> -->
                                        <div class="col-md-4 ">
                                            <input type="text" v-model="keyword1" class="form-control"
                                                placeholder="Search by Vendor name / GRN / INV / PO id" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <tr v-for="adsdata1 in adsdata.data">
                                                ...
                                                <div class="d-flex justify-content-left align-items-center">
                                                    <div class="d-flex flex-column"><a
                                                            class="user_name text-truncate text-body"><span
                                                                class="fw-bolder">{{ adsdata1.DepartmentName }}</span></a><small
                                                            class="emp_post text-muted">{{ adsdata1.ProjectName }}</small>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="td-center">
                                            ...
                                            <td class="td-center">
                                                <a @click="editgrn(adsdata1.GrnOrderID)" data-bs-toggle="modal"
                                                    ...
                                                    <span
                                                        class="badge badge-glow bg-warning">{{ adsdata1.Status2 }}</span>
                                                </a>
                                            ...
                                            <td class="td-center">
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <a class="dropdown-item" @click="editgrn(adsdata1.GrnOrderID)"
                                                            data-bs-toggle="modal" data-bs-target="#PREQ_view">
                                                            <i class="fa-solid fa-eye"></i>
                                                            View GRN
                                                        </a>
                                                        <a v-if="adsdata1.Status2 == 'Not Verified'"
                                                            class="dropdown-item" @click="editgrn(adsdata1.GrnOrderID)"
                                                            data-bs-toggle="modal" data-bs-target="#PREQ_viewDelete">
                                                            <i class="fa-solid fa-trash"></i>
                                                            Delete GRN
                                                        </a>

                                                        <a class="dropdown-item" target="_blank"
                                                            v-bind:href="`Accounts/Grn_letter/${adsdata1.GrnOrderID}/${adsdata1.GrnID}`">
                                                            <i class="fa-solid fa-print"></i>
                                                            Print GRN
                                                        </a>
                                                        <a class="dropdown-item" target="_blank"
                                                            v-bind:href="`Accounts/pi_Letter/${adsdata1.ReceavingOrderID}/${adsdata1.FormID}`">
                                                            <i class="fa-solid fa-print"></i>
                                                            Print Invoice
                                                        </a>
                                            ...
                                            <td class="td-center">
                                                <div class="d-flex justify-content-left align-items-center">
                                                    <div class="d-flex flex-column">
                                                        ...
                                                        <span v-if="adsdata1.status8 == 'Verified'"
                                                            class="badge bg-success">{{ adsdata1.status8 }}</span>
                                                        <span
                                                            v-else-if="adsdata1.Status2 == 'Verified' && adsdata1.status8 == 'Not Verified'"
                                                            @click="editgrn2(adsdata1.ReceavingOrderID)"
                                                            data-bs-toggle="modal" data-bs-target="#PREQ_status2"
                                                            class="badge badge-glow bg-warning">{{ adsdata1.status8 }}</span>
                                                        <span v-else
                                                            class="badge bg-light-warning">{{ adsdata1.status8 }}</span>
                                                    </div>
                                                </div>
                                            </td>
        ...
        <a target="_blank" v-bind:href="`Accounts/pi_Letter/${adsdata1.ReceavingOrderID}/${adsdata1.FormID}`" class="btn btn-sm">
            <i class="fa-solid fa-print"></i>
                            ...
                            <div style="text-align:center; padding-top:20px">
                                <pagination :limit="limit" :data="adsdata" v-if="pageNo == 2"
                                    @pagination-change-page="getResults"></pagination>
                                <pagination :limit="limit" :data="adsdata" v-if="pageNo == 1"
                                    @pagination-change-page="getResult"></pagination>
                                <pagination :limit="limit" :data="adsdata" v-if="pageNo == 3"
                                    @pagination-change-page="filtered_GRN"></pagination>
                            </div>
                        </div>
                    </section>
                    <!-- users list ends -->
                ...
                <div class="modal-content">
                    ...
                    <div class="col-xl-12 col-md-12 col-12">
                        <div class="card invoice-preview-card" v-for="get_grndata811 in get_grndata8">
                                    ...
                                    <div class="mt-md-0 mt-2" style="min-width:25%">
                                        ...
                                        <div class="invoice-date-wrapper row">
                                            ...
                                            <p style="width:65%" class="invoice-date">
                                                <span v-if="get_grndata811.Status2 == 'Verified'"
                                                    class="badge badge-glow bg-success">Verified</span>
                                                <span v-if="get_grndata811.Status2 == 'Issued'"
                                                    class="badge badge-glow bg-warning">Issued</span>
                                                <span v-if="get_grndata811.Status2 == 'Not Verified'"
                                                    class="badge badge-glow bg-info">Not Verified</span>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="divider">
                                <div class="divider-text" style="font-size: 24px;font-weight: 900;">Update Invoice
                                    Status</div>
                            </div>
                            ...
                            <div class="card-body invoice-padding pt-0">
                                <div class="row invoice-spacing">
                                    ...
                                    <div class="col-xl-6 p-0">
                                        ...
                                        <p class="card-text mb-25"><span
                                                class="badge badge-glow bg-warning">{{ get_grndata811.Status }}</span></p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr v-for="get_grndata21 in get_grndata81">
                                            ...
                                            <td class="py-1">
                                                <span
                                                    class="fw-bold">{{ Math.floor(get_grndata21.SubTotal).toLocaleString() }}</span>
                                            </td>
                                            <td class="py-1">
                                    ...
                                    <div class="col-md-8 order-md-1 order-1 mt-md-0 mt-3">
                                        ...
                                        <div class="col-12  mt-2 pt-50 row">
                                            ...
                                            <div class="col-6 col-md-6">
                                                <p class="card-text mb-0"><span style="width:100%"
                                                        class="fw-bold">Update Status:</span></p>
                                                <select v-model="eup_sts" class="form-select mb-md-0 mb-2">
                                                    <option value="">Select Status</option>
                                                    <option value="Verified">Verified</option>
                                                </select>
                                                <span style="color: #DB4437; font-size:11px;"
                                                    v-if="eup_sts == ''">{{ e_up_sts }}</span>
                                            </div>
                                            <div class="col-md-5" style="margin-top:21px">
                                                <button :disabled="disabled8" @click="delay8()" type="submit"
                                    ...
                                    <div class="col-md-4 d-flex justify-content-end order-md-2 order-1">
                                        <div class="invoice-total-wrapper" style="min-width: 200px;">
                                            <div class="invoice-total-item">
                                                <p class="invoice-total-title"> SubTotal: {{ currency }}.
                                                    {{ Number(get_grndata811.SubTotal) }}</p>
                                            </div>
                                            <div class="invoice-total-item">
                                                <p class="invoice-total-title"> Tax: {{ currency }}.
                                                    {{ Number(get_grndata811.Tax) }}</p>
                                            </div>
                                            <div class="invoice-total-item">
                                                <p class="invoice-total-title"> Delivery : {{ currency }}.
                                                    {{ Number(get_grndata811.ShippingCharges) }}</p>
                                            </div>
                                            <div class="invoice-total-item">
                                                <p class="invoice-total-title"> Discount: {{ currency }}.
                                                    {{ Number(get_grndata811.Discount) }}</p>
                                            </div>
                                            <div class="invoice-total-item">
                                                <p style="font-weight:bold" class="invoice-total-title"> Total:
                                                    {{ currency }}. {{ Number(get_grndata811.TotalAmount) }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="col-xl-12 col-md-12 col-12">
                        <div class="card invoice-preview-card" v-for="get_grndata11 in get_grndata">
                                ...
                                <div
                                    ...
                                    <div class="mt-md-0 mt-2" style="min-width:25%">
                                        ...
                                        <div class="invoice-date-wrapper row">
                                            <p class="invoice-date-title" style="width:35%">Status:</p>
                                            <p style="width:65%" class="invoice-date">
                                                <span v-if="get_grndata11.Status2 == 'Verified'"
                                                    class="badge badge-glow bg-success">Verified</span>
                                                <span v-if="get_grndata11.Status2 == 'Issued'"
                                                    class="badge badge-glow bg-warning">Issued</span>
                                                <span v-if="get_grndata11.Status2 == 'Not Verified'"
                                                    class="badge badge-glow bg-info">Not Verified</span>
                                            </p>
                                        </div>
                                    </div>
                            ...
                            <div class="divider">
                                <div class="divider-text" style="font-size: 24px;font-weight: 900;">Update GRN Status
                                </div>
                            </div>
                            <!-- Address and Contact starts -->
                            <div class="card-body invoice-padding pt-0">
                                <div class="row invoice-spacing">
                                    ...
                                    <div class="col-xl-4 p-0 mt-xl-0 mt-2">
                                        ...
                                        <p class="card-text mb-25"><span class="badge badge-glow
                                            bg-warning">{{ get_grndata11.Status }}</span></p>
                                    </div>
                                </div>
                            </div>
                            <!-- Address and Contact ends -->
                            ...
                            <div class="card-body invoice-padding pb-0">
                                <div class="row invoice-sales-total-wrapper">
                                    ...
                                    <div class="col-6 col-md-6 order-2">
                                        <p class="card-text mb-0"><span style="width:100%" class="fw-bold">Update
                                                Status:</span></p>
                    ...
                    <div class="modal-body pb-5 px-sm-5 pt-50">
                        <div class="text-center mb-2">
                            ...
                            <div class="text-center">
                                <button type="button" @click="delete_GRN(get_id)"
                ...
                <div class="modal-content">
                    ...
                    <div class="col-xl-12 col-md-12 col-12">
                        <div class="card invoice-preview-card" v-for="get_grndata11 in get_grndata">
                            ...
                            <div class="divider">
                                <div class="divider-text" style="font-size: 24px;font-weight: 900;">Goods Received Note
                                </div>
                            </div>
                            <!-- Address and Contact starts -->
                            <div class="card-body invoice-padding mx-3 pt-0">
                                <div class="row invoice-spacing">
                                    ...
                                    <div class="col-xl-4 p-0 mt-xl-0 mt-2">
                                        ...
                                        <p class="card-text mb-25">{{ get_grndata11.ProjectName }}</p>
                                        <p class="card-text mb-25"><span
                                                class="badge badge-glow bg-warning">{{ get_grndata11.Status }}</span></p>
                                    </div>
                                </div>
                            </div>
                            <!-- Address and Contact ends -->
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr v-for="get_grndata21 in get_grndata1">
                                            ...
                                            <td class="py-1"><span class="fw-bold">{{ get_grndata21.PoQuantity }}</span>
                                            </td>
                                            <td class="py-1"><span class="fw-bold">{{ get_grndata21.Unit }}</span></td>
                                            <td class="py-1"><span
                                                    class="fw-bold">{{ get_grndata21.RecvdQuantity }}</span></td>
                                            <td class="py-1"><span class="fw-bold">{{ get_grndata21.ItemExpiry }}</span>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                            ...
                            <div class="card-body invoice-padding mx-3 pb-0">
                                <div class="row invoice-sales-total-wrapper">
                                    <div class="col-md-6 order-md-1 order-1 mt-md-0 mt-3">
                                        <p class="card-text mb-0"><span style="width:100%"
                                                class="fw-bold">Narration:</span></p>
                    ...
                    <div class="col-xl-12 col-md-12 col-12">
                        <div class="card invoice-preview-card" v-for="get_grndata1 in get_grndata">
                                ...
                                <div class="row row-bill-to invoice-spacing" style="margin-top:0px">
                                    <div class="col-xl-6 mb-lg-1 col-bill-to ps-0">
                                        <div class="form-group">
                                            <h6 class="invoice-to-title" style="margin-bottom:5px">Against PO:<span
                                            ...
                                            <div class="invoice-customer">
                                                <select v-model="grn_po" class="invoiceto form-select" disabled>
                                                    ...
                                                    <option v-for='get_vendors1 in get_vendors'
                                                        :value='get_vendors1.PurchaseOrderID'>{{
                                                        get_vendors1.PoCode}}_{{ get_vendors1.VendorName }} (For
                                                        {{ get_vendors1.DepartmentName }}-{{ get_vendors1.ProjectName }})
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <h6 class="invoice-to-title" style="margin-bottom:5px">Invoice No:<span
                                                    style="color: #DB4437; font-size: 11px;">*</span></h6>
                                    ...
                                    <div class="col-xl-6 p-0 ps-xl-2 mt-xl-0 mt-2">
                                        ...
                                        <div class="form-group">
                                            <h6 class="invoice-to-title" style="margin-bottom:5px">Status:<span
                                                    style="color: #DB4437; font-size: 11px;">*</span></h6>
                                            <div class="invoice-customer">
                            ...
                            <div class="card-body invoice-padding invoice-product-details">
                                <div v-for="(get_po_detail11, index) in get_grnitems" class="source-item"
                                                ...
                                                <div class="col-lg-3 col-12 mb-lg-0 mb-2 mt-lg-0 mt-2">
                                                    ...
                                                    <select class="form-select" name="first[]" disabled>
                                                        <option :value='get_po_detail11.ItemId'>
                                                            {{ get_po_detail11.ItemName }}</option>
                                                    </select>
                                                </div>
                                                <div class="col-lg-2 col-12 my-lg-0 my-2">
                                                    <p class="card-text col-title mb-md-2 mb-0">Ordered Qty</p>
                                                    <input :value='get_po_detail11.PoQuantity' type="number" readonly
                                                        class="form-control" name="second[]" />
                                                </div>
                                                <div class="col-lg-2 col-12 my-lg-0 my-2">
                                                    <p class="card-text col-title mb-md-2 mb-0">Unit</p>
                                                    <input name="third[]" readonly :value='get_po_detail11.Unit'
                                                        type="text" class="form-control" />
                                                </div>
                                                <div class="col-lg-2 col-12 my-lg-0 my-2">
                                                    <p class="card-text col-title mb-md-2 mb-0">Received Qty</p>
                                                    <input name="fourth[]" type="number" class="form-control" />
                                                    <!--:value='get_po_detail11.RecvdQuantity'-->
                                                </div>
                                                <div class="col-lg-3 col-12 my-lg-0 my-2">
                                                    <p class="card-text col-title mb-md-2 mb-0">Date Expiry</p>
                                                    <input name="fifth[]" type="date" class="form-control" />
                                                    <!--:value='get_po_detail11.ItemExpiry'-->
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body invoice-padding py-0">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="mb-2">
                                            ...
                                            <textarea class="form-control" v-model="ed_narration" rows="2"
                                                id="note"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <!-- Invoice Note ends -->
                                <div class="col-12 text-center mt-2 pt-50">
                                    <button :disabled="disabled1" @click="delay1()" class="btn btn-primary bg-primary me-1">Update
                                        GRN</button>
                                    <button type="reset" class="btn btn-outline-secondary" data-bs-dismiss="modal"
                                        aria-label="Close">
                                        Cancel
