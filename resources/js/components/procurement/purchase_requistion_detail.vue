                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div  v-if="hasPermission('Purchase Requisition Merge')" class="dt-buttons d-inline-flex mt-50">
                                <router-link  style="float:left" to="/purchase/purchase_merge_requisition" class="btn btn-primary bg-primary waves-effect bg-primary py-2"><i class="fa-regular fa-object-ungroup"></i> Merge Requisitions</router-link>
                            </div>
                        </div>
                        <div class="col-md-9">
