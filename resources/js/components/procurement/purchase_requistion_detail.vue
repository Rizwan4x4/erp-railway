        ...
        <div class="app-content content ">
            ...
            <div class="content-wrapper container-xxl p-0">
                ...
                <div class="content-body">
                                ...
                                <div class="card top-radius bottom-radius border-0 m-0">
                                    <div class="card-body d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="avatar bg-light-warning p-50">
                                            <span class="avatar-content" v-popover.left="{ name: 'foo', enent: 'hover' }"
                                                @click="inv_reqCounter('all', 'Goods')">
                                ...
                                <div class="card top-radius bottom-radius border-0 m-0">
                                    <div class="card-body d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="avatar bg-light-primary p-50">
                                            <span class="avatar-content" v-popover.left="{ name: 'foo' }"
                                                @click="inv_reqCounter('Approved', 'Goods')">
                                ...
                                <div class="card top-radius bottom-radius border-0 m-0">
                                    <div class="card-body d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="avatar bg-light-info p-50">
                                            <span class="avatar-content" v-popover.left="{ name: 'foo' }"
                                                @click="inv_reqCounter('Pending', 'Goods')">
                                ...
                                <div class="card top-radius bottom-radius border-0 m-0">
                                    <div class="card-body d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="avatar bg-light-danger p-50">
                                            <span class="avatar-content" v-popover.left="{ name: 'foo' }"
                                                @click="inv_reqCounter('Rejected', 'Goods')">
                                ...
                                <div class="card top-radius bottom-radius border-0 m-0">
                                    <div class="card-body d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="avatar bg-light-success p-50">
                                            <span class="avatar-content" v-popover.left="{ name: 'foo' }"
                                                @click="inv_reqCounter('Issued', 'Goods')">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div v-if="hasPermission('Purchase Requisition Merge')"
                                class="dt-buttons d-inline-flex ">
                                <router-link style="float:left" to="/purchase/purchase_merge_requisition"
                                    class="btn btn-primary bg-primary waves-effect bg-primary py-2"><i
                                        class="fa-regular fa-object-ungroup"></i> Merge Requisitions</router-link>
                            </div>
                        </div>
                        <div class="col-md-9">
                            <ul class="nav nav-pills mb-2" style="padding-left:20px !important">
                                ...
                                <li v-if="hasPermission('Purchase Requisition View Services')"
                                    class="nav-item col-md-4">
                    ...
                    <section class="app-user-list">
                        <div class="card top-radius bottom-radius border-0" style="background-color:white !important">
                                                ...
                                                <div class="row g-1">
                                                    ...
                                                    <div class="col-md-1">
                                                        <button @click="filter_byStatus()"
                                                            style="background: rgb(193, 193, 193); width:100% !important; height: 38px !important; margin-bottom: 20px; margin-top: 31px;"
                                                            class="btn btn-primary bg-primary bg-primary">Search</button>
                                                    </div>
                                                    <div class="col-md-2 ">
                                                        <input type="text" v-model="keyword1" class="form-control"
                                                            style="margin-top: 31px;" placeholder="Inventory Req ID" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="table-responsive" style="overflow-x: initial !important;">
                                <table class="table table-hover">
                                    ...
                                    <tbody v-for="adsdata1 in adsdata.data" :key="adsdata1">
                                        <tr
                                            v-if="new RegExp(keyword1, 'i').test(adsdata1.RId) || new RegExp(keyword1, 'i').test(adsdata1.RId2)">
                                                ...
                                                <div class="accordion accordion-border" id="accordionBorder">
                                                    <div class="accordion-item" style="border: 0 !important;">
                                                        <div class="accordion-header d-flex"
                                                            ...
                                                            <div
                                                                class="col-md-2  mb-3 position-relative custom-mx-1  sorting_1" >
                                                                <div class="row">
                                                                    <div class="d-flex flex-column">
                                                                        <a class="user_name text-truncate text-body"><span
                                                                                class="fw-bolder">{{ adsdata1.RId }}
                                                                            </span></a>
                                                                        <small
                                                                            class="emp_post text-muted">{{ adsdata1.RId2 }}</small>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-2  mb-3 position-relative custom-mx-1 "
                                                                style="text-align:center;">{{ adsdata1.Dated }} </div>
                                                            <div class="col-md-3  mb-3 position-relative custom-mx-1 ">
                                                                <h6 class="user-name text-truncate mb-0">
                                                                    {{ adsdata1.DepartmentName }}</h6><small
                                                                    class="text-truncate text-muted">{{ adsdata1.ProjectName }}</small>

                                                            </div>
                                                            <div class="col-md-1  mb-3 position-relative custom-mx-1 "
                                                                style="text-align:center;">{{ adsdata1.RequisitionType }}
                                                            </div>
                                                            <div class="col-md-1  mb-3 position-relative custom-mx-1 "
                                                                ...
                                                                <a v-if="adsdata1.Status == 'Approved'">
                                                                    <span
                                                                        ...
                                                                        class="badge bg-success">{{ adsdata1.Status }}</span>
                                                                    <span v-else
                                                                        class="badge bg-success">{{ adsdata1.Status }}</span>
                                                                </a>
                                                                ...
                                                                <span class="badge badge-glow bg-warning"
                                                                    v-else>{{ adsdata1.Status }}</span>
                                                                <span v-if="adsdata1.state == 1"
                                                                    class="badge badge-glow bg-success">Fully
                                                                    Issued</span>
                                                            </div>
                                                            <!-- <div class="col-md-2  mb-3 position-relative custom-mx-1 " v-else style="text-align:center;">
                                                            ...
                                                            <div class="col-md-1  mb-1 position-relative"
                                                                style="width: 10%; margin-left:24px;">
                                                                <div class="d-flex align-items-center col-actions">
                                                                    <a style="text-decoration:none;" class="me-1"
                                                                        href="#" data-bs-toggle="modal"
                                                                        @click="editRequisition(adsdata1.RequisitionId)"
                                                                        data-bs-target="#viewPREQ">
                                                                        <i class="fa-solid fa-eye"></i>
                                                                    </a>
                                                                    <a class="dropdown-item button collapsed custom-mx-1 "
                                                                    ...
                                                                    <thead>
                                                                        <tr>
                                                                            ...
                                                                            <th class="sticky-th-center">
                                                                                Estimated<br />Cost</th>
                                                                        </tr>
                                                                    </thead>
                                                                    <tbody>
                                                                        <tr
                                                                            v-for="(get_request, index) in get_reqdata1">
                                                                            <td class="td-center"
                                                                                style="text-align:center;border-right:1px solid lightgrey">
                                                                                {{ index + 1 }}</td>
                                                                            <td class="td-left"
                                                                                style="text-align:center;border-right:1px solid lightgrey">
                                                                                {{ get_request.ItemName }}</td>
                                                                            <td class="td-left"
                                                                                style="text-align:center;border-right:1px solid lightgrey">
                                                                                {{ get_request.Detail }}</td>
                                                                            <td class="td-center"
                                                                                style="text-align:center;border-right:1px solid lightgrey">
                                                                                {{ get_request.Quantity }}</td>
                                                                            <td class="td-center"
                                                                                style="text-align:center;border-right:1px solid lightgrey">
                                                                                {{ get_request.unit }}</td>
                                                                            <td class="td-center"
                                            ...
                                            <td v-if="adsdata1.Status == 'Approved' || adsdata1.Status == 'Issued'"
                                                style="vertical-align: middle !important;font-size: 20px !important; width: 30% !important;">
                                                <div>
                                                    <div v-if="adsdata1.q1 == 'finalize'" class="badge">
                                                        <span
                                                            class="badge btn btn-sm rounded-pill badge-light-success dropdown-toggle hide-arrow"
                                                            @click="checkpo(adsdata1.RequisitionId, 1)"
                                                            data-bs-toggle="dropdown">Quotation 1</span>
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <a v-for="pono in po_nos" target="_blank"
                                                                @click="po(pono.PurchaseOrderID)" class="dropdown-item"
                                                                data-bs-toggle="modal" data-bs-target="#viewPO">
                                                    ...
                                                    <div v-else-if="adsdata1.q1 == 'Added'" class="badge">
                                                        <router-link
                                                            :to="{ name: 'edit_quotation', params: { id: 1, rid: adsdata1.RequisitionId } }"
                                                            class="me-50">
                                                            <span
                                                                class="badge  rounded-pill badge-light-primary">Quotation
                                                                1</span>
                                                        </router-link>
                                                    </div>
                                                    <div v-else-if="adsdata1.q1 == null" class="badge">
                                                        <router-link
                                                            :to="{ name: 'create_quotation', params: { id: 1, rid: adsdata1.RequisitionId } }"
                                                            class="me-50">
                                                            <span
                                                                class="badge  rounded-pill badge-light-danger">Quotation
                                                                1</span>
                                                        </router-link>
                                                    </div>
                                                    <div v-if="adsdata1.q2 == 'finalize'" class="badge">
                                                        <span
                                                            class="badge btn btn-sm rounded-pill badge-light-success dropdown-toggle hide-arrow"
                                                            @click="checkpo(adsdata1.RequisitionId, 2)"
                                                            data-bs-toggle="dropdown">Quotation 2</span>
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <a v-for="pono in po_nos" target="_blank"
                                                                @click="po(pono.PurchaseOrderID)" class="dropdown-item"
                                                                data-bs-toggle="modal" data-bs-target="#viewPO">
                                                    ...
                                                    <div v-else-if="adsdata1.q2 == 'Added'" class="badge">
                                                        <router-link
                                                            :to="{ name: 'edit_quotation', params: { id: 2, rid: adsdata1.RequisitionId } }"
                                                            class="me-50">
                                                            <span
                                                                class="badge  rounded-pill badge-light-primary">Quotation
                                                                2</span>
                                                    ...
                                                    <div v-else-if="adsdata1.q2 == null && adsdata1.q1 != null"
                                                        class="badge">
                                                        <router-link
                                                            :to="{ name: 'create_quotation', params: { id: 2, rid: adsdata1.RequisitionId } }"
                                                            class="me-50">
                                                            <span
                                                                class="badge  rounded-pill badge-light-danger">Quotation
                                                                2</span>
                                                    ...
                                                    <div v-if="adsdata1.q3 == 'finalize'" class="badge">
                                                        <span
                                                            class="badge btn btn-sm rounded-pill badge-light-success dropdown-toggle hide-arrow"
                                                            @click="checkpo(adsdata1.RequisitionId, 3)"
                                                            data-bs-toggle="dropdown">Quotation 3</span>
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <a v-for="pono in po_nos" target="_blank"
                                                                @click="po(pono.PurchaseOrderID)" class="dropdown-item"
                                                                data-bs-toggle="modal" data-bs-target="#viewPO">
                                                    ...
                                                    <div v-else-if="adsdata1.q3 == 'Added'" class="badge">
                                                        <router-link
                                                            :to="{ name: 'edit_quotation', params: { id: 3, rid: adsdata1.RequisitionId } }"
                                                            class="me-50">
                                                            <span
                                                                class="badge rounded-pill badge-light-primary">Quotation
                                                                3</span>
                                                    ...
                                                    <div v-else-if="adsdata1.q3 == null && adsdata1.q2 != null"
                                                        class="badge">
                                                        <router-link
                                                            :to="{ name: 'create_quotation', params: { id: 3, rid: adsdata1.RequisitionId } }"
                                                            class="me-50">
                                                            <span
                                                                class="badge rounded-pill badge-light-danger">Quotation
                                                                3</span>
                                                    ...
                                                    <div v-if="adsdata1.q4 == 'finalize'" class="badge">
                                                        <span
                                                            class="badge btn btn-sm rounded-pill badge-light-success dropdown-toggle hide-arrow"
                                                            @click="checkpo(adsdata1.RequisitionId, 4)"
                                                            data-bs-toggle="dropdown">Quotation 4</span>
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <a v-for="pono in po_nos" target="_blank"
                                                                @click="po(pono.PurchaseOrderID)" class="dropdown-item"
                                                                data-bs-toggle="modal" data-bs-target="#viewPO">
                                                    ...
                                                    <div v-else-if="adsdata1.q4 == 'Added'" class="badge">
                                                        <router-link
                                                            :to="{ name: 'edit_quotation', params: { id: 4, rid: adsdata1.RequisitionId } }"
                                                            class="me-50">
                                                            <span
                                                                class="badge rounded-pill badge-light-primary">Quotation
                                                                4</span>
                                                    ...
                                                    <div v-else-if="adsdata1.q4 == null && adsdata1.q3 != null"
                                                        class="badge">
                                                        <router-link
                                                            :to="{ name: 'create_quotation', params: { id: 4, rid: adsdata1.RequisitionId } }"
                                                            class="me-50">
                                                            <span
                                                                class="badge rounded-pill badge-light-danger">Quotation
                                                                4</span>
                                                    ...
                                                    <div v-if="adsdata1.q5 == 'finalize'" class="badge">
                                                        <span
                                                            class="badge btn btn-sm rounded-pill badge-light-success dropdown-toggle hide-arrow"
                                                            @click="checkpo(adsdata1.RequisitionId, 5)"
                                                            data-bs-toggle="dropdown">Quotation 5</span>
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <a v-for="pono in po_nos" target="_blank"
                                                                @click="po(pono.PurchaseOrderID)" class="dropdown-item"
                                                                data-bs-toggle="modal" data-bs-target="#viewPO">
                                                    ...
                                                    <div v-else-if="adsdata1.q5 == 'Added'" class="badge">
                                                        <router-link
                                                            :to="{ name: 'edit_quotation', params: { id: 5, rid: adsdata1.RequisitionId } }"
                                                            class="me-50">
                                                            <span
                                                                class="badge rounded-pill badge-light-primary">Quotation
                                                                5</span>
                                                    ...
                                                    <div v-else-if="adsdata1.q5 == null && adsdata1.q4 != null"
                                                        class="badge">
                                                        <router-link
                                                            :to="{ name: 'create_quotation', params: { id: 5, rid: adsdata1.RequisitionId } }"
                                                            class="me-50">
                                                            <span
                                                                class="badge rounded-pill badge-light-danger">Quotation
                                                                5</span>
                                                    ...
                                                    <div v-if="adsdata1.q6 == 'finalize'" class="badge">
                                                        <span
                                                            class="badge btn btn-sm rounded-pill badge-light-success dropdown-toggle hide-arrow"
                                                            @click="checkpo(adsdata1.RequisitionId, 6)"
                                                            data-bs-toggle="dropdown">Quotation 6</span>
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <a v-for="pono in po_nos" target="_blank"
                                                                @click="po(pono.PurchaseOrderID)" class="dropdown-item"
                                                                data-bs-toggle="modal" data-bs-target="#viewPO">
                                                    ...
                                                    <div v-else-if="adsdata1.q6 == 'Added'" class="badge">
                                                        <router-link
                                                            :to="{ name: 'edit_quotation', params: { id: 6, rid: adsdata1.RequisitionId } }"
                                                            class="me-50">
                                                            <span
                                                                class="badge rounded-pill badge-light-primary">Quotation
                                                                6</span>
                                                    ...
                                                    <div v-else-if="adsdata1.q6 == null && adsdata1.q5 != null"
                                                        class="badge">
                                                        <router-link
                                                            :to="{ name: 'create_quotation', params: { id: 6, rid: adsdata1.RequisitionId } }"
                                                            class="me-50">
                                                            <span
                                                                class="badge rounded-pill badge-light-danger">Quotation
                                                                6</span>
                                                    ...
                                                    <div v-if="adsdata1.q1 != null" class="btn-group"
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <a v-if="adsdata1.q2 != null" style="text-decoration:none;"
                                                                class="dropdown-item" href="#" data-bs-toggle="modal"
                                                                @click="comparativeHandler(adsdata1.RequisitionId)"
                                                                data-bs-target="#viewComparative">
                                                                Comparative
                                                            </a>
                                                            <a target="_blank"
                                                                v-bind:href="`Accounts/Quotation/1/${adsdata1.RequisitionId}`"
                                                                class="dropdown-item">
                                                                Quotation 1
                                                            </a>
                                                            <a target="_blank" v-if="adsdata1.q2 != null"
                                                                v-bind:href="`Accounts/Quotation/2/${adsdata1.RequisitionId}`"
                                                                class="dropdown-item">
                                                                Quotation 2
                                                            </a>
                                                            <a target="_blank" v-if="adsdata1.q3 != null"
                                                                v-bind:href="`Accounts/Quotation/3/${adsdata1.RequisitionId}`"
                                                                class="dropdown-item">
                                                                Quotation 3
                                                            </a>
                                                            <a target="_blank" v-if="adsdata1.q4 != null"
                                                                v-bind:href="`Accounts/Quotation/4/${adsdata1.RequisitionId}`"
                                                                class="dropdown-item">
                                                                Quotation 4
                                                            </a>
                                                            <a target="_blank" v-if="adsdata1.q5 != null"
                                                                v-bind:href="`Accounts/Quotation/5/${adsdata1.RequisitionId}`"
                                                                class="dropdown-item">
                                                                Quotation 5
                                                            </a>
                                                            <a target="_blank" v-if="adsdata1.q6 != null"
                                                                v-bind:href="`Accounts/Quotation/6/${adsdata1.RequisitionId}`"
                                                                class="dropdown-item">
                                                                Quotation 6
                                                            </a>
                                                        </div>
                            ...
                            <div style="text-align:center;padding-top:20px" class="d-flex">
                                <pagination :data="adsdata" @pagination-change-page="getResult" :limit="5"
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered modal-edit-user" style="min-width: 1200px;">
                <div class="modal-content">
                    ...
                    <vue-html2pdf :show-layout="false" :float-layout="true" :enable-download="true"
                        :preview-modal="false" :paginate-elements-by-height="5000" filename="Comparative_report"
                    ...
                    <div class="modal-footer">
                        <button type="button" @click="generateComparativeReport()"
                            class="btn btn-gradient-info">Pdf</button>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="card-body invoice-padding pb-0">
                                ...
                                <div
                                    ...
                                    <div v-for='companydetail11 in companydetail' style="margin-left:30px">
                                        <div style="padding-top:10px;margin-bottom: 0px;" class="logo-wrapper">
                                            <h3 class="text-primary invoice-logo" style="margin-left: 0px;">
                                                {{ companydetail11.company_name }}</h3>
                                        </div>
                                        <p class="card-text mb-25">Address: {{ companydetail11.company_address }} , </p>
                                        <p class="card-text mb-25">City: {{ companydetail11.city }} -
                                            {{ companydetail11.country }}</p>
                                    ...
                                    <div class="mt-md-0 mt-2" style="min-width:25%">
                                        ...
                                        <div class="invoice-date-wrapper row">
                                            ...
                                            <p style="width:70%" class="  badge badge-glow bg-info invoice-date">
                                                {{ requisit.RequisitionType }}</p>
                                        </div>
                                        <div class="invoice-date-wrapper row">
                                            <p class="invoice-date-title" style="width:35%">Status:</p>
                                            <p style="width:65%" class="invoice-date">
                                                <span v-if="requisit.Status == 'Approved'"
                                                    class="badge badge-glow bg-primary">Approved</span>
                                                <span v-if="requisit.Status == 'Issued'"
                                                    class="badge badge-glow bg-warning">Issued</span>
                                                <span v-if="requisit.Status == 'Pending'"
                                                    class="badge badge-glow bg-info">Pending</span>
                                            </p>
                                        </div>
                                    </div>
                    ...
                    <div class="col-xl-12 col-md-12 col-12">
                        <div class="card invoice-preview-card">
                            ...
                            <div class="card-body  pb-0">
                                <div class="d-flex justify-content-between flex-md-row flex-column invoice-spacing mt-0"
                                    ...
                                    <div v-for='companydeta11 in companydetail' style="margin-left:30px">
                                        <div style="padding-top:10px;margin-bottom: 0px;" class="logo-wrapper">
                                            <h3 class="text-primary invoice-logo" style="margin-left: 0px;">
                                                {{ companydeta11.company_name }}</h3>
                                        </div>
                                        <p class="card-text mb-25">Address: {{ companydeta11.company_address }} , </p>
                                        <p class="card-text mb-25">City: {{ companydeta11.city }} -
                                            {{ companydeta11.country }}</p>
                                ...
                                <div class="row row-bill-to invoice-spacing" style="margin-top:0px">
                                    <div class="col-xl-6 mb-lg-1 col-bill-to ps-0">
                                        ...
                                        <div class="invoice-customer">
                                            ...
                                            <span style="color: #DB4437; font-size: 11px;"
                                                v-if="dept_name == ''">{{ e_dept_name }}</span>
                                        </div>
                            ...
                            <div class="card-body invoice-padding invoice-product-details" style="margin-top:30px">
                                ...
                                <div v-for="get_reqdat in get_reqdata1" class="source-item"
                                            ...
                                            <div class="row w-100 pe-lg-0 pe-1 py-2">
                                                ...
                                                <div class="col-lg-3 col-12 my-lg-0 my-2">
                                                    ...
                                                    <textarea @keypress="onlyNumber" name="fourth[]"
                                                        ...
                                                        rows="1">{{ get_reqdat.Quantity }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div
                                    ...
                                    <div class="mt-md-0 mt-2" style="min-width:25%">
                                        ...
                                        <div class="invoice-date-wrapper row">
                                            <p class="invoice-date-title" style="width:35%">Status:</p>
                                            <p style="width:65%" class="invoice-date">
                                                <span v-if="perorders1.Status2 == 'Received'"
                                                    class="badge badge-light-warning">Received</span>
                                                <span v-if="perorders1.Status2 == 'Issued'"
                                                    class="badge badge-light-success">Issued</span>
                                                <span v-if="perorders1.Status2 == 'Not Delivered'"
                                                    class="badge badge-light-danger">Not Delivered</span>
                                                <span v-if="perorders1.Status2 == 'Not Completed'"
                                                    class="badge badge-light-danger">Not Completed</span>
                                                <span v-if="perorders1.Status2 == 'Completed'"
                                        ...
                                        <tr v-for="poProducts1 in poProducts">
                                            ...
                                            <td>
                                                <span class="fw-bold">{{ currency }}.
                                                    {{ Number(poProducts1.Price).toLocaleString() }}</span>
                                            </td>
                                            <td>
                                                <span class="fw-bold">{{ currency }}.
                                                    {{ Number(poProducts1.SubTotal).toLocaleString() }}</span>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
