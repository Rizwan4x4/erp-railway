                ...
                <div class="noprint content-header row">
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <router-link to="../purchase/demand_requisition" style="text-decoration: none;">Demand
                        ...
                        <div class="row invoice-add">
                            ...
                            <div class="col-xl-10 col-md-10 col-12">
                                <div class="card invoice-preview-card">
                                    ...
                                    <!-- Header ends -->
                                    <div class="divider">
                                        <div class="divider-text" style="font-size: 24px;font-weight: 900;">Demand
                                            Requisition</div>
                                    </div>
                                    ...
                                    <div class="card-body invoice-padding pt-0">
                                        <div class="row row-bill-to invoice-spacing" style="margin-top:0px">
                                            <div class="col-xl-6 mb-lg-1 col-bill-to ps-0">
                                                <h6 class="invoice-to-title" style="margin-bottom:5px">Project Name:
                                                    <label style="color: #d93025">*</label>
                                                </h6>
                                                <div class="invoice-customer">
                                                    <select @change="get_projectlist()" v-model="project_id"
                                                        class="invoiceto form-select" ref="project"
                                                        :class="{ 'is-invalid': !project_id && run, 'is-valid': project_id && run }">
                                                        <option value=''>Select Project Name</option>
                                                        <option v-for='get_project1 in get_project'
                                                            :value='get_project1.ID'>{{ get_project1.ProjectName }}
                                                        </option>
                                                    </select>
                                            ...
                                            <div class="col-xl-6 mb-lg-1 col-bill-to ps-0">
                                                <h6 class="invoice-to-title" style="margin-bottom:5px">
                                                    Department/Company Name: <label style="color: #d93025">*</label>
                                                </h6>
                                                <div class="invoice-customer">
                                                    <select v-model="dept_name" class="invoiceto form-select department"
                                                        :class="{ 'is-invalid': !dept_name && run, 'is-valid': dept_name && run }"
                                                        ref="department">
                                                        <option value="">
                                                            Select Department/Child Company
                                                        </option>
                                                        <option v-for='(get_dept1, index) in get_dept'
                                                            :value='get_dept1.DepartmentName'>{{ index + 1 }} - {{
                                                                get_dept1.DepartmentName }}</option>
                                                    </select>
                                                    <div class="invalid-feedback">
                                                ...
                                                <div class="demo-inline-spacing">
                                                    ...
                                                    <div class="form-check form-check-inline" style="margin-top:0px">
                                                        <input class="form-check-input" type="radio" v-model="status"
                                                            @change="find_services()" name="inlineRadioOptions"
                                                    ...
                                                    <div class="form-check form-check-inline" style="margin-top:0px">
                                                        <input class="form-check-input" type="radio" v-model="status"
                                                            @change="find_services()" name="inlineRadioOptions"
                                                            id="inlineRadio3" value="Assets">
                                                        <label class="form-check-label"
                                                            for="inlineRadio3">Assets</label>
                                                    </div>
                                                    <div class="form-check form-check-inline" style="margin-top:0px">
                                                        <input class="form-check-input" type="radio" v-model="status"
                                                            @change="find_services()" name="inlineRadioOptions"
                                                            id="inlineRadio2" value="Services">
                                                        <label class="form-check-label"
                                                            for="inlineRadio2">Services</label>
                                                    </div>
                                                </div>
                                                <div class="invalid-feedback">
                                    ...
                                    <div class="card-body invoice-padding invoice-product-details">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3"
                                                style="text-align: right; vertical-align:bottom !important;">
                                                <button class="btn btn-primary bg-primary" @click="sum_total()"
                                                    style="margin-top:21px;">Calculate Total</button>
                                            </div>
                                            <div class="col-md-2">
                                        ...
                                        <div class="form-group xz_form row animated slideInDown"
                                            v-for="count in counter" :id="count" style="margin-top:40px">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="row w-100 pe-lg-0 pe-1 py-2">
                                                                        <div
                                                                            ...
                                                                            <p
                                                                                class="card-text col-title mb-md-50 mb-0">
                                                                                {{ count }} - Item name <label
                                                                                    style="color: #d93025">*</label></p>
                                                                            <multiselect v-if="status == 'Goods'"
                                                                                style="margin-right: 10px;"
                                                                                :options="options"
                                                                                @input="Item_detail(first[count], count - 1)"
                                                                                value="id" label="label"
                                                                                v-model="first[count]"
                                                                                placeholder="Select from Goods">
                                                                            </multiselect>
                                                                            <multiselect v-else-if="status == 'Assets'"
                                                                                style="margin-right: 10px;"
                                                                                :options="options"
                                                                                @input="Item_detail(first[count], count - 1)"
                                                                                value="id" label="label"
                                                                            ...
                                                                            <input hidden v-else type="text"
                                                                                name="first[]" value="empty">
                                                                            <input hidden type="text" name="second[]"
                                                                                value="empty">
                                                                            <input hidden type="number"
                                                                                class="form-control" name="third[]"
                                                                                value="1" />
                                                                            <div v-if="errorsBackEnd[count]">
                                                                                <p class="text-danger">{{
                                                                                    errorsBackEnd[count].ItemName }}</p>
                                                                            </div>
                                                                        </div>
                                                                        <div v-if="status == 'Goods' || status == 'Assets'"
                                                                            class="col-lg-3 col-12 my-lg-0 my-2">
                                                                            <p class="card-text col-title mb-md-2 mb-0">
                                                                                Item Code</p>
                                                                            <p style="border-radius: 2px; padding-left: 10px; width: 100%; height: 35px;"
                                                                                :id="'demo2_' + (count - 1)"
                                                                                class="form-control card-text  mb-md-50 mb-0 codes">
                                                                            </p>
                                                                            <div v-if="errorsBackEnd[count]">
                                                                                <p class="text-danger">{{
                                                                                    errorsBackEnd[count].codes }}</p>
                                                                            </div>
                                                                        </div>
                                                                        <div v-if="status == 'Goods' || status == 'Assets'"
                                                                            ...
                                                                            <div v-if="errorsBackEnd[count]">
                                                                                <p class="text-danger">{{
                                                                                    errorsBackEnd[count].Quantity }}</p>
                                                                            </div>
                                                                        </div>
                                                                        <div v-else
                                                                            class="col-lg-3 col-12 my-lg-0 my-2">
                                                                        ...
                                                                        <div v-if="status == 'Goods' || status == 'Assets'"
                                                                            ...
                                                                            <p style="border-radius: 2px; padding-left: 10px; width: 100%; height: 35px;"
                                                                                :id="'demo_' + (count - 1)"
                                                                                class="form-control card-text  mb-md-50 mb-0 units">
                                                                            </p>
                                                                            ...
                                                                            <div v-if="errorsBackEnd[count]">
                                                                                <p class="text-danger">{{
                                                                                    errorsBackEnd[count].unit }}</p>
                                                                            </div>
                                                                        </div>
                                                                        <input hidden
                                                                            style="border-radius: 2px; padding-left: 10px; width: 100%; height: 35px;"
                                                                            :value="count"
                                                                            class="form-control card-text  mb-md-50 mb-0 count" />
                                                                        <div class="col-lg-8 col-12 my-lg-0 my-2">
                                                                            <p class="card-text mt-md-2 mb-0"
                                                                                v-if="status == 'Goods'">Item Detail</p>
                                                                            <p class="card-text mt-md-2 mb-0"
                                                                                v-else-if="status == 'Assets'">Asset
                                                                                Detail</p>
                                                                            <p class="card-text mt-md-2 mb-0" v-else>
                                                                                Service Detail</p>
                                                                            <textarea style="max-height:100px;"
                                                                                class="form-control mt-0" rows="1"
                                                                                name="fiveth[]"
                                                                                :placeholder="status === 'Goods' ? ['Item detail'] : (status === 'Assets' ? ['Asset detail'] : ['Service detail'])"></textarea>

                                                                            <div v-if="errorsBackEnd[count]">
                                                                                <p class="text-danger">{{
                                                                                    errorsBackEnd[count].detail }}</p>
                                                                            </div>
                                                                        </div>
                                                                        <div v-if="status == 'Goods' || status == 'Assets'"
                                                                            class="col-lg-4 col-12 my-lg-0 my-2">
                                                                            <p style="" class="card-text  mt-md-2 mb-0">
                                                                                Department</p>
                                                                            <p style="border-radius: 2px;padding-left: 10px;height: 35px;"
                                                                                :id="'demo3_' + (count - 1)"
                                                                                class="form-control card-text  mb-md-50 mb-0">
                                                                            </p>
                                                                        </div>
                                                                    </div>
                                    ...
                                    <div class="card-body invoice-padding">
                                        <div class="row invoice-sales-total-wrapper">
                                            <div class="col-md-12 order-md-1 order-2 mt-md-0 mt-3">
                                                ...
                                                <textarea style="max-height:150px;" v-model="narration"
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <button :disabled="disabled" @click="delay()"
                                            class="btn btn-primary bg-primary w-100 mb-75">
        ...
        get_projectlist() {
            if (this.project_id) {
                ...
                axios.get('accounts/get_departmentcoa/' + this.project_id)
                    .then(response => {
                        this.get_dept = response.data
                        console.log(this.get_dept, "get_dept");
                    })
            }
        },
        find_services() {
    ...
    mounted() {
        axios.get('accounts/get_projects9/')
            .then(response => {
                ...
                console.log(this.get_project, "get_project");
