                    ...
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">
                                Add Quotation {{ this.id }} of {{ this.req_id }}
                            </li>
                        </ol>
                    </div>
                </div>
                        ...
                        <div class="row invoice-add">
                            ...
                            <div class="col-xl-9 col-md-8 col-12">
                                <div class="card invoice-preview-card">
                                    ...
                                    <!-- Header ends -->
                                    <div class="divider">
                                        <div class="divider-text" style="font-size: 24px;font-weight: 900;">New
                                            Quotation
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body invoice-padding pt-0">
                                        <div class="row row-bill-to invoice-spacing" style="margin-top:0px">
                                            <div class="col-xl-12 mb-lg-1 col-bill-to ps-0">
                                                <h6 class="invoice-to-title" style="margin-bottom:5px">Vendor Name:
                                                    <span style="color: #DB4437; font-size: 11px;">*</span></h6>
                                                <div class="invoice-customer">
                                                    <multiselect :options="options"
                                                                 @input="vendor_n ? get_vendor_detail() : null"
                                                                 value="id" label="label" v-model="vendor_n"
                                                                 placeholder="Select Vendor Name"></multiselect>
                                                    <span style="color: #DB4437; font-size: 11px;"
                                                          v-if="!vendor_n">{{ e_vendor_n }}</span>
                                                </div>
                                                <div v-if="vendor_n" v-for="get_single_vendor1 in get_single_vendor">
                                                    <p class="card-text mb-25">Vendor Address:
                                                        {{ get_single_vendor1.Address }}, Phone:
                                                        {{ get_single_vendor1.Mobile }}, Email Id:
                                            ...
                                            <div class="col-xl-12 mb-lg-1 col-bill-to ps-0">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <h6 class="form-label">Est. Completion
                                                            {{ this.select_duration }}<span
                                                                style="color: #DB4437; font-size: 11px;">*</span></h6>
                                                        <input type="number" class="form-control" v-model="input_time"
                                                               value="0">
                                                    </div>
                                                    <div class="col-md-4">
                                                        <h6 class="form-label">Time Unit <span
                                                            style="color: #DB4437; font-size: 11px;">*</span></h6>
                                                        <select class="invoiceto form-select" v-model="select_duration">
                                                    ...
                                                    <div class="col-md-4">
                                                        <h6 class="form-label">Currency <span
                                                            style="color: #DB4437; font-size: 11px;">*</span></h6>
                                                        <select class="invoiceto form-select" v-model="select_currency">
                                    ...
                                    <div>
                                        <div v-for="(get_reqdata11,index) in get_reqdata1"
                                             style="border: 1px solid lightgrey;padding-top: 10px;padding-bottom: 10px;border-radius: 5px;margin-bottom:5px"
                                             class="card-body invoice-padding invoice-product-details">
                                            <div>
                                                <div class="repeater-wrapper" data-repeater-item>
                                                    <div class="row ">
                                                        <div class="col-lg-5 col-12 mb-lg-0 mb-2 mt-lg-0 mt-2">
                                                            <p class="card-text  mb-md-50 mb-0">Item</p>
                                                            <select v-if="req_type=='Goods' || req_type=='Assets' "
                                                                    class="form-select item-details" name="first[]">
                                                                <option :value="get_reqdata11.itemId">
                                                                    {{ get_reqdata11.ItemName }}
                                                                </option>
                                                            </select>
                                                        ...
                                                        <div class="col-lg-2 col-12 my-lg-0 my-2">
                                                            <p class="card-text  mb-md-2 mb-0">Quantity</p>
                                                            <textarea @keypress="onlyNumber" @change="sum_total()"
                                                                      style="min-height: 0px !important;padding: 5px !important;margin-top: 0px !important;"
                                                                      class="form-control mt-2" rows="1"
                                                                      name="fourth[]">{{get_reqdata11.Quantity}}</textarea>
                                                        </div>
                                                        <div class="col-lg-2 col-12 my-lg-0 my-2">
                                                            <p class="card-text  mb-md-2 mb-0">Unit Cost</p>
                                                            <input @change="sum_total()" name="third[]" type="number"
                                                                   class="form-control" value="0"/>
                                                        </div>
                                                        <div class="col-lg-2 col-12 mt-lg-0 mt-2">
                                                            <p class="card-text  mb-md-50 mb-0">Total Price</p>
                                                            <p style="margin-top: 5px;border-radius: 2px;padding-left: 10px;max-width: 100px;height: 35px;"
                                                               :id="'demo_'+(index)"
                                                               class="form-control card-text  mb-md-50 mb-0"></p>
                                                        </div>
                                                        <div class="col-lg-1 col-12 mt-lg-0 mt-2">
                                                            <p class="card-text  mb-md-50 mb-0">Add</p>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="mb-2">
                                                    ...
                                                    <textarea placeholder="Add remarks" v-model="narration"
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <button :disabled="disabled" @click="delay()"
                                                class="btn btn-primary bg-primary w-100 mb-75">Post Quotation
                                        </button>
...
export default {
    ...
    methods: {
        ...
        create_quotation() {
            if (!this.vendor_n || this.input_time == '' || this.select_currency == '' || this.select_duration == '') {
                if (!this.vendor_n) {
                    this.e_vendor_n = 'Please select vendor';
                }
                ...
                formData.append('vendor_n', this.vendor_n.label);
                ...
                axios.post('./accounts/insert_pquotation', formData)
                    .then(data => {
                        if (data.data == "submitted") {
                            this.$toastr.s("Purchase Quotation added Successfully", "Congratulations!");
        ...
        sum_total() {
            ...
            for (var g = 0; g < fourth.length; g++) {
                ...
                if (added.checked == true) {
                    ...
                    document.getElementsByName('third[' + g + ']').innerHTML = 0;
                }
            }
            this.subtotal = Number(m);
        },
        get_vendor_detail() {
            axios.get('accounts/get_vendor_detail/' + this.vendor_n.id)
                .then(response => {
                    this.get_single_vendor = response.data;
                })
        },
        add_xz_repeater() {
            this.counter++;
        ...
        fetch_items_detail() {
            axios.get('accounts/fetch_req_type/' + this.$route.params.rid)
                .then(response => {
                    ...
                    this.req_id = response.data[0].RId;
                    // if (response.data[0].RequisitionType == 'Goods' || response.data[0].RequisitionType == 'Assets') {
                    //     axios.get('accounts/get_items/' + response.data[0].RequisitionType)
                    //         .then(response => {
    ...
    mounted() {
        ...
        axios.get('./accounts/get_vendor')
            .then(response => {
                ...
                this.options = [];
                this.options = this.get_vendors.map((data) => ({
                    id: data.ID,
        ...
        axios.get('accounts/get_req_data1/' + this.$route.params.rid)
            .then(response => {
