                    ...
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">
                                Demand Service Requisitions Detail
                            </li>
                        </ol>
                    </div>
                </div>
                <div class="content-body">
                    <div class="row">
                        <div class="col-lg-3 col-sm-12">
                            <div class="card">
                                <div class="card-body d-flex align-items-center justify-content-between" title="Click to view details" style="cursor:pointer;" v-popover.left="{name:'foo', enent:'hover'}" @click="inv_reqCounter('all', 'Services')">
                                    <div>
                        ...
                        <div class="col-lg-3 col-sm-12">
                            <div class="card">
                                <div class="card-body d-flex align-items-center justify-content-between" title="Click to view details" style="cursor:pointer;" v-popover.left="{name:'foo'}" @click="inv_reqCounter('Pending', 'Services')">
                                    <div>
                        ...
                        <div class="col-lg-3 col-sm-12">
                            <div class="card">
                                <div class="card-body d-flex align-items-center justify-content-between" title="Click to view details" style="cursor:pointer;" v-popover.left="{name:'foo'}" @click="inv_reqCounter('Approved', 'Services')">
                                    <div>
                        ...
                        <div class="col-lg-3 col-sm-12">
                            <div class="card">
                                <div class="card-body d-flex align-items-center justify-content-between" title="Click to view details" style="cursor:pointer;" v-popover.left="{name:'foo'}" @click="inv_reqCounter('Issued', 'Services')">
                                    <div>
                    ...
                    <ul class="nav nav-pills mb-2 col-md-12" style="padding-left:20px !important">
                        ...
                        <li class="nav-item col-md-3">
                            <router-link to="/purchase/demand_requisition_assets" class="nav-link">
                                <i class="fa-solid fa-car"></i>
                                <span class="fw-bold">Assets</span>
                            </router-link>
                        </li>
                        <li class="nav-item col-md-3">
                            <router-link to="/purchase/demand_requisition_services" class="nav-link active">
                        ...
                        <div clas="card" style="background-color:white !important">
                                ...
                                <div class="col-sm-12 col-lg-12 ps-xl-75 ps-0">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input type="date" class="form-control" v-model="closingdate" placeholder="" required="">
                                                    ...
                                                    <div class="col-md-2">
                                                        <input autocomplete="off" type="text" name="keyword1" v-model="keyword1" class="form-control" style="margin-top: 25px;  margin-left: 20px;" placeholder="Search By Reqid" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="table-responsive" style="overflow-x: initial !important;">
                                <table class="table table-hover">
                                    <thead>
                                        <tr>
                                            <th class="sticky-th-center col-md-2">Requisition ID</th>
                                            <th class="sticky-th-center col-md-2">Request Date</th>
                                            <th class="sticky-th-left col-md-3">Department<br />& Project</th>
                                            <th class="sticky-th-center col-md-1">Type </th>
                                            <th class="sticky-th-center col-md-1">Status</th>
                                            <th class="sticky-th-center">Actions </th>
                                        </tr>
                                    </thead>
                                    <tbody v-for="adsdata1 in adsdata.data" :key="adsdata1">
                                        <tr v-if="new RegExp(keyword1, 'i').test(adsdata1.RId)">
                                            <td colspan="6">
                                                    ...
                                                    <div class="accordion-item" style="border:none !important">
                                                        <div class="accordion-header  d-flex" :id="'headingBorder'+adsdata1.RequisitionId">
                                                            ...
                                                            <div class="col-md-1  mb-3 position-relative mx-1" >
                                                                ...
                                                                <span @click="editRequisition(adsdata1.RequisitionId)" data-bs-toggle="modal" data-bs-target="#PREQ_status" v-else-if="adsdata1.Status=='Pending'" class="badge badge-glow bg-info" style="cursor:pointer;">{{adsdata1.Status}}</span>
                                                                ...
                                                                <a v-if="adsdata1.Status2=='Completed'">
                                                                    <span v-if="adsdata1.q1==null && adsdata1.q2==null && adsdata1.q3==null && adsdata1.q4==null && adsdata1.q5==null && adsdata1.q6==null" class="badge badge-glow bg-success">{{adsdata1.Status2}}</span>
                                                                    <span v-else class="badge badge-glow bg-primary">{{adsdata1.Status2}}</span>
                                                                </a>
                                                                <span @click="editRequisition(adsdata1.RequisitionId)" data-bs-toggle="modal" data-bs-target="#PREQ_status2" v-else-if="adsdata1.Status2=='Not Completed'" class="badge badge-glow bg-danger">{{adsdata1.Status2}}</span>

                                                                <span class="badge badge-glow bg-danger" v-else>{{adsdata1.Status2}}</span>
                                                            ...
                                                            <!-- <div class="col-md-1  mb-3 position-relative mx-1" v-else>
                                                                ...
                                                                <span class="badge badge-glow bg-warning" v-else>{{adsdata1.Status}}</span>
                                                                <span v-if="adsdata1.state==1" class="badge badge-glow bg-success">Fully Issued</span>
                                                                <span v-if="adsdata1.Status2=='Completed'" class="badge badge-glow bg-success">{{adsdata1.Status2}}</span>
                                                                <span v-else-if="adsdata1.Status2=='Not Completed'" class="badge badge-glow bg-danger">{{adsdata1.Status2}}</span>
                                                                <span class="badge badge-glow bg-warning" v-else>{{adsdata1.Status2}}</span>
                                                            ...
                                                            <a class="collapsed mx-5" @click="editReq(adsdata1.RequisitionId)" style="border: none;margin-top:5px" data-bs-toggle="collapse" :data-bs-target="'#accordionBorder'+adsdata1.RequisitionId" aria-expanded="false" :aria-controls="'accordionBorder'+adsdata1.RequisitionId">
                                                        ...
                                                        <div :id="'accordionBorder'+adsdata1.RequisitionId" class="accordion-collapse collapse" :aria-labelledby="'headingBorder'+adsdata1.RequisitionId" :data-bs-parent="'#accordionBorder'+adsdata1.RequisitionId">
                                                            <div class="accordion-body">
                                                                <table class="table table-hover">
                                                                    ...
                                                                    <tbody>
                                                                        <tr v-for="(get_reqdata11, index) in get_reqdata1">
                                                                            <td class="py-1">
                            ...
                            <div class="card-body invoice-padding pb-0">
                                <div class="row invoice-sales-total-wrapper">
                                    ...
                                    <div class="col-6 col-md-6 order-2">
                                        ...
                                        <span style="color: #DB4437; font-size:11px;" v-if="up_sts1==''">{{e_up_sts}}</span>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="mb-2">
                                            ...
                                            <textarea class="form-control" v-model="narration" rows="2"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <!-- Invoice Note ends -->
...
<script>
    export default {
        ...
        methods: {
            editReq(id) {
                axios.get('accounts/get_demandreq_services/' + id)
                    .then(response => {
            ...
            update_preq_status1() {
                if (this.up_sts1 == '') {
                    ...
                    this.e_up_sts = "";
                    axios.post('accounts_upd_req_sts_completion', {
                        reqId: this.id,
                        sts: this.up_sts1,
                    })
                        .then(data => {
                            if (data.data == "Status updated!") {
                                ...
                                this.$toastr.e("Work is not Completed yet", "Error!");
                            }
                        })
                }
            ...
            filter_byStatus(page = 1) {
                ...
                if (this.pageSelect == 'All') {
                    axios.get('accounts_fetch_demandreqBysts_services/' + this.status + '/' + this.dept_name1 + '/' + this.proj_name + '/'+ this.startingdate1 + '/' + this.closingdate1 + '/' + this.pageSelect)
                        .then(response => {
                    ...
                    axios.get('accounts_fetch_demandreqBysts_services/' + this.status + '/' + this.dept_name1 + '/' + this.proj_name + '/' + this.startingdate1 + '/' + this.closingdate1 + '/' + this.pageSelect + '?page=' + page)
                        .then(response => {
                            if (response.data == "Invalid department") {
                                this.$toastr.e("You do not have access to search other departments' requisition(s)", "Caution!");
                            }
            ...
            getResult(page = 1) {
                if (this.pageSelect == 'All') {
                    axios.get('accounts/get_demandrequisition_services', { params: { pages: this.pageSelect } })
                        .then(response => this.adsdata = response)
                        .catch(error => { });
                } else {
                    axios.get('accounts/get_demandrequisition_services?page=' + page, { params: { pages: this.pageSelect } })
            ...
            getResults(page = 1) {
                if (this.pageSelect == 'All') {
                    axios.get('accounts/searchbydemandreqid_services/' + this.keyword1 + '/' + this.pageSelect)
                        .then(response => {
                            this.adsdata = response
                        })
                } else {
                    axios.get('accounts/searchbydemandreqid_services/' + this.keyword1 + '/' + this.pageSelect + '?page=' + page)
                        .then(response => {
                            this.adsdata = response.data
                        })
        ...
        mounted() {
            ...
            axios.get('accounts/count_demandrequisitions_services')
