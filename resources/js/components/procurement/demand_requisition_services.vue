        ...
        <div class="app-content content ">
            ...
            <div class="content-wrapper container-xxl p-0">
                ...
                <div class="content-body">
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-sm-12">
                                <div class="card top-radius bottom-radius border-0 m-0">
                                    <div class="card-body d-flex align-items-center justify-content-between"
                                        ...
                                        @click="inv_reqCounter('all', 'Services')">
                                        <div>
                            ...
                            <div class="col-lg-3 col-sm-12">
                                <div class="card top-radius bottom-radius border-0 m-0">
                                    <div class="card-body d-flex align-items-center justify-content-between"
                                        title="Click to view details" style="cursor:pointer;"
                                        v-popover.left="{ name: 'foo' }" @click="inv_reqCounter('Pending', 'Services')">
                                        <div>
                            ...
                            <div class="col-lg-3 col-sm-12">
                                <div class="card top-radius bottom-radius border-0 m-0">
                                    <div class="card-body d-flex align-items-center justify-content-between"
                                        title="Click to view details" style="cursor:pointer;"
                                        v-popover.left="{ name: 'foo' }"
                                        @click="inv_reqCounter('Approved', 'Services')">
                                        <div>
                            ...
                            <div class="col-lg-3 col-sm-12">
                                <div class="card top-radius bottom-radius border-0 m-0">
                                    <div class="card-body d-flex align-items-center justify-content-between"
                                        title="Click to view details" style="cursor:pointer;"
                                        v-popover.left="{ name: 'foo' }" @click="inv_reqCounter('Issued', 'Services')">
                                        <div>
                    ...
                    <ul class="nav nav-pills mb-2 col-md-12">
                                                ...
                                                <div class="row g-1">
                                                    ...
                                                    <div class="col-md-2">
                                                        <input autocomplete="off" type="text" name="keyword1"
                                                            v-model="keyword1" class="form-control px-2"
                                                            style="margin-top: 31px;  margin-left: 20px;"
                                                            placeholder="Search By Reqid" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                        ...
                                                        <div class="accordion-header  d-flex"
                                                            ...
                                                            <div class="col-md-1  mb-3 position-relative mx-1">
                                                                ...
                                                                <span @click="editRequisition(adsdata1.RequisitionId)"
                                                                    ...
                                                                    style="cursor:pointer;">{{ adsdata1.Status }}</span>
                                                                ...
                                                                <span @click="editRequisition(adsdata1.RequisitionId)"
                                                                    ...
                                                                    v-else-if="adsdata1.Status2 == 'Not Completed'"
                                                                    class="badge badge-glow bg-danger">{{
                                                                    adsdata1.Status2 }}</span>

                                                                <span class="badge badge-glow bg-danger" v-else>{{
                                                                    adsdata1.Status2 }}</span>
                                                        ...
                                                        <div :id="'accordionBorder' + adsdata1.RequisitionId"
                                                            ...
                                                            <div class="accordion-body">
                                                                <table class="table table-hover">
                                                                    ...
                                                                    <tbody>
                                                                        <tr
                                                                            v-for="(get_reqdata11, index) in get_reqdata1">
                                                                            <td class="py-1">
                                                                                <span class="fw-bold">{{ index + 1
                                                                                    }}</span>
                                                                            </td>
                                                                            <td class="py-1">
                                                                                <span class="fw-bold">{{
                            ...
                            <div class="card-body invoice-padding pb-0">
                                <div class="row invoice-sales-total-wrapper">
                                    ...
                                    <div class="col-6 col-md-6 order-2">
                                        ...
                                        <span style="color: #DB4437; font-size:11px;" v-if="up_sts1 == ''">{{ e_up_sts
                                            }}</span>
                                    </div>
