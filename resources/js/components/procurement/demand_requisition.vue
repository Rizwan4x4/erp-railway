                    ...
                    <div class="card top-radius bottom-radius px-3 py-4">
                        <div class="row">
                            <div class="col-lg-3 col-sm-12">
                                <div class="card top-radius bottom-radius border-0 mb-0">
                                    <div class="card-body d-flex align-items-center justify-content-between"
                                        style="cursor:pointer;" v-popover.left="{ name: 'foo', enent: 'hover' }"
                            ...
                            <div class="col-lg-3 col-sm-12">
                                <div class="card top-radius bottom-radius border-0 mb-0">
                                    <div class="card-body d-flex align-items-center justify-content-between"
                                        style="cursor:pointer;" v-popover.left="{ name: 'foo' }"
                                                ...
                                                <div class="accordion accordion-border" id="accordionBorder">
                                                    <div class="accordion-item" style="border:none !important">
                                                        <div class="accordion-header  d-flex"
                                                            ...
                                                            <div class="col-md-1  mb-3 position-relative mx-1"
                                                                v-if="hasPermission('Demand Requisition Inventory Change Statuses')">
