                ...
                <div class="content-body">
                    <div class="row">
                        <div class="col-lg-3 col-sm-12">
                            <div class="card">
                                <div class="card-body d-flex align-items-center justify-content-between" style="cursor:pointer;" v-popover.left="{name:'foo', enent:'hover'}" @click="inv_reqCounter('all', 'Goods')">
                                    <div>
                        ...
                        <div class="col-lg-3 col-sm-12">
                            <div class="card">
                                <div class="card-body d-flex align-items-center justify-content-between" style="cursor:pointer;" v-popover.left="{name:'foo'}" @click="inv_reqCounter('Pending', 'Goods')">
                                    <div>
                        ...
                        <div class="col-lg-3 col-sm-12">
                            <div class="card">
                                <div class="card-body d-flex align-items-center justify-content-between" style="cursor:pointer;" v-popover.left="{name:'foo'}" @click="inv_reqCounter('Approved', 'Goods')">
                                    <div>
                        ...
                        <div class="col-lg-3 col-sm-12">
                            <div class="card">
                                <div class="card-body d-flex align-items-center justify-content-between" style="cursor:pointer;" v-popover.left="{name:'foo'}" @click="inv_reqCounter('Issued', 'Goods')">
                                    <div>
                    ...
                    <ul class="nav nav-pills mb-2" style="padding-left:20px !important">
                        ...
                        <li v-if="hasPermission('Demand Requisition Inventory View')" class="nav-item col-md-3">
                            <router-link to="/purchase/demand_requisition" class="nav-link active">
                                <i class="fa-solid fa-warehouse"></i>
                                <span class="fw-bold">Inventory</span>
                            </router-link>
                        </li>
                        <li v-if="hasPermission('Demand Requisition Assets View')" class="nav-item col-md-3">
                            <router-link to="/purchase/demand_requisition_assets" class="nav-link">
                                <i class="fa-solid fa-car"></i>
                                <span class="fw-bold">Assets</span>
                            </router-link>
                        </li>
                        <li v-if="hasPermission('Demand Requisition Service View')" class="nav-item col-md-3">
                            <router-link to="/purchase/demand_requisition_services" class="nav-link">
                    ...
                    <section class="app-user-list">
                        <div class="card">
                            <div class="d-flex justify-content-around align-items-center header-actions mx-2 row">
                                ...
                                <table class="table table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="sticky-th-left col-md-3">Department & Project</th>
                                                ...
                                                <div class="accordion accordion-border" id="accordionBorder">
                                                    <div class="accordion-item" style="border:none !important">
                                                        <div class="accordion-header  d-flex" :id="'headingBorder'+adsdata1.RequisitionId">
                                                            ...
                                                            <div class="col-md-1  mb-3 position-relative mx-1"  v-if="hasPermission('Demand Requisition Inventory Change Statuses')">
                                                            ...
                                                            <div class="col-md-3  mb-3 position-relative mx-1" v-else>
                                                            ...
                                                            <div class="col-md-2  mb-3 position-relative mx-1" style="width: 8%;">
                                                                ...
                                                                <table class="table">
                                                                    <thead>
                                                                        <tr>
                                                                            ...
                                                                            <th class="py-1">Linked Department</th>
                                                                        </tr>
                                                                    </thead>
                                                                    <tbody>
                            ...
                            <div style="text-align:center;padding-top:20px" class="d-flex justify-content-end me-4">
                                <pagination :data="adsdata" @pagination-change-page="getResult" style="margin-top: 25px;" :limit="5"></pagination>
                                <div>
...
<script>
    export default {
        ...
        methods: {
            ...
            filter_byStatus(page = 1) {
                ...
                if (this.pageSelect == 'All') {
                    axios.get('accounts_fetch_demandreqBysts/' + this.status + '/' + this.dept_name1 + '/' + this.proj_name  + '/'+ this.startingdate1 + '/' + this.closingdate1 + '/' + this.pageSelect + '?page=' + page)
                        .then(response => {
            ...
            getResult(page = 1) {
                if (this.pageSelect == 'All') {
                    axios.get('accounts/get_demandrequisition', { params: { pages: this.pageSelect } })
                        .then(response => this.adsdata = response)
                        .catch(error => { });
                } else {
                    axios.get('accounts/get_demandrequisition?page=' + page, { params: { pages: this.pageSelect } })
            ...
            getResults(page = 1) {
                if (this.pageSelect == 'All') {
                    axios.get('accounts/searchbydemandreqid/' + this.keyword1 + '/' + this.pageSelect)
                        .then(response => {

                            this.adsdata = response
                        })
                } else {
                    axios.get('accounts/searchbydemandreqid/' + this.keyword1 + '/' + this.pageSelect + '?page=' + page)
                        .then(response => {
        ...
        watch: {
            keyword1(after, before) {this.getResults();},
            pageSelect() {
                this.getResult();
            }
        },
        mounted() {
            ...
            axios.get('accounts/count_demandrequisitions')
