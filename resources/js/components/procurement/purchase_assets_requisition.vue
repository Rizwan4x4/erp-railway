                            ...
                            <div class="card">
                                <div class="card-body d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="avatar bg-light-warning p-50">
                                        <span class="avatar-content" v-popover.left="{name:'foo', enent:'hover'}" @click="inv_reqCounter('all', 'Assets')">
                            ...
                            <div class="card">
                                <div class="card-body d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="avatar bg-light-primary p-50">
                                        <span class="avatar-content" v-popover.left="{name:'foo'}" @click="inv_reqCounter('Approved', 'Assets')">
                            ...
                            <div class="card">
                                <div class="card-body d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="avatar bg-light-info p-50">
                                        <span class="avatar-content" v-popover.left="{name:'foo'}" @click="inv_reqCounter('Pending', 'Assets')">
                            ...
                            <div class="card">
                                <div class="card-body d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="avatar bg-light-success p-50">
                                        <span class="avatar-content" v-popover.left="{name:'foo'}" @click="inv_reqCounter('Issued', 'Assets')">
                                            <i class="fa-solid fa-user-large-slash"></i>
                                        </span>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <ul class="nav nav-pills mb-2" style="padding-left:20px !important">
                                ...
                                <li class="nav-item col-md-4">
                                    <router-link to="/purchase/purchase_assets_requisition" class="nav-link active">
                                            ...
                                            <td class="td-center" colspan="6">
                                                <div class="accordion accordion-border" id="accordionBorder">
                                                    <div class="accordion-item">
                                                        <div class="accordion-header  d-flex justify-content-around" :id="'headingBorder'+adsdata1.RequisitionId">
                                                            ...
                                                            <!-- <div class="col-md-1  mb-3 position-relative mx-1" v-else>
                                                                ...
                                                                <span v-else-if="adsdata1.Status=='Pending'" class="badge badge-glow bg-info">{{adsdata1.Status}}</span>
                                                                <span v-else-if="adsdata1.Status=='Rejected'" class="badge badge-glow bg-danger">{{adsdata1.Status}}</span>
                                                                <span class="badge bg-warning" v-else>{{adsdata1.Status}}</span>
                                                                <span v-if="adsdata1.state==1" class="badge badge-glow bg-success">Fully Issued</span>

                                                            </div> -->
                                                            <div class="col-md-1 float-end mb-1 position-relative" style="width: 10%; margin-left:5px;">
                                            ...
                                            <td v-if="adsdata1.Status=='Approved' || adsdata1.Status=='Issued'" style="vertical-align: middle !important;font-size: 20px !important; width: 30% !important;">
                                                <div >
                                                    <div v-if="adsdata1.q1=='finalize'" class="badge">
                                                        <span class="badge  rounded-pill badge-light-success">Quotation 1</span>
                                                    </div>
                                                    ...
                                                    <div v-if="adsdata1.q2=='finalize'" class="badge">
                                                        <span class="badge  rounded-pill badge-light-success">Quotation 2</span>
                                                    </div>
                                                    ...
                                                    <div v-if="adsdata1.q3=='finalize'" class="badge">
                                                        <span class="badge rounded-pill badge-light-success">Quotation 3</span>
                                                    </div>
                                                    ...
                                                    <div v-if="adsdata1.q4=='finalize'" class="badge">
                                                        <span class="badge rounded-pill badge-light-success">Quotation 4</span>
                                                    </div>
                                                    ...
                                                    <div v-if="adsdata1.q5=='finalize'" class="badge">
                                                        <span class="badge rounded-pill badge-light-success">Quotation 5</span>
                                                    </div>
                                                    ...
                                                    <div v-if="adsdata1.q6=='finalize'" class="badge">
                                                        <span class="badge  rounded-pill badge-light-success">Quotation 6</span>
                                                    </div>
...
<script>
    export default {
        ...
        methods: {
            ...
            filter_byStatus(page = 1) {
                ...
                if (this.pageSelect == 'All') {
                    axios.get('accounts_fetch_reqBysts_assets/' + this.status + '/' + this.dept_name1 + '/' + this.proj_name  + this.startingdate1 + '/' + this.closingdate1 +'/' + this.pageSelect)
                        .then(response => {
                    ...
                    axios.get('accounts_fetch_reqBysts_assets/' + this.status + '/' + this.dept_name1 + '/' + this.proj_name  + '/' + this.startingdate1 + '/' + this.closingdate1 +'/'+ this.pageSelect + '/?page=' + page)
                        .then(response => {
                            if (response.data == "Invalid department") {
                                this.$toastr.e("You do not have access to search other departments' requisition(s)", "Caution!");
                            }
            ...
            getResult(page = 1) {
                if (this.pageSelect == 'All') {
                    axios.get('accounts/get_requisition_assets', { params: { pages: this.pageSelect } })
                        .then(response => this.adsdata = response)
                        .catch(error => { });
                } else {
                    axios.get('accounts/get_requisition_assets/?page=' + page, { params: { pages: this.pageSelect } })
            ...
            getResults(page = 1) {
                if (this.pageSelect == 'All') {
                    axios.get('accounts/searchbyreqid_assets/' + this.keyword1 + '/' + this.pageSelect)
                        .then(response => {
                            this.adsdata = response
                        })
                } else {
                    axios.get('accounts/searchbyreqid_assets/' + this.keyword1 + '/' + this.pageSelect + '/?page=' + page)
                        .then(response => {
                            this.adsdata = response.data
                        })
        ...
        mounted() {
            ...
            axios.get('accounts/count_requisitions_assets')
