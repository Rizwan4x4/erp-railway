                            ...
                            <div class="card">
                                <div class="card-body d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="avatar bg-light-warning p-50">
                                        <span class="avatar-content" v-popover.left="{name:'foo', enent:'hover'}" @click="inv_reqCounter('all', 'Services')">
                            ...
                            <div class="card">
                                <div class="card-body d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="avatar bg-light-primary p-50">
                                        <span class="avatar-content" v-popover.left="{name:'foo'}" @click="inv_reqCounter('Approved', 'Services')">
                            ...
                            <div class="card">
                                <div class="card-body d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="avatar bg-light-info p-50">
                                        <span class="avatar-content" v-popover.left="{name:'foo'}" @click="inv_reqCounter('Pending', 'Services')">
                            ...
                            <div class="card">
                                <div class="card-body d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="avatar bg-light-success p-50">
                                        <span class="avatar-content" v-popover.left="{name:'foo'}" @click="inv_reqCounter('Issued', 'Services')">
                                            <i class="fa-solid fa-user-large-slash"></i>
                                        </span>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <ul class="nav nav-pills mb-2" style="padding-left:20px !important">
                                ...
                                <li class="nav-item col-md-4">
                                    <router-link to="/purchase/purchase_services_requisition" class="nav-link active">
                                ...
                                <div class="col-sm-12 col-lg-12 ps-xl-75 ps-0">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input type="date" class="form-control" v-model="closingdate" placeholder="" required="">
                                                    ...
                                                    <div class="col-md-1 ">
                                                        <button @click="filter_byStatus()" class="btn btn-secondary" style="margin-left: 10px;background: rgb(193, 193, 193); width: 80% !important; height: 33px !important; margin-bottom: 20px; margin-top: 25px;">Search</button>
                                                    </div>
                                                    <div class="col-md-2 ">
                                                    ...
                                                    <div class="accordion-item">
                                                        <div class="accordion-header  d-flex" :id="'headingBorder'+adsdata1.RequisitionId">
                                                            ...
                                                            <div class="col-md-2  mb-3 position-relative mx-1">
                                                                ...
                                                                <span class="badge badge-glow bg-success" v-if="adsdata1.Status2=='Completed'"> {{adsdata1.Status2}}</span>
                                                                ...
                                                                <table class="table table-hover">
                                                                    <thead>
                                                                        <tr>
                                                                            ...
                                                                            <th class="sticky-th-center">Items Detail</th>
...
export default {
    ...
    methods: {
        ...
        filter_byStatus(page = 1) {
            ...
            if (this.pageSelect == 'All') {
                axios.get('accounts_fetch_reqBysts_services/' + this.status + '/' + this.dept_name1 + '/' + this.proj_name + '/' + this.startingdate1 + '/' + this.closingdate1+ '/' + this.pageSelect + '/?page=' + page)
                    .then(response => {
        ...
        getResult(page = 1) {
            if (this.pageSelect == 'All') {
                axios.get('accounts/get_requisition_services', { params: { pages: this.pageSelect } })
                    .then(response => this.adsdata = response)
                    .catch(error => {});
            } else {
                axios.get('accounts/get_requisition_services/?page=' + page, { params: { pages: this.pageSelect } })
        ...
        getResults(page = 1) {
            if (this.pageSelect == 'All') {
                axios.get('accounts/searchbyreqid_services/' + this.keyword1 + '/' + this.pageSelect)
                    .then(response => {
                        this.adsdata = response
                    })
            } else {
                axios.get('accounts/searchbyreqid_services/' + this.keyword1 + '/' + this.pageSelect + '/?page=' + page)
                    .then(response => {
                        this.adsdata = response.data
                    })
    ...
    mounted() {
        ...
        axios.get('accounts/count_requisitions_services')
