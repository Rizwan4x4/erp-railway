                    ...
                    <div class="card top-radius bottom-radius border-0">
                        <div style="margin-bottom:20px;padding-top:20px"
                            ...
                            <div class="col-md-10">
                                <div
                                    ...
                                    <div class="col-md-1">
                                        <a @click="clear()" style="float:left"
                                            class="btn btn-outline-secondary waves-effect">Clear</a>
                                    </div>
                                    <div class="col-md-5">
                                        <input type="text" v-model="keyword1" class="form-control"
                                            placeholder="Search By PO Code / Vendor Name / Req. ID" />
                                    </div>
                                    <div class="col-md-2">
                                        <select @change="filter_byStatus()" v-model="status1"
                        ...
                        <div class="table-responsive" style="overflow-x: initial !important;">
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                                        <th class="sticky-th-center">PO ID</th>
                                        <th class="sticky-th-center">PO Date</th>
                                        ...
                                        <th class="sticky-th-center">Delivery</th>
                                        <th class="sticky-th-center">Total</th>
                                        ...
                                        <td class="td-center">
                                            <div v-if="hasPermission('Purchase Orders Actions')"
                                                ...
                                                <a class="me-25" data-bs-toggle="modal"
                                                    @click="editPurOrder(adsdata1.PurchaseOrderID)"
                                                    data-bs-target="#viewPO">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <a target="_blank"
                                                        v-bind:href="`Accounts/PO_letter/${adsdata1.PurchaseOrderID}/${adsdata1.PoCode}`"
                                                        class="dropdown-item">
                                                        <i class="fa-brands fa-creative-commons-sa"></i>
                                                        Print PO
                                                    </a>
                                                    <a class="dropdown-item"
                                                        v-if="adsdata1.RequisitionType === 'Services'" target="_blank"
                                                        v-bind:href="`Accounts/wordorder_letter/${adsdata1.PurchaseOrderID}/${adsdata1.PoCode}`">
                                                        <i class="fa-brands fa-creative-commons-sa"></i>
                                                        Print WorkOrder
                                                    </a>
                                                    <a class="dropdown-item"
                                                        v-if="adsdata1.Status2 === 'Not Delivered' || adsdata1.Status2 === 'Not Completed'"
                                                        @click="fetch_poid(adsdata1.PurchaseOrderID)"
                        ...
                        <div style="display:flex; justify-content:center; padding-top:20px">
                            <pagination :limit='limit' v-if='pageNo === 4' :data="adsdata"
                                @pagination-change-page="getResults"></pagination>
                            <pagination :limit='limit' v-if='pageNo === 1' :data="adsdata"
                                @pagination-change-page="getResult"></pagination>
                            <pagination :limit='limit' v-else-if='pageNo === 2' :data="adsdata"
                                @pagination-change-page="search_byDate"></pagination>
                            <pagination :limit='limit' v-else-if='pageNo === 3' :data="adsdata"
                                @pagination-change-page="filter_byStatus"></pagination>
                        </div>
                    </div>
                </section>
                <!-- users list ends -->
                            ...
                            <div class="col-xl-12 col-md-12 col-12">
                                <div class="card invoice-preview-card" v-for="perorders1 in perorders">
                                    ...
                                    <div class="card-body  pb-0">
                                        <div class="d-flex justify-content-between flex-md-row flex-column invoice-spacing mt-0"
                                            ...
                                            <div v-for='companydetail1 in companydetail' style="margin-left:30px">
                                                <div style="padding-top:10px;margin-bottom: 0;" class="logo-wrapper">
                                                    <h3 class="text-primary invoice-logo" style="margin-left: 0;">
                                    ...
                                    <div class="card-body invoice-padding pt-0">
                                        <div class="row row-bill-to invoice-spacing" style="margin-top:0">
                                            <div class="col-xl-6 mb-lg-1 col-bill-to ps-0" style="margin:5px;">
                                                <h6 class="invoice-to-title" style="margin-bottom:5px">Against
                                                    Requistion & Quotation<span
                                                        style="color: #DB4437; font-size: 11px;">*</span></h6>
                                                <div class="invoice-customer">
                                                    <select v-model="vendor_n" class="invoiceto form-select" disabled>
                                                        <option value="">Select Quotation</option>
                                                        <option v-for='requisitions1 in requisitions'
                                                            :value='requisitions1.VendorName'>{{
                                                            requisitions1.RId}}_{{ requisitions1.VendorName }}</option>
                                                    </select>
                                                </div>
                                                <div class="form-group">
                                                    <label>Vendor Name</label>
                                                    <input v-model="vendor_n" type="text" class="form-control"
                                                        readonly />
                                                </div>
                                                ...
                                                <div class="mb-1">
                                                    ...
                                                    <div class="demo-inline-spacing">
                                                        <div class="form-check form-check-inline" style="margin-top:0">
                                                            <input class="form-check-input" type="radio"
                                                                v-model="status" name="inlineRadioOptions"
                                                                id="inlineRadio1" value="Full" checked="">
                                                            <label class="form-check-label"
                                                                for="inlineRadio1">Full</label>
                                                        </div>
                                                        <div class="form-check form-check-inline" style="margin-top:0">
                                                            <input class="form-check-input" type="radio"
                                                                v-model="status" name="inlineRadioOptions"
                                                                id="inlineRadio2" value="Partial">
                                                            <label class="form-check-label"
                                                                for="inlineRadio2">Partial</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-5 p-0 ps-xl-2 mt-xl-0 mt-2"
                                                style="border:1px solid lightgrey;border-radius:4px !important">
                                    ...
                                    <div class="card-body invoice-padding invoice-product-details">
                                        <div v-for="(get_po_detail11, index) in poProducts" class="source-item"
                                                ...
                                                <div class="repeater-wrapper" data-repeater-item>
                                                    <div class="row w-100 pe-lg-0 pe-1 py-2" style="min-width:103%">
                                                        ...
                                                        <div class="col-lg-2 col-12 my-lg-0 my-2">
                                                            ...
                                                            <input :value='get_po_detail11.QuoteQuantity' type="number"
                                                                readonly class="form-control" name="fiveth[]" />
                                                        </div>
                                                        <div class="col-lg-2 col-12 my-lg-0 my-2"
                                                            style="max-width:13%;">
                                                            <p class="card-text col-title mb-md-2 mb-0">Ordered Qty</p>
                                                            <input @change="sum_total()" type="number"
                                                                class="form-control" name="fourth[]" />
                                                        </div>
                                                        <div class="col-lg-1 col-12 my-lg-0 my-2" style="min-width:13%">
                                                            <p class="card-text col-title mb-md-2 mb-0">Unit Cost</p>
                                                            <input name="third[]" readonly type="number"
                                                                class="form-control"
                                                        ...
                                                        <div class="col-lg-2 col-12 my-lg-0 my-2"
                                                            ...
                                                            <input name="sixth[]" readonly type="text"
                                                                class="form-control" :value='get_po_detail11.Unit' />
                                                        </div>
                                                        <div class="col-lg-2 col-12 my-lg-0 my-2">
                                                            <p class="card-text col-title mb-md-2 mb-0">Price</p>
                                                            <p readonly name="second[]" :id="'demo_' + (index)"
                                                                class="form-control card-text col-title mb-md-50 mb-0"
                                                                style="padding-left: 10px; max-width: 100px; height: 35px;">
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row invoice-sales-total-wrapper">
                                            ...
                                            <div class="col-md-6 d-flex justify-content-end order-md-2 order-2">
                                                ...
                                                <div class="invoice-total-wrapper">
                                                    ...
                                                    <div class="invoice-total-item">
                                                        <p class="invoice-total-amount">
                                                            <input @change="sum_total()" v-model="discount"
                        ...
                        <div class="modal-content">
                            ...
                            <div class="col-xl-12 col-md-12 col-12">
                                <div class="card invoice-preview-card" v-for="perorders1 in perorders">
                                    ...
                                    <div class="divider">
                                        <div class="divider-text" style="font-size: 24px;font-weight: 900;">Purchase
                                            Order</div>
                                    </div>
                                    <!-- Address and Contact starts -->
                                    <div class="card-body invoice-padding pt-0">
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <tr v-for="poProducts1 in poProducts">
                                                    ...
                                                    <td>
                                                        <span
                                                            class="fw-bold">{{ Number(poProducts1.Price).toLocaleString() }}</span>
                                                    </td>
                                                    <td>
                                                        <span
                                                            class="fw-bold">{{ Number(poProducts1.SubTotal).toLocaleString() }}</span>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body pb-5 px-sm-5 pt-50">
                    <div class="text-center mb-2">
                        <div class="col-md-12">
                            <h6>Are You Sure You Want To Reverse The PO?</h6>
                        </div>
...
export default {
    ...
    methods: {
        ...
        filter_byStatus(page = 1) {
            ...
            this.datefrom = "";
            this.dateto = "";
            axios.get('accounts_fetch_PObySts/' + this.status1 + '/?page=' + page)
                .then(response => {
        ...
        getResult(page = 1) {
            this.pageNo = 1
            axios.get('accounts/get_po_detail/?page=' + page)
        ...
        getResults(page = 1) {
            ...
            this.datefrom = "";
            this.dateto = "";
            axios.get('./accounts_PObyName/?page=' + page, { params: { name: this.keyword1, status: this.status } })
                .then(response => this.adsdata = response.data)
                .catch();
            this.pageNo = 4;
        },
        search_byDate(page = 1) {
            ...
            axios.get('accounts_get_po_bydate/' + this.datefrom1 + '/' + this.dateto1 + '/?page=' + page)
                .then(response => {
                    this.adsdata = response.data;
                })
            this.pageNo = 2;
