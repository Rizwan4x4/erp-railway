            ...
            <div class="content-wrapper container-xxl p-0">
                ...
                <div class="content-body">
                    <section class="app-user-view-account">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div id="accordionWrapa50" role="tablist" aria-multiselectable="true">
                                                    <!-- <div class="card"> -->
                                                    <div class="card-header px-0 py-2 border-bottom">
                                                        <h4 class="card-title">HR Configuration</h4>
                                                    </div>
                                                    <div class="card-body p-0">

                                                        <div class="row">
                                                            <div class="col-md-6 col-sm-3 mb-2 mt-2">
                                                                <label class="form-label" for="accountFirstName">Gratuty
                                                                    Start From
                                                                    (Days)</label>
                                                                <label style="color: #d93025">*</label>
                                                                <input type="number" class="form-control"
                                                                    id="accountFirstName" v-model="gratuty_start">
                                                                <span style="color: #DB4437; font-size: 11px;"
                                                                    v-if="this.gratuty_start == ''">{{ e_gratuty_start
                                                                    }}</span>
                                                            </div>
                                                            <div class="col-md-6 col-sm-3 mb-2 mt-2">
                                                                <label class="form-label" for="accountFirstName">Max
                                                                    Loan Allowed (Times of salary)</label>
                                                                <label style="color: #d93025">*</label>
                                                                <input type="number" class="form-control"
                                                                    id="accountFirstName" v-model="max_loan">
                                                                <span style="color: #DB4437; font-size: 11px;"
                                                                    v-if="this.max_loan == ''">{{ e_max_loan }}</span>
                                                            </div>
                                                            <div class="col-md-6 col-sm-3 mb-2">
                                                                <label class="form-label" for="accountFirstName">Minutes
                                                                    Per
                                                                    Deducation</label>
                                                                <label style="color: #d93025">*</label>
                                                                <input type="number" class="form-control"
                                                                    id="accountFirstName" v-model="days_deduction">
                                                                <span style="color: #DB4437; font-size: 11px;"
                                                                    v-if="this.days_deduction == ''">{{ e_days_deduction
                                                                    }}</span>
                                                            </div>
                                                            <div class="col-md-6 col-sm-3 mb-2">
                                                                <label class="form-label"
                                                                    for="accountFirstName">Maximium
                                                                    Installment</label>
                                                                <label style="color: #d93025">*</label>
                                                                <input type="number" class="form-control"
                                                                    id="accountFirstName" v-model="max_installment">
                                                                <span style="color: #DB4437; font-size: 11px;"
                                                                    v-if="this.max_installment == ''">{{
                                                                        e_max_installment }}</span>
                                                            </div>
                                                            <div class="col-md-6 col-sm-3 mb-2">
                                                                <label class="form-label" for="accountFirstName">Annual
                                                                    Leaves (after
                                                                    probation)</label>
                                                                <label style="color: #d93025">*</label>
                                                                <input type="number" class="form-control"
                                                                    id="accountFirstName" v-model="annual_leaves">
                                                                <span style="color: #DB4437; font-size: 11px;"
                                                                    v-if="this.annual_leaves == ''">{{ e_annual_leaves
                                                                    }}</span>
                                                            </div>
                                                            <div class="col-md-6 col-sm-3 mb-2">
                                                                <label class="form-label" for="accountFirstName">Sick
                                                                    Leaves (per fiscal
                                                                    year)</label>
                                                                <label style="color: #d93025">*</label>
                                                                <input type="number" class="form-control"
                                                                    id="accountFirstName" v-model="sick_leaves">
                                                                <span style="color: #DB4437; font-size: 11px;"
                                                                    v-if="this.sick_leaves == ''">{{ e_sick_leaves
                                                                    }}</span>
                                                            </div>

                                                            <div class="col-md-6 col-sm-3 mb-2">
                                                                <label class="form-label" for="accountFirstName">Casual
                                                                    Leaves (per fiscal
                                                                    year)</label>
                                                                <label style="color: #d93025">*</label>
                                                                <input type="number" class="form-control"
                                                                    id="accountFirstName" v-model="casual_start">
                                                                <span style="color: #DB4437; font-size: 11px;"
                                                                    v-if="this.casual_start == ''">{{ e_casual_start
                                                                    }}</span>
                                                            </div>
                                                            <div class="col-md-4 col-sm-3 mb-2"
                                                                style="padding-top: 25px; margin: auto;">
                                                                <button
                                                                    v-if="hasPermission('HR Controller hr configuration update')"
                                                                    type="submit" :disabled="disabled3"
                                                                    @click="delay3()" style="width:100%"
                                                                    class="btn btn-primary bg-primary me-1 mt-1 bg-primary">Update</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!-- </div> -->
                        ...
                        <div class="row">
                            <div class="col-xl-12  col-md-12 order-1 order-md-0">
                                <!-- User Card -->
                                                ...
                                                <div class="col-sm-12">
                                                    <div id="accordionWrapa50" role="tablist"
                                                        ...
                                                        <div class="card-header px-0 py-2">
                                                            ...
                                                            <router-link :to="{ name: 'accounts_session' }"
                                                                class="btn btn-outline-primary waves-effect text-secondary float-end">Go
                                                                to
                                                                ...
                                                                <table class="table">
                                                                    ...
                                                                    <tbody>
                                                                        <tr class="odd"
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                <span
                                                                                    ...
                                                                                    <a
                                                                                        ...
                                                                                        <span
                                                                                            @click="fetch_session_id(adsdata1.SessionID)"
                                                                            ...
                                                                            <td>
                                                                                <a @click="delete_session(adsdata1.SessionID)"
                                                                                    class="text-danger">
                                                ...
                                                <div class="col-sm-12">
                                                    <div id="accordionWrapa50" role="tablist"
                                                        ...
                                                        <div class="card-header px-0 py-2">
                                                            ...
                                                            <a v-if="hasPermission('HR Controller Add leave type')"
                                                                data-bs-toggle="modal" data-bs-target="#leavetype"
                                                        ...
                                                        <div class="card-body p-0">
                                                            <div class="table-responsive"
                                                                ...
                                                                <table class="table">
                                                                    ...
                                                                    <tbody>
                                                                        <tr class="odd"
                                                                            v-for="l_types1 in l_types.data">
                                                                            <td>{{ l_types1.LeaveType }}</td>
                                                                            <td>
                                                                                <a v-if="hasPermission('HR Controller delete leave type')"
                                                                                    @click="delete_leave(l_types1.LeaveID)"
                                                                                    class="me-25">
                                                                                    <i style="color:#d42f2f"
                                                            ...
                                                            <div style="text-align:center;padding-top:20px">
                                                                <pagination :data="l_types"
                                                                    @pagination-change-page="getResult3">
                                                                </pagination>
                                                            </div>
                                                        </div>
                                                        <!-- </div> -->
                                                ...
                                                <div class="col-sm-12">
                                                    <div id="accordionWrapa50" role="tablist"
                                                        ...
                                                        <div class="card-header px-0 py-2">
                                                            ...
                                                            <a v-if="hasPermission('HR Controller inchlude holiday')"
                                                                data-bs-toggle="modal" data-bs-target="#addNewCard"
                                                                class="btn btn-outline-primary waves-effect">Include
                                                                Holiday</a>
                                                        </div>
                                                        <div class="card-body p-0">
                                                            <div class="table-responsive"
                                                                ...
                                                                <table class="table">
                                                                    ...
                                                                    <tbody>
                                                                        <tr class="odd"
                                                                            v-for="holiday_data1 in holiday_data.data">
                                                                            <td>{{ holiday_data1.HolidayName }}</td>
                                                                            <td>{{ holiday_data1.holidaystartDate }}
                                                                            </td>
                                                                            <td>{{ holiday_data1.HolidayEndDate }}
                                                                            </td>
                                                                            <td>{{ holiday_data1.NoOfDays }}</td>
                                                                            <td>
                                                                                <a v-if="hasPermission('HR Controller delete holiday')"
                                                                                    @click="delete_holiday(holiday_data1.HolidayID)"
                                                                                    class="me-25">
                                                                                    <i style="color:#d42f2f"
                                                                                        class="fa-solid fa-trash"></i>
                                                                                </a>
                                                ...
                                                <div class="col-sm-12">
                                                    <div id="accordionWrapa50" role="tablist"
                                                        ...
                                                        <div class="card-header px-0 py-2">
                                                            ...
                                                            <a v-if="hasPermission('HR Controller add new fine')"
                                                                data-bs-toggle="modal" data-bs-target="#finemodal"
                                                                class="btn btn-outline-primary waves-effect">Add New
                                                                Fine</a>
                                                        </div>
                                                        <div class="card-body p-0">
                                                            <div class="table-responsive"
                                                                ...
                                                                <table class="table">
                                                                    ...
                                                                    <tbody>
                                                                        <tr class="odd"
                                                                            v-for="finedetail1 in finedetail.data">
                                                                            ...
                                                                            <td>
                                                                                <a @click="delete_fine(finedetail1.FineId)"
                                                                                    class="me-25">
                                                                                    <i style="color:#d42f2f"
                                                                                        class="fa-solid fa-trash"></i>
                                                                                </a>
                                                            ...
                                                            <div style="text-align:center;padding-top:20px">
                                                                <pagination :data="finedetail"
                                                                    @pagination-change-page="getResult4"></pagination>
                                                            </div>
                                                        </div>
                                                        <!-- </div> -->
                                                    </div>
                                                ...
                                                <div class="col-sm-12">
                                                    <div id="accordionWrapa50" role="tablist"
                                                        ...
                                                        <div class="card-header px-0 py-2">
                                                            ...
                                                            <a v-if="hasPermission('HR Controller warning reason add new')"
                                                                data-bs-toggle="modal" data-bs-target="#addWarnReas"
                                                                class="btn btn-outline-primary waves-effect">+ Add
                                                                new</a>
                                                        </div>
                                                        <div class="card-body p-0">
                                                            <div class="table-responsive"
                                                                ...
                                                                <table class="table">
                                                                    ...
                                                                    <tbody>
                                                                        <tr class="odd"
                                                                            v-for="warning_reason1 in warning_reason.data">
                                                                            <td>{{ warning_reason1.ReasonName }}</td>
                                                                            <td v-html="warning_reason1.ReasonContent">
                                                                            </td>

                                                                            <td class="td-center">
                                                                                <div class="btn-group">
                                                                                    <a v-if="hasPermission('HR Controller warning reason actions')"
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <a @click="delete_warn_reason(warning_reason1.ReasonID)"
                                                                                            class="dropdown-item">
                                                                                            <i
                                                                                                class="fa-solid fa-trash"></i>
                                                                                            Delete Warning
                                                                                        ...
                                                                                        <a class="dropdown-item"
                                                                                            data-bs-toggle="modal"
                                                                                            data-bs-target="#EditWarning"
                                                                                            @click="Edit_warn_reason(warning_reason1.ReasonID)">
                                                                                            <i
                                                            ...
                                                            <div style="text-align:center;padding-top:20px">
                                                                <pagination :data="warning_reason"
                                                                    @pagination-change-page="getResult5">
                                                                </pagination>
                                                            </div>
                                                        </div>
                                                        <!-- </div> -->
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body pb-5 px-sm-5 pt-50">
                                            <form id="addNewCardValidation" class="row gy-1 gx-2 mt-75"
                                                ...
                                                <div class="col-12">
                                                    <label class="form-label" for="modalAddCardName">Warning
                                                        Reason</label>
                                                    <input disabled v-model="edit_warning_reason" type="text"
                                                        class="form-control" />
                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <vue-editor v-model="edit_warning_description" class="form-control"
                                                        placeholder="Reason Description"></vue-editor>

                                                </div>
                                                <div class="col-12 text-center">

                                                    <button type="submit" :disabled="disabled1"
                                                        @click="update_Warning()" class="btn btn-primary bg-primary me-1 mt-1"
                    ...
                    <div class="modal fade" id="addWarnReas" tabindex="-1" aria-labelledby="addNewCardTitle"
                        aria-hidden="true">
                                ...
                                <div class="modal-body px-sm-5 mx-50 pb-5">
                                    <form id="addNewCardValidation" class="row gy-1 gx-2 mt-75" onsubmit="return false">
                                        <div class="col-12">
                                            ...
                                            <input type="text" v-model="reason_name" class="form-control"
                                                placeholder="Reason Name">
                                            <span style="color: #DB4437; font-size: 11px;" v-if="reason_name == ''">{{
                                                e_reason_name }}</span>
                                        </div>
                                        <div class="col-md-12">
                                            <label class="form-label" for="modalAddCardName">Reason Description</label>
                                            <span style="color: #DB4437; font-size: 11px;">*</span>
                                            <vue-editor v-model="reason_desc" class="form-control"
                                                placeholder="Reason Description"></vue-editor>

                                            <span style="color: #DB4437; font-size: 11px;" v-if="reason_desc == ''">{{
                                                e_reason_desc }}</span>
                                        </div>
                                        <div class="col-12 text-center">
                                            <button type="submit" :disabled="disabled5" @click="delay5()"
                    ...
                    <div class="modal fade" id="addNewCard" tabindex="-1" aria-labelledby="addNewCardTitle"
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header bg-transparent">
                                    <h3 class="text-center mb-1" id="addNewCardTitle">Include Holiday</h3>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                        aria-label="Close"></button>
                                </div>
                                <div class="modal-body px-sm-5 mx-50 pb-5">
                                    <form id="addNewCardValidation" class="row gy-1 gx-2 mt-75" onsubmit="return false">
                                        <div class="col-12">
                                            ...
                                            <span style="color: #DB4437; font-size: 11px;"
                                                v-if="h_holiday_name == ''">{{ e_holiday_name }}</span>
                                        </div>
                                        <div class="col-md-12">
                                            <label class="form-label" for="modalAddCardName">Date From</label>
                                            <span style="color: #DB4437; font-size: 11px;">*</span>
                                            <input v-model="h_date_from" type="date" id="modalAddCardName"
                                                class="form-control" />
                                            <span style="color: #DB4437; font-size: 11px;" v-if="h_date_from == ''">{{
                                                e_date_from }}</span>
                                        </div>
                                            ...
                                            <div class="row demo-inline-spacing" style="padding-left: 5%;">
                                                <div class="col-md-5 form-check form-check-inline"
                                                    ...
                                                    <input class="form-check-input" type="radio" v-model="days"
                                                        name="inlineRadioOptions" id="inlineRadio1" value="One Day"
                                                        checked="">
                                                ...
                                                <div class=" col-md-5 form-check form-check-inline"
                                                    ...
                                                    <input class="form-check-input" type="radio" v-model="days"
                                                        ...
                                                        value="Multiple Days">
                                                    <label class="form-check-label" for="inlineRadio2">Multiple
                                                        Days</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div v-if="this.days == 'Multiple Days'" class="col-md-12">
                                            ...
                                            <input v-model="h_date_to" type="date" id="modalAddCardName"
                                                class="form-control" />
                                        </div>
                                        <div class="col-md-12">
                                            <label class="form-label" for="modalAddCardName">Description</label>
                                            <input v-model="h_description" type="text" id="modalAddCardName"
                                                class="form-control" />
                                        </div>
                                        <div class="col-12 text-center">
                    ...
                    <div class="modal-body pb-5 px-sm-5 pt-50">
                        <div class="text-center mb-2">
                            ...
                            <div class="text-center" style="text-align:center">
                                <button type="button" @click="update_session_payroll()"
                                    class="btn btn-primary bg-primary waves-effect waves-float waves-light" data-bs-dismiss="modal"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body px-sm-5 mx-50 pb-5">
                        <form id="addNewCardValidation" class="row gy-1 gx-2 mt-75" onsubmit="return false">
                            <div class="col-12">
                                ...
                                <select v-model="emp_emp_id" class="form-control">
                                    ...
                                    <option v-for='find_emp1 in find_emp' :value='find_emp1.EmployeeID'>{{
                                        find_emp1.EmployeeCode }}-{{ find_emp1.Name }}</option>
                                </select>
                                <span style="color: #DB4437; font-size: 11px;" v-if="emp_emp_id == ''">{{ e_emp_id
                                }}</span>
                            </div>
                            <div class="col-md-12">
                                ...
                                <span style="color: #DB4437; font-size: 11px;" v-if="emp_amount == ''">{{ e_emp_amount
                                }}</span>
                            </div>
                            <div class="col-md-12">
                            ...
                            <div class="col-12 text-center">
                                <button type="submit" :disabled="disabled4" @click="delay4()"
                                    class="btn btn-primary bg-primary me-1 mt-1" data-bs-dismiss="modal"
                                    aria-label="Close">Submit</button>
                                <button type="reset" class="btn btn-outline-secondary mt-1" data-bs-dismiss="modal"
                                    aria-label="Close">
...
export default {
    ...
    methods: {
        update_Warning() {
            axios.post('update_warningdetail', {
                warnReasonName: this.edit_warning_reason,
                warnReasonDesc: this.edit_warning_description,
                warnReasonID: this.warn_id,
            })
                .then(data => {
                    if (data.data == 'Warning Updated')
        ...
        Edit_warn_reason(id) {
            axios.get('get_warningreason_byId/' + id)
                .then(response => {
                    console.log("warning reason by id ", response.data[0].ReasonContent)
                    this.edit_warning_description = response.data[0].ReasonContent;
                    this.edit_warning_reason = response.data[0].ReasonName;
                    this.warn_id = response.data[0].ReasonID;
                })
        },
        delay1() {
            this.disabled1 = true
        ...
        update_session_payroll() {
            axios.get('update_payroll_status/' + this.fetch_sessoin_id)
                .then(response => {
                    if (response.data == 'session closed') {
                        this.getResult();
                        this.$toastr.s("Session Closed and Salaries process started!", "Information!");
                    }
                })
            // this.$router.go(0);
        },
        ...
        submit_holiday() {
            if (!this.h_date_to == "") {
                if (this.h_date_to < this.h_date_from) {

                    this.$toastr.e("Date To cannat be smaller then Date From!", "Caution!");
                }
            }
