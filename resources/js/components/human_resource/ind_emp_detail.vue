                                            ...
                                            <ul class="list-unstyled">
                                                <li class="mb-75">
                                                    <span class="fw-bolder me-25">Father<span
                                                        v-if="emp_detail1.Gender!='Male' || emp_detail1.MaritalStatus!='Single'">/Husband</span> Name:</span>
                                        ...
                                        <div v-if="emp_detail1.Salary!=null && emp_detail1.Salary!=0"
                                            ...
                                            <div class="d-flex justify-content-center">
                                                ...
                                                <span class="fw-bolder display-5 mb-0 text-primary"
                                                      style="font-size:18px">{{ Math.floor(emp_detail1.Salary).toLocaleString() }}</span>
                                                <sub
                                        ...
                                        <div v-if="allowance > '0'"
                                            ...
                                            <div class="d-flex justify-content-center">
                                                ...
                                                <span class="fw-bolder display-5 mb-0 text-secondary"
                                                      style="font-size:18px">{{ Math.floor(allowance).toLocaleString() }}</span>
                                                <sub
                                                    class="pricing-duration font-small-4 ms-25 mt-auto mb-2">/month</sub>
                                            </div>
                                        </div>
                                        <div v-if="stipend!='0'"
                                            ...
                                            <div class="d-flex justify-content-center">
                                                ...
                                                <span class="fw-bolder display-5 mb-0 text-success"
                                                      style="font-size:18px">{{ Math.floor(stipend).toLocaleString() }}</span>
                                                <sub
                                                    class="pricing-duration font-small-4 ms-25 mt-auto mb-2">/month</sub>
                                            </div>
                                        </div>
                                        <div v-if="com_year > '1'"
                                            ...
                                            <div class="d-flex justify-content-center">
                                                ...
                                                <span class="fw-bolder display-5 mb-0 text-danger"
                                                      style="font-size:18px">{{ Math.floor((com_year - 1) * emp_detail1.Salary).toLocaleString() }}</span>
                                                <sub
                                                    ...
                                                    <li class="timeline-item">
                                                        ...
                                                        <div class="timeline-event">
                                                            <div
                                                                ...
                                                                <span
                                                                    class="timeline-event-time me-1">{{ exp_detail1.StartingDate | formatDate1 }} to {{ exp_detail1.LeavingDate | formatDate1 }}</span>
                                                            </div>
                                                        ...
                                                        <td v-else v-for="emp_warning1 in emp_warning">
                                                            <div class="demo-inline-spacing">
                                                                <router-link
                                                                    ...
                                                                    <span
                                                                        class="badge badge-glow bg-info">First-{{ emp_warning1.ReasonSubject }}</span>
                                                                </router-link>
                                                                <router-link
                                                                    :title="'Issued on '+emp_warning1.DateIssued+'\nClick to view Details'"
                                                                    :to="{ name: 'warning_view', params: { id: emp_warning1.LetterID }}"
                                                                    ...
                                                                    style="cursor:pointer;">
                                                                    <span
                                                                        class="badge badge-glow bg-warning">Second-{{ emp_warning1.ReasonSubject }}</span>
                                                                </router-link>
                                                                <router-link
                                                                    :title="'Issued on '+emp_warning1.DateIssued+'\nClick to view Details'"
                                                                    :to="{ name: 'warning_view', params: { id: emp_warning1.LetterID }}"
                                                                    ...
                                                                    style="cursor:pointer;">
                                                                    <span class="badge badge-glow bg-danger">Terminated-{{ emp_warning1.ReasonSubject }}</span>
                                                                </router-link>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                ...
                                                <table class="table table-hover">
                                                    ...
                                                    <tr v-for="leaves1 in leaves">
                                                        ...
                                                        <td class="text-center">{{ leaves1.StartDate }}<br/><span
                                                            v-if="leaves1.NoOfDays > 1">to<br/>{{ leaves1.EndDate }}</span>
                                                        </td>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-hover">
                                                    ...
                                                    <tr v-for='Sal_detail1 in Sal_detail'>
                                                        <td style="text-align:left">{{ Sal_detail1.SessionName }}</td>
                                                        <td style="text-align:left">{{ Sal_detail1.MethodType }}</td>
                                                        <td style="text-align:left">
                                                            {{ Math.floor(Sal_detail1.Salary).toLocaleString() }}
                                                        </td>
                                                        <td style="text-align:left">
                                                            {{ Number(Sal_detail1.BonusAmount) + Number(Sal_detail1.AllowanceAmount) + Number(Sal_detail1.StipendAmount) + Number(Sal_detail1.OAmount) }}
                                                        </td>
                                                        <td style="text-align:left">
                                                            {{ Number((Sal_detail1.Fine) + Number(Sal_detail1.DAmount) + Number(Sal_detail1.InstallmentAmount)).toLocaleString() }}
                                                        </td>
                                                        <td style="text-align:left">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>
                                                            <div style="text-align:left;">Manager<br/>Approval</div>
                                                        </th>
                                                        <th>
                                                                ...
                                                                <div :id="'accordionBorder'+loans1.LoanId"
                                                                    ...
                                                                    <div class="accordion-body">
                                                                        ...
                                                                        <h5 class="card-header"
                                                                            style="padding:0px !important;">Installments
                                                                            detail</h5>
                                                                        <table class="table">
                                                                            <thead>
                                                                            <tr>
