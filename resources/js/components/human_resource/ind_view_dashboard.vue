                                    ...
                                    <div class="card" data-v-step="7">
                                        <div class="card-body pb-50" style="position: relative;">
                                            ...
                                            <a  data-bs-toggle="modal"
                                               data-bs-target="#markAttendance" style="width:100%;"
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tr v-for="attendance1 in attendance"
                                                ...
                                                <td class="text-center"
                                                    ...
                                                    <svg
                                                        v-if="attendance1.CheckOutBy=='Manual_Attendance' && attendance1.CheckOut"
                                                        xmlns="http://www.w3.org/2000/svg" height="1.2em"
                                                        viewBox="0 0 640 512">
                                                    ...
                                                    <svg
                                                        v-else-if="attendance1.CheckOutBy=='Auto_CheckOut' && attendance1.CheckOut"
                                                        xmlns="http://www.w3.org/2000/svg" height="1.2em"
                                                        title="Auto Checkout"
                                                        viewBox="0 0 512 512">
                                                    ...
                                                    <svg
                                                        v-else-if="attendance1.CheckOutBy=='Machine_Attendance' && attendance1.CheckOut"
                                                        xmlns="http://www.w3.org/2000/svg" height="1.2em"
                                                        viewBox="0 0 512 512">
                                                ...
                                                <td class=" text-center text -danger"
                                                    v-if="attendance1.CheckOut < attendance1?.ClosingTime" title="Early">
                                                ...
                                                <td class="text-center fw-bold"
                                                    ...
                                                    {{
                                                        calculateTimeDifference(attendance1.CheckIN, attendance1.CheckOut)
                                                    }}
                                                </td>
                                                <td class="text-center" v-else>-</td>
                                                <td class="text-center">
                                                    ...
                                                    <g id="SvgjsG2048" class="apexcharts-inner apexcharts-graphical"
                                                       transform="translate(57.60058403015137, 10)">
                                                        ...
                                                        <line id="SvgjsLine2053" x1="0" y1="0" x2="0"
                                                              y2="186.0296284866333" stroke="#b6b6b6"
                                                              stroke-dasharray="3" class="apexcharts-xcrosshairs" x="0"
                                                              y="0" width="1" height="186.0296284866333" fill="#b1b9c4"
                                                            ...
                                                            <g id="SvgjsG2057" class="apexcharts-series"
                                                               ...
                                                               data:realIndex="0">
                                                                <path id="SvgjsPath2065"
                                                                      ...
                                                                      pathFrom="M -1 260.4414798812866L -1 260.4414798812866L 53.93046032298695 260.4414798812866L 107.8609206459739 260.4414798812866L 161.79138096896085 260.4414798812866L 215.7218412919478 260.4414798812866L 269.65230161493474 260.4414798812866L 323.5827619379217 260.4414798812866L 377.51322226090866 260.4414798812866L 431.4436825838956 260.4414798812866L 485.3741429068825 260.4414798812866L 539.3046032298695 260.4414798812866L 593.2350635528564 260.4414798812866"></path>
                                                                <g id="SvgjsG2058"
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar rounded">
                                                                <div class="avatar-content">
                                                                    <img
                                                                        src="public/app-assets/images/icons/toolbox.svg"
                                                                        alt="Toolbar svg"/>
                                                                </div>
                                                            </div>
                                                            <div>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar rounded">
                                                                <div class="avatar-content">
                                                                    <img
                                                                        src="public/app-assets/images/icons/parachute.svg"
                                                                        alt="Parachute svg"/>
                                                                </div>
                                                            </div>
                                                            <div>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar rounded">
                                                                <div class="avatar-content">
                                                                    <img
                                                                        src="public/app-assets/images/icons/speaker.svg"
                                                                        alt="Speaker svg"/>
                                                                </div>
                                                            </div>
                                                            <div>
                        ...
                        <div class="modal-body pb-5 px-sm-5 pt-50">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    <thead>
                                    <tr>
                                        <th class="text-center" style="vertical-align:middle !important">For Date</th>
                                        <th class="text-center" style="vertical-align:middle !important">Leave<br/>Type
                                        </th>
                                        <th style="vertical-align:middle !important">Reason</th>
                                        <th class="text-center" style="vertical-align:middle !important">Manager<br/>status
                                        </th>
                                        <th class="text-center" style="vertical-align:middle !important">HR<br/> status
                                        </th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr v-for="this_m_lvs1 in this_m_lvs">
                                        <td class="text-center" style="vertical-align:middle;">
                                            ...
                                            v-if="this_m_lvs1.NoOfDays > 1">to<br/>{{ this_m_lvs1.EndDate }}</label>
                                        </td>
                                        <td class="text-center" style="vertical-align:middle;">
                                            {{ this_m_lvs1.Leavetype }}
                                        </td>
                                        <td style="vertical-align:middle;">{{ this_m_lvs1.Reason }}</td>
                                        <td v-if="this_m_lvs1.ManagerApproval=='Approved'" class="text-center"><span
                                            class="badge bg-gradient-success">Approved</span></td>

                                        <td v-else-if="this_m_lvs1.ManagerApproval=='Rejected'" class="text-center">
                                            <span class="badge bg-gradient-danger">Rejected</span></td>
                                        ...
                                        <td v-if="this_m_lvs1.HRApproval=='Approved'" class="text-center"><span
                                            class="badge bg-gradient-success">Approved</span></td>
                                        <td v-else-if="this_m_lvs1.HRApproval=='Rejected'" class="text-center"><span
                                            class="badge bg-gradient-danger">Rejected</span></td>
                        ...
                        <div class="modal-body pb-5 px-sm-3 mx-50">
                            ...
                            <form style="text-align:left;" class="row gy-1 gx-2">
                                ...
                                <div class="col-12 col-md-3">
                                    ...
                                    <span style="color: #DB4437; font-size: 11px;"
                                          v-if="amount==''">{{ amount_error }}</span>
                                    <span style="color: #DB4437; font-size: 11px;" v-if="amount > max_advance">Ammount is too much</span>
                                </div>
                                <div class="col-12 col-md-4">
                                    <label class="form-label">Number of installments</label>
                                    <span v-if="type1=='Loan'" style="color: #DB4437; font-size: 11px;">*</span>
                                    <select v-if="type1=='Loan' && amount!=''" v-model="no_of_inst" class="form-select">
                                ...
                                <div class="col-12 col-md-12">
                                    ...
                                    <span style="color: #DB4437; font-size: 11px;">*</span>
                                    <label v-if="type1=='Loan' && no_of_inst>0 && amount>0" style="float:right;">Each
                            ...
                            <form id="addNewAddressForm" style="text-align:left;" class="row gy-1 gx-2"
                                ...
                                <div class="col-12 text-center">
                                    <button :disabled="disabled1" @click="delay2()" type="submit"
                                            ...
                                            aria-label="Close">Mark Attendance
                                    </button>
                                    <button type="reset" class="btn btn-outline-secondary mt-2" data-bs-dismiss="modal"
                    ...
                    <div class="modal-body pb-5 px-sm-3 mx-50">
                        ...
                        <form style="text-align:left;" class="row gy-1 gx-2" onsubmit="return false">
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <span style="color: #DB4437; font-size: 11px;"
                                      v-if="this.att_date==''">{{ att_date_error }}</span>
                            </div>
                            <div class="col-12 col-md-4">
                                ...
                                <span style="color: #DB4437; font-size: 11px;"
                                      v-if="this.AdjustFor==''">{{ AdjustFor_error }}</span>
                            </div>
                            <div class="col-12 col-md-4">
                                <label class="form-label">Adjust Hours:</label>
                                <input type="number" class="form-control" v-model="Hours" placeholder="Enter hours"/>
                                <span style="color: #DB4437; font-size: 11px;"
                                      v-if="this.Hours==''">{{ Hours_error }}</span>
                                <span style="color: #DB4437; font-size: 11px;" v-if="this.Hours>23">Houres cannot more then 23</span>
                                <span style="color: #DB4437; font-size: 11px;" v-if="this.Hours<0">Houres cannot less then 0</span>
                            </div>
                            <div class="col-12 col-md-4">
                                <label class="form-label">Adjust Minutes:</label>
                                <input type="number" class="form-control" v-model="Minutes" placeholder="Enter minuts"/>
                                <span style="color: #DB4437; font-size: 11px;"
                                      v-if="this.Minutes==''">{{ Minutes_error }}</span>
                                <span style="color: #DB4437; font-size: 11px;" v-if="this.Minutes>59">Minutes cannot more then 59</span>
                                <span style="color: #DB4437; font-size: 11px;" v-if="this.Minutes<0">Minutes cannot less then 0</span>
                            </div>
                            <div class="col-12 col-md-12">
