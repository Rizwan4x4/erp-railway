                ...
                <div class="content-header row">
                    <div class="breadcrumb-wrapper">
                        ...
                        <!-- <b-progress animated show-progress max="100" class="mb-3" :value="percent[0].profile_completion"
                            variant="secondary" :label="`${Number(percent[0].profile_completion)}`">
                        </b-progress> -->
                    </div>
                    <ul class="nav nav-pills mb-2 d-flex justify-content-around text-center gap-4"
                        style="padding-left: 20px;">
                        <li class="nav-item flex-fill">
                            <a class="nav-link custom-tab active" id="empPersonal-tab" data-bs-toggle="tab"
                                href="#empPersonal" role="tab" aria-selected="true">
                                <i class="fa-solid fa-briefcase"></i>
                                <span class="fw-bold">Employment</span>
                            </a>
                        </li>
                        <li class="nav-item flex-fill">
                            <a class="nav-link custom-tab" @click="leavedata()" id="empLeaves-tab" data-bs-toggle="tab"
                                href="#empLeaves" role="tab" aria-selected="false">
                                <i class="fa-solid fa-person-skiing-nordic"></i>
                                <span class="fw-bold">Leaves</span>
                            </a>
                        </li>
                        <li class="nav-item flex-fill">
                            <a class="nav-link custom-tab" @click="attendencedata()" id="empAttendance-tab"
                                data-bs-toggle="tab" href="#empAttendance" role="tab" aria-selected="false">
                                <i class="fa-solid fa-calendar-days"></i>
                                <span class="fw-bold">Attendance</span>
                            </a>
                        </li>
                        <li class="nav-item flex-fill">
                            <a class="nav-link custom-tab" @click="financialdata()" id="empFinancialHistory-tab"
                                data-bs-toggle="tab" href="#empFinancialHistory" role="tab" aria-selected="false">
                ...
                <div class="content-body">
                    <section class="app-user-view-account">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="empPersonal" aria-labelledby="empPersonal-tab"
                                ...
                                <div class="row py-2">
                                    <div v-for='emp_detail1 in emp_detail'
                                        class="col-xl-6 col-lg-6 col-md-5 order-1 order-md-0">
                                                ...
                                                <div class="user-avatar-section">
                                                    <div class="d-flex align-items-center flex-column">
                                                        <img v-if="emp_detail1.Photo == ''"
                                                            ...
                                                            src="images/profile_images/pro.png" height="110" width="110"
                                                            alt="User avatar" />
                                                        <img v-else class="img-fluid rounded mt-3 mb-2"
                                                            v-bind:src="`images/profile_images/${emp_detail1.Photo}`"
                                            ...
                                            <div class="d-flex align-items-start">
                                                ...
                                                <div class="ms-75">
                                                    <h4 class="mb-0">
                                                        ...
                                                        percent.mobile + percent.photo + percent.reporting
                                                        }}%</h4>
                                                    <small>Profile Completed</small>
                                                </div>
                                            </div>
                                        </div> -->
                                                <h4 class="fw-bolder border-bottom py-50 mb-1 fs-5">Personal Details
                                                </h4>
                                                <div class="info-container">
                                                    <ul class="list-unstyled">

                                                        <li class="mb-75">
                                                            <label class="fw-bolder me-25 d-block mb-1">Father
                                                                Name:</label>
                                                            <input type="text" class="form-control bg-transparent"
                                                                :value="emp_detail1.FatherHusband" disabled>
                                                        </li>

                                                        <li class="mb-75">
                                                            <label class="fw-bolder me-25 d-block mb-1">Email:</label>
                                                            <input type="text" class="form-control bg-transparent"
                                                                :value="emp_detail1.Email" disabled>
                                                        </li>

                                                        <li class="mb-75">
                                                            <label class="fw-bolder me-25 d-block mb-1">Date Of
                                                                Birth:</label>
                                                            <input type="text" class="form-control bg-transparent"
                                                                :value="emp_detail1.DOB" disabled>
                                                        </li>

                                                        <li class="mb-75">
                                                            <label class="fw-bolder me-25 d-block mb-1">Gender:</label>
                                                            <input type="text" class="form-control bg-transparent"
                                                                :value="emp_detail1.Gender" disabled>
                                                        </li>

                                                        <li class="mb-75">
                                                            <label
                                                                class="fw-bolder me-25 d-block mb-1">Religion:</label>
                                                            <input type="text" class="form-control bg-transparent"
                                                                :value="emp_detail1.Religion" disabled>
                                                        </li>

                                                        <li class="mb-75">
                                                            <label class="fw-bolder me-25 d-block mb-1">Contact:</label>
                                                            <input type="text" class="form-control bg-transparent"
                                                                :value="emp_detail1.Mobile" disabled>
                                                        </li>

                                                        <li class="mb-75">
                                                            <label class="fw-bolder me-25 d-block mb-1">City:</label>
                                                            <input type="text" class="form-control bg-transparent"
                                                                :value="emp_detail1.City" disabled>
                                                        </li>

                                                        <li class="mb-75">
                                                            <label class="fw-bolder me-25 d-block mb-1">Country:</label>
                                                            <input type="text" class="form-control bg-transparent"
                                                                value="Pakistan" disabled>
                                                        </li>

                                                        <li class="mb-75">
                                                            <label class="fw-bolder me-25 d-block mb-1">Status:</label>
                                                            <input type="text"
                                                                class="form-control bg-transparent fw-bold" :class="{
                                                                    'text-warning': emp_detail1.Status === 'Suspended',
                                                                    'text-success': emp_detail1.Status === 'Registered',
                                                                    'text-primary': emp_detail1.Status === 'Resigned',
                                                                    'text-danger': emp_detail1.Status === 'Terminated'
                                                                }" :value="emp_detail1.Status" disabled>
                                                        </li>
                                                    ...
                                                    <div class="d-flex justify-content-center pt-2 gap-3">
                                                        ...
                                                        <button :disabled="disabled"
                                                            ...
                                                            @click="get_id(emp_detail1.EmployeeID)"
                                                            data-bs-toggle="modal" data-bs-target="#terminate_emp"
                                                        ...
                                                        <button :disabled="disabled"
                                                            ...
                                                            @click="get_id(emp_detail1.EmployeeID)"
                                                            data-bs-toggle="modal" data-bs-target="#suspend_emp">Suspend
                                                        </button>
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-7 order-0 order-md-1">
                                        <div v-for='emp_detail1 in emp_detail'
                                            class="card border-0 top-radius bottom-radius">
                                            <div class="card-header top-radius border-bottom">
                                                <div style="float:left">
                                                    <h4 class="card-title fw-bolder fs-5">Employment Details</h4>
                                                </div>
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-xl-6 col-12 py-2 border-end">

                                                        <dl class="mb-0">
                                                            <dt class="fw-bolder mb-1">Employee Code:</dt>
                                                            <dd class="mb-1">{{ emp_detail1.EmployeeCode }}</dd>

                                                            <dt class="fw-bolder mb-1">Reporting To:</dt>
                                                            <dd class="mb-1">{{ rep_employees.rep1 }}</dd>

                                                            <dt class="fw-bolder mb-1">Posting City:</dt>
                                                            <dd class="mb-1">{{ emp_detail1.PostingCity }}</dd>

                                                            <dt class="fw-bolder mb-1">Email:</dt>
                                                            <dd class="mb-1">{{ emp_detail1.CompanyEmail }}</dd>

                                                            <dt class="fw-bolder mb-1">CNIC:</dt>
                                                            <dd class="mb-1">{{ emp_detail1.CNIC }}</dd>

                                                            <dt class="fw-bolder mb-1">Job Shift:</dt>
                                                            <dd class="mb-1">{{ shift_name }}</dd>

                                                            <dt class="fw-bolder mb-1">Relation:</dt>
                                                            <dd class="mb-1">{{ emp_detail1.Relation }}</dd>

                                                            <dt class="fw-bolder mb-1">Salary Currency:</dt>
                                                            <dd class="mb-1">{{ emp_detail1.Salary_Currency }}</dd>

                                                            <dt class="fw-bolder mb-1">Send Notification:</dt>
                                                            <dd class="mb-1">{{ emp_detail1.SendNotification == 1 ?
                                                                'Allowed' : 'Not Allowed' }}</dd>

                                                            <dt class="fw-bolder mb-1">E-Portal Access:</dt>
                                                            <dd class="mb-1">{{ emp_detail1.EportalAccess == 1 ?
                                                                'Allow'
                                                                : 'Not Allowed' }}</dd>

                                                            <dt class="fw-bolder mb-1">Team Attendance:</dt>
                                                            <dd class="mb-1">{{ emp_detail1.AllowEmployeesAttendance
                                                                ==
                                                                1 ? 'Allowed' : 'Not Allowed' }}</dd>
                                                        </dl>

                                                    </div>
                                                    <div class="col-xl-6 col-12 py-2">
                                                        <dl class="mb-0">
                                                            <dt class="fw-bolder mb-1">Department:</dt>
                                                            <dd class="mb-1">{{ emp_detail1.Department }}</dd>

                                                            <dt class="fw-bolder mb-1">Second Rep. To:</dt>
                                                            <dd class="mb-1">{{ rep_employees.rep2 }}</dd>

                                                            <dt class="fw-bolder mb-1">Joining Date:</dt>
                                                            <dd class="mb-1">{{ emp_detail1.JoiningDate }}</dd>

                                                            <dt class="fw-bolder mb-1">Probation End:</dt>
                                                            <dd class="mb-1">{{ emp_detail1.ProbationEnd }}</dd>

                                                            <dt class="fw-bolder mb-1">Blood Group:</dt>
                                                            <dd class="mb-1">{{ emp_detail1.BloodGroup }}</dd>

                                                            <dt class="fw-bolder mb-1">CNIC Expiry:</dt>
                                                            <dd class="mb-1">{{ emp_detail1.CnicExpiry }}</dd>

                                                            <dt class="fw-bolder mb-1">Job Status:</dt>
                                                            <dd class="mb-1">{{ emp_detail1.JobStatus }}</dd>

                                                            <dt class="fw-bolder mb-1">Phone Number:</dt>
                                                            <dd class="mb-1">{{ emp_detail1.Phone }}</dd>

                                                            <dt class="fw-bolder mb-1">Complete Address:</dt>
                                                            <dd class="mb-1">{{ emp_detail1.Address }}, {{
                                                                emp_detail1.City }}</dd>
                                                        </dl>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="card border-0 top-radius bottom-radius">
                                            <h4 class="fw-bolder fs-5 card-header top-radius">Qualification List
                                            </h4>

                                            <!-- Table for qualification data -->
                                        ...
                                        <div class="card border-0 top-radius bottom-radius">
                                            <h4 class="fw-bolder card-header fs-5 top-radius">Work Experience</h4>
                                                        ...
                                                        <div class="timeline-event">
                                                            ...
                                                            <div class="d-flex flex-row align-items-center mb-50">
                                                                ...
                                                                <div class="user-info">
                                                                    ...
                                                                    <p class="mb-0"
                                                                        v-if="exp_detail1.Refrence != 'NULL'">
                                        ...
                                        <div class="card border-0 top-radius bottom-radius">
                                            <h4 class="card-header top-radius fw-bolder fs-5">Issued Warnings</h4>
                            ...
                            <div class="tab-pane" id="empLeaves" aria-labelledby="empLeaves-tab" role="tabpanel">
                                <div class="row py-2">
                                    <div v-for='emp_detail1 in emp_detail'
                                        class="col-xl-6 col-lg-6 col-md-5 order-1 order-md-0">
                                        <div class="card border-0 top-radius bottom-radius">
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-7 order-0 order-md-1">
                                        <div class="card border-0 top-radius bottom-radius">
                                            <div class="card-header top-radius border-bottom">
                                                <h4 class="card-title fw-bolder  py-50 mb-1 fs-5">Leavess Balances</h4>

                                                <select class="custom-select border-0 no-border"
                                                    v-model="selectedLeave">
                                                    <!-- <option value="">Select Leave Type</option> -->
                                                    <!-- <option v-for="leave in leaveOptions" :key="leave" :value="leave">
                                                        {{ leave }}
                                                    </option> -->
                                                    <option v-for="leave in leavesblnc" :key="leave.LeaveType"
                                                        :value="leave.LeaveType">
                                                        {{ leave.LeaveType }}
                                                    </option>
                                                </select>
                                                <!-- <p>You selected: {{ selectedLeave }}</p> -->
                                            </div>

                                            <apexchart :key="chartKey" type="donut" height="230"
                                                :options="chartOptions1" :series="series1">
                                            </apexchart>
                                            <div v-if="selectedLeaveData"
                                                class="d-flex flex-column gap-2 p-2 rounded p-3">

                                                <div class="d-flex justify-content-between align-items-center px-5">
                                                    <span class="d-flex align-items-center gap-2 fw-bold">
                                                        <i class="fa-solid fa-circle text-primary fs-6"></i> Type
                                                    </span>
                                                    <span>{{ selectedLeaveData.LeaveType }}</span>
                                                </div>

                                                <div class="d-flex justify-content-between align-items-center px-5">
                                                    <span class="d-flex align-items-center gap-2 fw-bold">
                                                        <i class="fa-solid fa-circle text-warning fs-6"></i> Granted
                                                    </span>
                                                    <span>{{ selectedLeaveData.TotalLeave }}</span>
                                                </div>

                                                <div class="d-flex justify-content-between align-items-center px-5">
                                                    <span class="d-flex align-items-center gap-2 fw-bold ">
                                                        <i class="fa-solid fa-circle text-info fs-6"></i> Used
                                                    </span>
                                                    <span>{{ selectedLeaveData.TotalLeave -
                                                        selectedLeaveData.RemainingLeave }}</span>
                                                </div>

                                                <div class="d-flex justify-content-between align-items-center px-5">
                                                    <span class="d-flex align-items-center gap-2 fw-bold">
                                                        <i class="fa-solid fa-circle fs-6" style="color: #7C4DFF;"></i>
                                                        Balance
                                                    </span>
                                                    <span>{{ selectedLeaveData.RemainingLeave }} Left</span>
                                                </div>

                                            </div>
                                            <div v-else
                                                class="d-flex justify-content-center text-center flex-column gap-2 p-2 rounded p-3">
                                                <p>No {{ selectedLeave }} Leave Data</p>
                                            </div>
                                            ...
                                            <!-- <div v-if="selectedLeaveData">
                                                <div class="d-flex justify-content-between mb-1">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <span class="fw-bold ms-75">Leave Type</span>
                                                    </div>
                                                    <span>{{ selectedLeaveData.LeaveType }}</span>
                                                </div>

                                                <p><strong>Leave Type:</strong> {{ selectedLeaveData.LeaveType }}</p>
                                                <p><strong>Total Leave:</strong> {{ selectedLeaveData.TotalLeave }}</p>
                                                <p><strong>Availed Leave:</strong> {{ selectedLeaveData.TotalLeave -
                                                    selectedLeaveData.RemainingLeave }}</p>
                                                <p><strong>Remaining Leave:</strong> {{ selectedLeaveData.RemainingLeave
                                                }}</p>
                                            </div> -->
                                            ...
                                            <!-- <div class="d-flex justify-content-around mb-1">
                                                <div class="d-flex align-items-center">
                                                    <i class="fa-solid fa-square fs-5 text-primary "></i>
                                                    <span class="fw-bold ms-75">Type</span>
                                                </div>
                                                <span>give data</span>
                                            </div>
                                            <div class="d-flex justify-content-around mb-1">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="card border-0 top-radius bottom-radius">
                                            <div class="fw-bolder fs-5 card-header top-radius">
                                    ...
                                    <div class="col-12">
                                        <div class="card border-0 top-radius bottom-radius">
                                            <div class="card-header top-radius">
                                                <h4 class="card-title fw-border fs-5">Current Session Attendance</h4>
                                            </div>
                                            <div class="table-responsive" style="overflow-x: initial !important;">
                                                <table class="table">
                                                        ...
                                                        <tr v-for="attendance1 in attendance"
                                                            ...
                                                            <td class="text-success text-center"
                                                                ...
                                                                {{ attendance1.instatus * -1 }} minut<span
                                                                    v-if="attendance1.instatus * -1 != 1">es</span>
                                                                early
                                                            </td>
                                                            <td class="text-success text-center"
                            ...
                            <div class="tab-pane" id="empFinancialHistory" aria-labelledby="empFinancialHistory-tab"
                                role="tabpanel">
                                <!-- Project table -->
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-7 order-0 order-md-1">
                                        <div class="card border-0 top-radius bottom-radius">
                                            <div class="card-header border-bottom top-radius">
                                                <h4 class="card-title fw-bolder  py-50 mb-1 fs-5">Salary History</h4>

                                                <!-- select month  -->
                                                <select class="custom-select border-0 no-border"
                                                    style="cursor: pointer;" v-model="selectedMonth">
                                                    <option value="">Select Month</option>
                                                    <option v-for="sal in all_sals.data" :key="sal.SessionName"
                                                        :value="sal.SessionName">
                                                        {{ sal.SessionName }}
                                                    </option>
                                                </select>
                                            ...
                                            <!-- <div class="table-responsive" style="overflow-x: initial !important;"> -->
                                            <div v-if="filteredSalaries.length">
                                                <div v-for="(sal, index) in filteredSalaries" :key="sal.DistributionID"
                                                    class="card border-0 py-3 px-5 mb-2">
                                                    <h5>{{ sal.EmployeeName }}</h5>
                                                    <div class="d-flex justify-content-between">
                                                        <p><strong>SR:</strong></p>
                                                        <p>{{ (index + 1) + ((page1 - 1) * 5) }}</p>
                                                    </div>
                                                    ...
                                                    <div class="mb-2 d-flex justify-content-between">
                                                        ...
                                                        <p>{{ Math.floor(sal.Salary).toLocaleString() }}</p>
                                                    </div>

                                                    <div class="mb-2 d-flex justify-content-between">
                                                        <p><strong>Bonus:</strong></p>
                                                        <p>{{ Math.floor(parseInt(sal.BonusAmount) +
                                                            parseInt(sal.StipendAmount) + parseInt(sal.OAmount) +
                                                            parseInt(sal.FuelAmount)).toLocaleString() }}</p>
                                                    </div>

                                                    <div class="mb-2 d-flex justify-content-between">
                                                        <p><strong>Fine:</strong></p>
                                                        <p>{{ Math.floor(parseInt(sal.Fine) + parseInt(sal.DAmount) +
                                                            parseInt(sal.TaxAmount) + parseInt(sal.AdvanceAmount) +
                                                            parseInt(sal.InstallmentAmount)).toLocaleString() }}</p>
                                                    </div>

                                                    <div class="mb-2 d-flex justify-content-between">
                                                        <p><strong>Payable:</strong></p>
                                                        <p>{{ Math.floor(sal.PayableSalary).toLocaleString() }}</p>
                                                    </div>

                                                    <div class="mb-2 d-flex justify-content-between">
                                                        <p><strong>Status:</strong></p>
                                                        <p>
                                                            <span v-if="sal.SalaryStatus == 'Not Received'"
                                                                class="badge bg-warning">Not Received</span>
                                                            <span v-else class="badge bg-success">{{ sal.SalaryStatus
                                                            }}</span>
                                                        </p>
                                                    </div>

                                                    <!-- <p><strong>SR:</strong> {{ (index + 1) + ((page1 - 1) * 5) }}</p> -->
                                                    <!-- <p><strong>Method:</strong>{{ sal.MethodType }}</p>
                                                    <p><strong>Salary:</strong> {{
                                                        Math.floor(sal.Salary).toLocaleString() }}</p>
                                                    <p><strong>Bonus:</strong> {{
                                                        Math.floor(parseInt(sal.BonusAmount) +
                                                            parseInt(sal.StipendAmount) + parseInt(sal.OAmount) +
                                                            parseInt(sal.FuelAmount)).toLocaleString() }}</p>
                                                    <p><strong>Fine:</strong> {{ Math.floor(parseInt(sal.Fine) +
                                                        parseInt(sal.DAmount) + parseInt(sal.TaxAmount) +
                                                        parseInt(sal.AdvanceAmount) +
                                                        parseInt(sal.InstallmentAmount)).toLocaleString() }}</p>
                                                    <p><strong>Payable:</strong> {{
                                                        Math.floor(sal.PayableSalary).toLocaleString() }}</p>
                                                    ...
                                                    <div class="d-flex justify-content-center">
                                                        <a v-if="sal.SalaryStatus != 'Not Received'"
                                                            :href="`${url}/generate_slip/${sal.EmployeeID}/${sal.DistributionID}/${sal.EmpCode}`"
                                                            target="_blank" title="Download slip">
                                            ...
                                            <div v-else>
                                                <p class="text-center">Select a month to view salary details.</p>
                                            </div>
                                            ...
                                            <!-- <table class="table table-hover">
                                                ...
                                                <tbody style="text-align:center">
                                                    <tr v-for="(all_sals1, index) in all_sals.data">
                                                        <td class="td-center">{{ (index + 1) + ((page1 - 1) * 5) }}
                                                        </td>
                                                        ...
                                                        <td class="td-right">
                                                            {{
                                                                Math.floor(parseInt(all_sals1.BonusAmount) +
                                                                    parseInt(all_sals1.StipendAmount) +
                                                                    parseInt(all_sals1.OAmount) +
                                                                    parseInt(all_sals1.FuelAmount)).toLocaleString()
                                                            }}
                                                        </td>
                                                        <td class="td-right">
                                                            {{
                                                                Math.floor(parseInt(all_sals1.Fine) +
                                                                    parseInt(all_sals1.DAmount) +
                                                                    parseInt(all_sals1.TaxAmount) +
                                                                    parseInt(all_sals1.AdvanceAmount) +
                                                                    parseInt(all_sals1.InstallmentAmount)).toLocaleString()
                                                            }}
                                                        </td>
                                                        <td class="td-right">
                                                        ...
                                                        <td>
                                                            <span class="badge bg-gradient-warning"
                                                                v-if="all_sals1.SalaryStatus == 'Not Received'">Not
                                                                Received</span>
                                                            <span class="badge bg-gradient-success" v-else>{{
                                                                all_sals1.SalaryStatus }}</span>
                                                        </td>
                                                        <td class="text-center">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="card border-0 top-radius bottom-radius">
                                            <div class="card-header border-bottom top-radius">
                                                <h4 class="card-title fw-bolder  mb-1 fs-5">Loan History</h4>
                                            </div>
                                            <div class="table-responsive" style="overflow-x: initial !important;">
                                                                            ...
                                                                            <table class="table table-hover">
                                                                                <thead>
                                                                                    <tr>
                                                                                        ...
                                                                                        <th class="sticky-th-center">
                                                                                            Installment<br />Session
                                                                                        </th>
                                                                                        <th class="sticky-th-center">
                                                                                            Installment<br />Amount
                                                                                        </th>
                                                                                        <th class="sticky-th-center">
                                                                                            Installment<br />Status
                                                                                        </th>
                                                                                    ...
                                                                                    <tr v-for="(get_reqdata11, index) in install_list"
                                                                                        ...
                                                                                        <td class="td-center">
                                                                                            ...
                                                                                            <span
                                                                                                ...
                                                                                                class="badge bg-gradient-primary">Waived
                                                                                                Off</span>
                                                                                            <span
                                        ...
                                        <div class="card border-0 top-radius bottom-radius">
                                            <div class="card-header top-radius">
                                                <h4 class="card-title fw-bolder py-50 mb-1 fs-5">Fine & Dues</h4>
                                            </div>
                                        ...
                                        <div class="card border-0 top-radius bottom-radius">
                                            <div class="card-header top-radius">
                                                <h4 class="card-title fw-bolder py-50 mb-1 fs-5">Arrears, Bonuses &
                                                    Allowances</h4>
                                            </div>
                                                    ...
                                                    <tbody style="text-align:center">
                                                        <tr v-for="arrears1 in arrears">
                                                            ...
                                                            <td>
                                                                ...
                                                                <span class="badge bg-gradient-primary" v-else>{{
                                                                    arrears1.ReqStatus }}</span>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr v-for="allowances1 in allowances">
                                                            ...
                                                            <td>
                                                                ...
                                                                <span class="badge bg-gradient-primary" v-else>{{
                                                                    allowances1.ReqStatus }}</span>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                            <div class="table-responsive ps-3 pb-3" v-else>No Arrears, Bonuses or Allowances
                                                history
                                            </div>
                                        </div>
                                        <!-- /Project table -->
                                    ...
                                    <div class="modal-body pb-5 px-sm-5 pt-50">
                                        <div class="text-center mb-2">
                                            ...
                                            <div class="text-center">
                                                ...
                                                <button v-if="tdate != ''" type="button" @click="terminate(employeeid)"
                                                    class="btn btn-warning waves-effect waves-float waves-light"
                                                    data-bs-dismiss="modal" aria-label="Close">Yes
                                                </button>
...
export default {
    ...
    computed: {
        selectedLeaveData() {
            ...
            return this.leavesblnc.find(
                leave => leave.LeaveType === this.selectedLeave
            );
        },
        filteredSalaries() {
            if (this.selectedMonth) {
                return this.all_sals.data.filter(item => item.SessionName === this.selectedMonth);
            } else {
                return [];
            }
        },
            ...
            if (!this.leavesblncLoaded) {
                axios.get('selected_emp_leaves_blnc/' + this.id)
                    .then(data => {
                        ...
                        if (this.leavesblnc.length > 0) {
                            this.selectedLeave = this.leavesblnc[0].LeaveType;
                        }
                        this.chartOptions1.labels = this.leavesblnc.map(leave => leave.LeaveType);
                        this.chartOptions1.colors = this.leavesblnc.map(leave => this.colorMap[leave.LeaveType] || '#000000');
                        this.series1 = this.leavesblnc.map(leave => leave.TotalLeave);
                        // console.log(this.series1, "Series of Total Leaves");
                        this.chartKey++;
        ...
        financialdata() {
            ...
            if (!this.loansLoaded) {
                axios.get('fetch_employee_loans/' + this.id)
                    .then(data => {
                        console.log(data.data, "loans response");
        ...
        employee_salaries(page = 1) {
            ...
            axios.get('salaries_history/' + this.id + '?page=' + page)
                .then(response => {
                    ...
                    if (this.all_sals.length > 0) {
                        this.selectedMonth = this.all_sals[0].SessionName;
    ...
    mounted() {
        ...
        axios.get('/get-leave-types')
            .then(res => {
                this.leaveOptions = res.data;
                if (this.leaveOptions.length > 0) {
                    this.selectedLeave = this.leaveOptions[0];
                };
            });
        ...
        axios.get('getindemployee_detail/' + this.id)
            .then(data => {
                ...
                console.log(this.emp_detail,"single detail");
