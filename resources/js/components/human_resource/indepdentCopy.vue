                ...
                <div class="content-body">
                    <section class="app-user-view-account">
                            ...
                            <div v-for='emp_detail1 in emp_detail'
                                ...
                                <div class="card border-0 top-radius bottom-radius">
                                    <div class="card-body">
                                        ...
                                        <h4 class="fw-bolder border-bottom py-50 mb-1 fs-5">Personal Details</h4>
                                        <div class="info-container">
                                            <ul class="list-unstyled">

                                                <li class="mb-75">
                                                    <label class="fw-bolder me-25 d-block mb-1">Father Name:</label>
                                                ...
                                                <li class="mb-75">
                                                    <label class="fw-bolder me-25 d-block mb-1">Date Of Birth:</label>
                                                    <input type="text" class="form-control bg-transparent"
                                                ...
                                                <li class="mb-75">
                                                    <label class="fw-bolder me-25 d-block mb-1">Religion:</label>
                                                    <input type="text" class="form-control bg-transparent"
                                            ...
                                            <div class="d-flex justify-content-center pt-2 gap-3">
                                                <button :disabled="disabled" v-if="emp_detail1.Status != 'Registered'"
                                                ...
                                                <button :disabled="disabled" v-if="emp_detail1.Status == 'Suspended'"
                                                ...
                                                <div class="row">
                                                    <div class="col-xl-6 col-12 py-2 border-end">
                                                        ...
                                                        <dl class="mb-0">
                                                            ...
                                                            <dd class="mb-1">{{ emp_detail1.EportalAccess == 1 ? 'Allow'
                                                                : 'Not Allowed' }}</dd>
                                        ...
                                        <div class="modal-body pb-5 px-sm-5 pt-50">
                                            <div class="text-center mb-2">
                                                ...
                                                <div class="text-center">
                                                    ...
                                                    <button v-if="sdate != ''" type="button"
                                                        @click="suspend(employeeid)"
                                        ...
                                        <div class="modal-body pb-5 px-sm-5 pt-50">
                                            <div class="text-center mb-2">
                                                ...
                                                <div class="text-center">
                                                    ...
                                                    <button v-if="rdate != ''" type="button"
                                                        @click="resigned(employeeid)"
                                                        class="btn btn-warning waves-effect waves-float waves-light"
                                                        data-bs-dismiss="modal" aria-label="Close">Yes
                                                    </button>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card border-0 top-radius bottom-radius">
                                    <h4 class="fw-bolder fs-5 card-header top-radius">Qualification List</h4>
                                                    ...
                                                    <td v-else v-for="emp_warning1 in emp_warning">
                                                        <div class="demo-inline-spacing">
                                                            <router-link
                                                                :title="'Issued on ' + emp_warning1.DateIssued + '\nClick to view Details'"
                                                                :to="{ name: 'warning_view', params: { id: emp_warning1.LetterID } }"
                                                                class="badge" v-if="emp_warning1.WarningType == 'First'"
                                                                style="cursor:pointer;">
                                                                <span class="badge badge-glow bg-info">First-{{
                                                                    emp_warning1.ReasonSubject
                                                                }}</span>
                                                            ...
                                                            <router-link
                                                                ...
                                                                v-if="emp_warning1.WarningType == 'Second'"
                                                                style="cursor:pointer;">
                                                                <span class="badge badge-glow bg-warning">Second-{{
                                                                    emp_warning1.ReasonSubject
                                                                }}</span>
                                                            </router-link>
                                                            <router-link
