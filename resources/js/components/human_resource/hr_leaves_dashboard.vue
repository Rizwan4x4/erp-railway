                                    ...
                                    <div class="row">
                                        <div class="col-md-2 user_role">
                                            <label class="form-label" for="UserRole"><img class="px-1"
                                                    :src="images.solar_filter_linear" alt="icon">Leave Type<span
                                ...
                                <div class="table-responsive" style="overflow-x: initial !important;">
                                    <table class="table table-hover">
                                        <thead>
                                            ...
                                            <tr>
                                                <th scope="col" class="sticky-th-center" style="top:132px !important">
                                                    Tot.
                                                </th>
                                                <th scope="col" class="sticky-th-center" style="top:132px !important">
                                                    Rem.
                                                    ...
                                                    <div class="d-flex justify-content-left align-items-center">
                                                        ...
                                                        <div class="d-flex flex-column"><a
                                                                class="user_name text-truncate text-body"><span
                                                                    class="fw-bolder"> </span>{{ adsdata1.Name
                                                                }}</a><small class="emp_post text-muted">{{
                                                                    adsdata1.department
                    ...
                    <div class="modal-body px-sm-5 mx-50 pb-5">
                        <form id="addNewCardValidation" class="row gy-1 gx-2 mt-75" onsubmit="return false">
                            <div class="col-12">
                                ...
                                <span style="color: #DB4437; font-size: 11px;" v-if="lv_emp_id.id == ''">{{ e_lv_emp_id
                                    }}</span>
                            </div>
                            <div class="col-md-12">
                                ...
                                <multiselect :show-labels="false" style="margin-right: 10px; font-size: 12px;"
                                    placeholder="Select Leave Type" v-model="lv_type" :options="options5">
                                </multiselect>
                ...
                axios.post('submit_emp_leaves', requestData)
                    .then(data => {
                        if (data.data === 'Employee leave added' || data.data === 'Employee leave updated') {
                            ...
                            console.log(newLeaveObject,"new leave object ");
        ...
        getbyId(page = 1) {
            ...
            axios.get('./filter_leaves_byId?page=' + page, { params: { emp_name_code: this.emp_name_code } })
                .then(data => {
                    ...
                    console.log(this .adsdata,"getting data ");
    ...
    mounted() {
        ...
        axios.get('view_leave_type/')
            .then(response => {
                ...
                // console.log(this.l_types,"this is leave types");
                ...
                for (var i = 0; i < $this.l_types.length; i++) {
                    ...
                    console.log(this.options5,"option 5 leave ws");
