                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-7">
                                        <div class="demo-inline-spacing">
                                            <button type="button" data-bs-toggle="modal" data-bs-target="#addNewCard"
                                                    class="btn btn-primary waves-effect">Apply Leave
                                            </button>
                                    ...
                                    <div class="col-md-5">
                                        <div class="demo-inline-spacing">
                                            <input autocomplete="off" type="text"
                                                   style="min-width: 280px;" v-model="keyword1"
                                                   class="form-control"
                                ...
                                <div class="row">
                                    <div class="col-md-2 user_role">
                                        <label class="form-label" for="UserRole">Leave Type</label>
                                        <multiselect :show-labels="false" style="margin-right: 10px; font-size: 15px;"
                                                     id="UserRole" placeholder="All Types" v-model="leave"
                                    ...
                                    <div class="col-md-2 user_plan">
                                        ...
                                        <multiselect :show-labels="false" style="margin-right: 10px; font-size: 15px;"
                                                     ...
                                                     v-model="location" :options="options2">
                                        </multiselect>
                                    </div>
                                ...
                                <b-collapse id="my-collapse">
                                    <div style="min-height: 70px;" class="advanced">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2 user_status">
                                                <label class="form-label" id="FilterTransaction"
                                                       for="FilterTransaction">Manager Status</label>
                                                <multiselect :show-labels="false"
                                                             style="margin-right: 10px; font-size: 12px;"
                                            ...
                                            <div class="col-md-2 user_status">
                                                <label class="form-label" id="FilterTransaction"
                                                       for="FilterTransaction">HR Status</label>
                                                <multiselect :show-labels="false"
                                                             style="margin-right: 10px; font-size: 12px;"
                                    ...
                                    <table class="table">
                                        ...
                                        <tr v-for="leaves2 in leaves.data" style="vertical-align: middle;">
                                                ...
                                                <div @click="fetch_leave_upSts(leaves2.LeaveRQID, '')"
                                                    ...
                                                    <div class="avatar-wrapper">
                                                        <div class="avatar  me-1">
                                                            <img
                                                                v-bind:src="`public/images/profile_images/${leaves2.Photo}`"
                                                                alt="Avatar" height="32" width="32">
                                                        </div>
                                                    </div>
                                                    <div class="d-flex flex-column"><a
                                                        class="user_name text-truncate text-body"><span
                                                        class="fw-bolder">{{ leaves2.Name }}</span></a><small
                                                        class="emp_post text-muted">{{ leaves2.Department }} -
                                            ...
                                            <td style="text-align:center;">
                                                ...
                                                <span
                                                    v-if="leaves2.NoOfDays!='1'"><br/>to<br/>{{
                                                        leaves2.EndDate
                                                    }}</span>
                                            </td>
                                            ...
                                            <td style="text-align: center;">
                                                <span
                                                    ...
                                                    data-bs-target="#updt_lv_sts" style="cursor: pointer;">Pending</span>
                                                <span
                                                    v-else-if="leaves2.ManagerApproval=='Pending'"
                                            ...
                                            <td style="text-align: center;">
                                                ...
                                                <span v-else>
                                                        <span
                                                            v-if="leaves2.HRApproval=='Pending' && leaves2.PendingLeaveStatus =='P'"
                                                            class="badge bg-gradient-warning" style="cursor: pointer;">Pending</span>
                                                        <span
                                                            v-else-if="leaves2.HRApproval=='Pending' && leaves2.PendingLeaveStatus!='P'"
                                                            class="badge bg-gradient-warning">Pending</span>
                                                        <span v-else-if="leaves2.HRApproval=='Rejected'"
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <span style="color: #DB4437; font-size: 11px;"
                                              v-if="this.lv_status==''">{{ lv_status_error }}</span>
                                    </div>
                                    <div class="col-md-12">
                        ...
                        <form id="addNewCardValidation" class="row gy-1 gx-2 mt-75" onsubmit="return false">
                            ...
                            <div class="col-12">
                                ...
                                <multiselect :show-labels="false" @input="fetch_emp_leave()"
                                             ...
                                             value="id" label="label" v-model="emp_emp_id"
                                             :options="options5"></multiselect>
                                <span style="color: #DB4437; font-size: 11px;"
                                      v-if="emp_emp_id.id==''">{{ emp_emp_id_error }}</span>
                            </div>
                            <div class="col-12">
                                <label class="form-label" for="modalAddCardNumber">Leave Type: <span
                                    style="color:red">*</span></label>
                                <multiselect :show-labels="false" style="margin-right: 10px; font-size: 12px;"
                                             id="FilterTransaction" placeholder="Select Type"
                                             v-model="emp_leave" :options="options">
                                </multiselect>
                                <span style="color: #DB4437; font-size: 11px;"
                                      v-if="emp_leave==''">{{ emp_leave_error }}</span>
                            </div>
                            <div class="col-md-12">
                                <label class="form-label">Date From: <span style="color:red">*</span></label>
                                <input v-model="emp_date_from" type="date" class="form-control"/>
                                <span style="color: #DB4437; font-size: 11px;"
                                      v-if="emp_date_from==''">{{ emp_date_from_error }}</span>
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <span style="color: #DB4437; font-size: 11px;"
                                      v-if="this.emp_reason==''">{{ emp_reason_error }}</span>
                            </div>
