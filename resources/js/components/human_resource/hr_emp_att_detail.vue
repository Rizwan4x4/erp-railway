                ...
                <div class="content-body">
                    ...
                    <section class="app-user-view-account">
                        <div class="row m-0 border-0">
                            <div class="card top-0-radius bottom-radius border-0 px-0">
                                <div class="card-body">
                                    ...
                                    <div class="row" style="margin-bottom: 10px">
                                        <div class="col-md-4">
                                            ...
                                            :src="images.solar_filter_linear" alt="icon">Employee Name_Code</label>
                                            <multiselect style="margin-right: 10px" v-model="emp_name"
                                                :options="options0" :show-labels="false"></multiselect>
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label" for="FilterTransaction"><img class="px-1"
                                            :src="images.solar_filter_linear" alt="icon">Department</label>
                                            <multiselect :show-labels="false" style="
                                                    margin-right: 10px;
                                                    font-size: 12px;
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <multiselect :show-labels="false" style="
                                                ...
                                                v-model="att_designation" :options="options"></multiselect>
                                        </div>
                                        <div class="col-md-3 mt-2">
                                            ...
                                            <multiselect :show-labels="false" style="
                                                    margin-right: 10px;
                                                    font-size: 15px;
                                                " id="UserPlan" placeholder="All" v-model="att_location"
                                                :options="options1">
                                            </multiselect>
                                        </div>
                                        <div class="col-md-3 mt-2">
                                            <label class="form-label"><img class="px-1"
                                            :src="images.solar_filter_linear" alt="icon">Date From</label>
                                            <input type="date" v-model="att_startingdate" class="form-control" />
                                        </div>
                                        <div class="col-md-3 mt-2">
                                            <label class="form-label"><img class="px-1"
                                            :src="images.solar_filter_linear" alt="icon">Date To</label>
                                            <input type="date" class="form-control" v-model="att_closingdate" />
                                        </div>
                                        <div class="col-md-3">
                                            <button @click="daily_attendance()" style="margin-top: 38px;width: 100%;"
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody v-if="att_report && att_report.length > 0">
                                                <tr v-for="att_report1 in att_report">
                                                    ...
                                                    <td class="td-center"
                                                        style="text-align:center;border-right:1px solid lightgrey" v-if="
                                                            att_report1.CheckIN !=
                                                            null
                                                        ">
                                                        {{
                                                    ...
                                                    <td class="td-center"
                                                        ...
                                                        <a @click="
                                                            ...
                                                            " data-bs-toggle="modal" data-bs-target="#employeehire1">
                                                            <i class="fa-solid fa-edit"></i>
                                                        </a>
                                                    </td>
                                                    <!-- <td
                                                        class="td-center" style="text-align:center;border-right:1px solid lightgrey"
                                                        v-else
                                                    >
                                                        <a
                                                            @click="
                                            ...
                                            <tbody v-else>
                                                <tr>
                                                    <h3 class='text-center justify-content-center' colspan="5">No data
                                                        to show</h3>
                                                </tr>
                                            </tbody>
                                        </table>
                                    ...
                                    <div style="
                                            ...
                                            padding-top: 20px;
                                        ">
                                        <pagination :limit="limit2" :data="att_report" @pagination-change-page="
                                            daily_attendance
                                        "></pagination>
                                    </div>
                                </div>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content pb-5">
                    <div class="modal-header">
                        ...
                        <button type="button" class="btn-close" @click="cleargrace_id()" data-bs-dismiss="modal"
                    ...
                    <div class="col-12 text-center">
                        <button v-if="check_in != '' && check_in != null" class="btn btn-primary bg-primary"
                            @click="update_att()" data-bs-dismiss="modal" aria-label="Close">
                            Update Attendance
                        </button>
                        <button v-else class="btn btn-danger" @click="update_att()">
                            Update Attendance
                        </button>
                        <button type="button" class="btn btn-outline-secondary" @click="cleargrace_id()"
