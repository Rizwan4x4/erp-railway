                            ...
                            <div class="card top-radius bottom-radius border-0">
                                <div class="row" style="margin-top:20px">
                                    ...
                                    <div v-if="hasPermission('Fuel assign fuel allowance')" class="col-md-3 col-12 mb-2 position-relative">
                                        <button data-bs-toggle="modal" data-bs-target="#applyallowance" class="btn btn-primary bg-primary">Assign Fuel Allowance</button>
                                    </div>
                                ...
                                <div class="modal-body pb-5 px-sm-5 pt-50">
                                    <div class="text-center mb-2">
                                        ...
                                        <div class="text-center" style="text-align:center">
                                            <button type="button" :disabled="disabled1" @click="delay1()" class="btn btn-primary bg-primary waves-effect waves-float waves-light" data-bs-dismiss="modal" aria-label="Close">Yes</button>
                                ...
                                <div class="modal-body pb-5 px-sm-5 pt-50">
                                    ...
                                    <form id="editUserForm" class="row gy-1 pt-75" onsubmit="return false">
                                        ...
                                        <div class="col-12 text-center mt-2 pt-50">
                                            <button type="button" v-if="emp_limit >= 0 && emp_limit != '' && emp_limit <= 1000" @click="delay2()" :disabled="disabled1" class="btn btn-primary bg-primary waves-effect waves-float waves-light" data-bs-dismiss="modal" aria-label="Close">Update</button>
                                ...
                                <div class="modal-body pb-5 px-sm-5 pt-50">
                                    <form id="addNewCardValidation" class="row gy-1 gx-2 mt-75" onsubmit="return false">
                                        ...
                                        <div class="col-12 text-center">
                                            <button type="submit" :disabled="disabled" @click="delay()" class="btn btn-primary bg-primary me-1 mt-1" data-bs-dismiss="modal" aria-label="Close">Apply</button>
