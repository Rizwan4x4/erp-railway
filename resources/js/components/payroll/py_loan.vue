<template>
    <div>
                ...
                <section>
                    <div class="row g-0">
                        ...
                        <div class="col position-relative">
                            <div class="card shadow-none border-0 mb-0 top-radius bottom-radius">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-2">
                                                            <label class="form-label"><img class="px-1"
                                                                    :src="images.solar_filter_linear" alt="icon">From
                                                                date</label>
                                                            <input type="date" id="datepicker" v-model="from_date"
                                                                class="form-control p-2" placeholder="Name" />
                                                        </div>
                                                        <div class="col-md-2">
                                                            <label class="form-label"><img class="px-1"
                                                                    :src="images.solar_filter_linear" alt="icon">End
                                                                date</label>
                                                        ...
                                                        <div class="col-md-2">
                                                            ...
                                                            <multiselect style="margin-right: 10px; font-size: 12px;"
                                                                id="FilterTransaction" placeholder="All Departments"
                                                                :show-labels="false" v-model="department"
                                                                :options="options2">
                                                            </multiselect>
                                                        </div>
                                                        <div class="col-md-2">
                                                            ...
                                                            <multiselect style="margin-right: 10px;"
                                                                :show-labels="false" v-model="designation"
                                                                :options="options">
                                                            </multiselect>
                                                        </div>
                                                        <div class="col-md-2">
                                                            <label class="form-label"><img class="px-1"
                                                                    :src="images.solar_filter_linear" alt="icon">Name or
                                                                id</label>
                                                        ...
                                                        <div class="col-md-1">
                                                            <a title="Click to see extra search filters"
                                                            ...
                                                            <div class="container">
                                                                <div class="row"
                                                                    ...
                                                                    <div class="col-md-4" style="float:left">
                                                                        <label class="form-label"><img class="px-1"
                                                                                :src="images.solar_filter_linear"
                                                                                alt="icon">Filter by</label>
                                                                        <multiselect style="margin-right: 10px;"
                                                                            @input="view_loans()" v-model="m_check"
                                                                            :show-labels="false"
                                                                            placeholder="Dept. & HR Manager"
                                                                            :options="options3">
                                                                        </multiselect>
                                                                    </div>
                                                                    <div class="col-md-2" style="float:left">
                                                                        <div class="form-check form-check-success mb-1"
                                                                            ...
                                                                            <input type="checkbox"
                                                                                @change="view_loans()"
                                                                                v-model="check_approved" id="holiday"
                                                                                class="form-check-input input-filter" />
                                                                            <label class="form-check-label"
                                                                                for="holiday">Approved</label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-2" style="float:left">
                                                                        <div class="form-check form-check-warning mb-1"
                                                                            ...
                                                                            <input type="checkbox"
                                                                                @change="view_loans()"
                                                                                v-model="check_pending" id="family"
                                                                                class="form-check-input input-filter" />
                                                                            <label class="form-check-label"
                                                                                for="family">Pending</label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-1" style="float:left">
                                                                        <div class="form-check form-check-danger mb-1"
                                                                            ...
                                                                            <input type="checkbox"
                                                                                @change="view_loans()"
                                                                                v-model="check_rejected" id="personal"
                                                                                class="form-check-input input-filter" />
                                                                            <label class="form-check-label"
                                                                                for="personal">Rejected</label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-1" style="float:left">
                                                                    </div>
                                                    ...
                                                    <div class="col-sm-12 col-lg-12 ps-xl-75 ps-0">
                                                        <div
                                                            ...
                                                            <div class="row m-0">
                                                                <div class="col-md-2">
                                                                    <button
                                                                        v-if="hasPermission('Payroll Apply for loan')"
                                                                        class="btn btn-primary bg-primary"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#emploan">
                                                                        + Apply for loan
                                                                    </button>
                                            ...
                                            <div class="card border-0">
                                                <div class="table-responsive" style="overflow-x: initial !important;">
                                                    <table class="table table-hover">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th class="sticky-th-center" style="min-width: 217px;">
                                                                    Employee Name</th>
                                                                        ...
                                                                        <div class="accordion-header d-flex">
                                                                            ...
                                                                            <div class="col-md-1"
                                                                                ...
                                                                                <div class="btn-group">
                                                                                    ...
                                                                                    <div v-if="hasPermission('Payroll Actions for loan')"
                                                                                        class="dropdown-menu dropdown-menu-end">
                                                                                        <a @click="fetch_emp_upSts(loans1.LoanId)"
                                                                                            data-bs-toggle="modal"
                                                                                        ...
                                                                                        <a v-if="loans1.ReqStatus == 'Pending'"
                                                                                            @click="fetch_emp_upSts(loans1.LoanId); get_emp_id(loans1.EmployeeID)"
                                                                                            data-bs-toggle="modal"
                                                                                            data-bs-target="#updateloan"
                                                                                            class="dropdown-item">
                                                                                            <i
                                                                                                class="fa-solid fa-pencil-square-o"></i>
                                                                                            Edit details
                                                                                        </a>
                                                                                        <a target="_blank"
                                                                                            v-bind:href="`employee_loan/${loans1.LoanId}`"
                                                                                            v-if="loans1.LoanType == 'Loan' && (loans1.ReqStatus == 'Paid' || loans1.ReqStatus == 'Returned')"
                                                                                            class="dropdown-item">
                                                                                            <i
                                                                                        ...
                                                                                        <a target="_blank"
                                                                                            v-bind:href="`employee_loan1/${loans1.LoanId}`"
                                                                                            v-if="loans1.LoanType == 'Advance' && (loans1.ReqStatus == 'Paid' || loans1.ReqStatus == 'Returned')"
                                                                                            class="dropdown-item">
                                                                                            <i
                                                                                                class="fa-solid fa-print"></i>
                                                                                            Advance Slip
                                                                                        ...
                                                                                        <a @click="fetch_emp_upSts(loans1.LoanId)"
                                                                                            ...
                                                                                            class="dropdown-item"
                                                                                            v-if="loans1.ReqStatus == 'Approved'">
                                                                                            <i
                                                                                        ...
                                                                                        <a target="_blank"
                                                                                            v-if="loans1.ReqStatus == 'Paid' || loans1.ReqStatus == 'Returned'"
                                                                                            v-bind:href="`loan_report/${loans1.LoanId}`"
                                                                                            class="btn btn-sm">
                                                                                            <i
                                                                                                class="fa-solid fa-print"></i>Installments
                                                                                        </a>
                                                                                        <a @click="fetch_emp_upSts(loans1.LoanId)"
                                                                                            class="dropdown-item"
                                                                                            v-if="loans1.ReqStatus == 'Paid'"
                                                                                            data-bs-toggle="modal"
                                                                                        ...
                                                                                        <a class="dropdown-item"
                                                                                            @click="getid(loans1.LoanId)"
                                                                                            data-bs-toggle="modal"
                                                                                            data-bs-target="#delete_loan"
                                                                                            v-if="loans1.ReqStatus == 'Pending'">
                                                                                            <i
                                                                                        ...
                                                                                        <tr v-for="(get_reqdata11, index) in install_list"
                                                                                            ...
                                                                                            <td v-if="get_reqdata11.InstallmentStatus == 'Unpaid'"
                                                                                                ...
                                                                                                <div class="btn-group">
                                                                                                    ...
                                                                                                    <div v-if="hasPermission('Payroll Actions for installment')"
                                                                                                        class="dropdown-menu dropdown-menu-end">
                                                                                                        <a @click="get_loanid(get_reqdata11.LoanId, get_reqdata11.DetailId)"
                                                                                                            data-bs-toggle="modal"
                                                                                                            data-bs-target="#payloan1"
                                                                                                            class="dropdown-item">
                                                                                                            <i
                                                                                                        ...
                                                                                                        <a @click="get_loanid(get_reqdata11.LoanId, get_reqdata11.DetailId)"
                                                                                                            data-bs-toggle="modal"
                                                                                                            data-bs-target="#payloan2"
                                                                                                            class="dropdown-item">
                                                                                                            <i
                                                                                                                class="fa-solid fa-file-waveform"></i>
                                                                                                            Waive off
                                                                                                            Installment
                                                                                                        </a>
                                                                                                    </div>
                                                    ...
                                                    <div style="display: flex;">
                                                        <pagination :data="loans" :limit="limit"
                                                            @pagination-change-page="view_loans"></pagination>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body pb-5 px-sm-3 mx-50">
                                <h1 class="address-title text-center mb-1" id="addNewAddressTitle">Apply for Loan or
                                    Advance</h1>
                                ...
                                <form style="text-align:left;" class="row gy-1 gx-2" onsubmit="return false">
                                    <div class="col-12 col-md-6">
                                        ...
                                        <multiselect :show-labels="false" @input="find_id(emp_name)"
                                            style="margin-right: 10px; font-size: 12px;" placeholder="Select Employee"
                                            v-model="emp_name" :options="options6"></multiselect>
                                        <span style="color: #DB4437; font-size: 11px;"
                                            v-if="emp_name == '' || emp_name == null">{{ e_emp_name }}</span>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-3">
                                        ...
                                        <span style="color: #DB4437; font-size: 11px;">*</span>
                                        <multiselect style="margin-right: 10px;" @input="fetch_emp_detail()"
                                            v-model="type" :show-labels="false" placeholder="Select"
                                            :options="options4"></multiselect>
                                        <span style="color: #DB4437; font-size: 11px;" v-if="type == 'Select'">{{
                                            type_error }}</span>
                                    </div>
                                    <div class="col-12 col-md-3">
                                        ...
                                        <input type="number" class="form-control" v-model="amount"
                                            placeholder="Amount" />
                                        <span style="color: #DB4437; font-size: 11px;" v-if="amount == ''">{{
                                            amount_error }}</span>
                                        <span style="color: #DB4437; font-size: 11px;"
                                            v-if="amount > max_advance">Amount is too much</span>
                                    </div>
                                    <div class="col-12 col-md-3">
                                        ...
                                        <select v-if="type == 'Loan'" v-model="no_of_inst" class="form-select">
                                            ...
                                            <option :value="index" v-for="index in Number(config_ins)">{{ index }}
                                            </option>
                                        </select>
                                        <select v-else-if="type == 'Advance'" disabled class="form-select"
                                            title="Advance Month">
                                        ...
                                        <span style="color: #DB4437; font-size: 11px;"
                                            v-if="this.no_of_inst == '0' && type == 'Loan'">{{ installments_error
                                            }}</span>
                                    </div>
                                    <div class="col-12 col-md-12">
                                        ...
                                        <span style="color: #DB4437; font-size: 11px;"> *</span>
                                        <label v-if="type == 'Loan' && no_of_inst > 0 && amount > 0"
                                            style="float:right;">Each installments will be of Rs.
                                            <label>{{ Math.round(amount / no_of_inst).toLocaleString()
                                                }}</label></label>
                                        <input type="text" class="form-control" v-model="reason"
                                            placeholder="Type reason here" />
                                        <span style="color: #DB4437; font-size: 11px;" v-if="this.reason == ''">{{
                                            reason_error }}</span>
                                    </div>
                                    <div class="col-12 text-center">
                                        <button
                                            v-if="(emp_name == '' || emp_name == null) || amount == '' || amount > max_advance || type == 'Select' || type == null || reason == '' || (type == 'Loan' && no_of_inst == '0')"
                                            :disabled="disabled" @click="delay()" type="submit" class="btn btn-danger">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body pb-5 px-sm-5 pt-50">
                                <div class="text-center mb-2">
                                    <center>
                                        <div class="col-md-12">
                                            <h1 class="address-title text-center mb-1" id="addNewAddressTitle">Return
                                                loan</h1>
                                            <p class="address-subtitle text-center mb-2 pb-75">Input Details</p>
                            ...
                            <div class="col-md-11  mt-3 mx-2">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="mb-2">
                                            <label for="note" class="form-label fw-bold">Remarks:</label>
                                            <textarea v-model="narration1" class="form-control" rows="2"
                                                id="note"></textarea>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="modal-body pb-5 px-sm-5 pt-50">
                                ...
                                <form id="editUserForm" class="row gy-1 pt-75" onsubmit="return false">
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <span style="color: #DB4437; font-size: 11px;" v-if="us_man_status == ''">{{
                                            us_man_status_error }}</span>
                                    </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body pb-5 px-sm-5 pt-50">
                                ...
                                <form id="editUserForm" class="row gy-1 pt-75" onsubmit="return false">
                                    ...
                                    <div class="col-12 col-md-3">
                                        <label class="form-label">Maximum Limit <span
                                                style="color: #DB4437; font-size: 11px;">*</span></label>
                                        <input disabled type="number" class="form-control" v-model="max_advance" />
                                    </div>
                                    <div class="col-12 col-md-3">
                                        <label class="form-label">{{ pay_type }} amount <span
                                                style="color: #DB4437; font-size: 11px;">*</span></label>
                                        <input type="number" class="form-control" v-model="us_amount" />
                                        <span style="color: #DB4437; font-size: 11px;" v-if="us_amount == ''">{{
                                            e_us_amount }}</span>
                                        <span style="color: #DB4437; font-size: 11px;"
                                            v-if="us_amount > max_advance">Amount is too much</span>
                                    </div>
                                    <div class="col-12 col-md-3">
                                        <label class="form-label">Number of installments </label>
                                        <span v-if="pay_type == 'Loan'"
                                        ...
                                        <span style="color: #DB4437; font-size: 11px;"
                                            v-if="us_installments == '0' && pay_type == 'Loan'">{{ installments_error
                                            }}</span>
                                    </div>
                                    <div class="col-12 col-md-3">
                                        <label v-if="us_type == 'Loan' && us_installments > 0 && us_amount > 0"
                                            style="float:right;">Each installments will be of Rs.
                                            <label>{{ Math.round(us_amount / us_installments).toLocaleString()
                                                }}</label></label>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        ...
                                        <span style="color: #DB4437; font-size: 11px;" v-if="us_reason == ''">{{
                                            e_us_reason }}</span>
                                    </div>
                                    <div class="col-12 col-md-3">
                                        <label class="form-label">Manager Status</label>
                                    ...
                                    <div class="col-12 text-center mt-2 pt-50">
                                        <button
                                            v-if="(pay_type == 'Loan' && us_installments == '0') || us_reason == '' || us_amount == '' || us_amount > max_advance"
                                        ...
                                        <div class="col-md-12">
                                            <table style="width:100%;">
                                                <thead style="float:left; width:100%;" v-for="emp_loan1 in emp_loan">
                                                    <h2 style="text-align:center;">Pay {{ emp_loan1.LoanType }} to
                                                        employee</h2>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <th>Amount: </th>
                                                        <td> {{ Math.floor(emp_loan1.LoanAmount).toLocaleString() }}/-
                                                        </td>
                                                        <th>Installments: </th>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="2">
                                                            <div class="col-md-10">
                                                                <strong>{{ emp_loan1.LoanType !== 'Advance' ?
                                                                    'Installment start from ' : 'For Month' }}</strong>
                                                                <select class="form-select"
                                                                    v-if="emp_loan1.LoanType !== 'Advance'">
                                                                    <option v-for="(sessions1, index) in sessions"
                                                                        :value="index">{{ sessions1 }}</option>
                                                                </select>
                                                        ...
                                                        <td colspan="2">
                                                            <div class="col-md-10">
                                                                ...
                                                                <multiselect dis style="margin-right: 10px;"
                                                                    v-model="bank_type" :options="options5">
                                                                </multiselect>
                                                            </div>
                                                        </td>
                                                        <td colspan="2">
                                                            <div class="col-md-10">
                                                                ...
                                                                <input v-model="bank_amount" type="text"
                                                                    class="form-control" @input="amount_filter()" />
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </thead>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <form id="addNewAddressForm" style="text-align:left;" class="row gy-1 gx-2"
                                                ...
                                                <div class="col-md-12">
                                                    <label class="form-label">Reason</label>
                                                    <textarea rows="3" type="text" disabled class="form-control"
                                                        v-model="us_reason"></textarea>
                                                </div>
                                                <div class="col-md-12">
                                                    ...
                                                    <span style="color: #DB4437; font-size: 11px;"
                                                        v-if="return_amount == '0'">{{ e_ret_installment }}</span>
                                                </div>
                                            </form>
                                        </div>
                                        <div class="col-md-6">
                                                        ...
                                                        <tr v-for="(get_reqdata11, index) in install_list">
                                                            ...
                                                            <td v-if="get_reqdata11.InstallmentStatus == 'Unpaid'">
                                                                <input class="form-check-input" type="checkbox"
                                                                    name="second[]" @change="sum_total()"
                                                                    id="inlineRadio1" /> Return
                                                                <input hidden type="text"
                                                                    :value="get_reqdata11.InstallmentAmount"
                                                                    name="ins_amt[]" class="form-control" />
                                                            </td>
                                                            <td v-else></td>
                                                            <td class="py-1">
                                                                <span v-if="get_reqdata11.InstallmentStatus == 'Unpaid'"
                                                                    class="badge bg-gradient-warning">Unpaid</span>
                                                                <span
                                                                    v-else-if="get_reqdata11.InstallmentStatus == 'waivedoff'"
                                                                    class="badge bg-gradient-success">Waived Off</span>
                                                                <span
                                                                    v-else-if="get_reqdata11.InstallmentStatus == 'Returned'"
                                                                    class="badge bg-gradient-danger">Returned</span>
                                                                <span
        ...
        <vue-html2pdf :show-layout="false" :float-layout="true" :enable-download="false" :preview-modal="true"
            :paginate-elements-by-height="1400" filename="Ind_Employee_Attendance" :pdf-quality="2"
            ...
            @hasGenerated="hasGenerated($event)" ref="htmlloanPdf">
