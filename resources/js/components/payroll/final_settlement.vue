                            ...
                            <div class="card-body border-bottom">
                                <div class="row">
                                    ...
                                    <div class="col-md-1">
                                        ...
                                        <button @click="getbyfilter()" class="dt-button add-new btn btn-primary" tabindex="0" type="button">Search</button>
                                    </div>
                                </div>
                            </div>
                                                    ...
                                                    <div class="d-flex justify-content-left align-items-center">
                                                        <div class="avatar-wrapper">
                                                            <div class="avatar  me-1">
                                                                <img v-if="settlements1.Photo=='' || settlements1.Photo==null" src="public/images/profile_images/pro.png" alt="Avatar" height="32" width="32">
                                                                <img v-else v-bind:src="`public/images/profile_images/${settlements1.Photo}`" alt="Avatar" height="32" width="32">
                                                            </div>
                                                        </div>
                                                        <div class="d-flex flex-column">
                                                            <a class="user_name text-truncate text-body"><span class="fw-bolder">{{settlements1.Name}} </span></a>
                                                            <small class="emp_post text-muted">
                                                                <small>{{settlements1.Department}}-{{settlements1.Designation}}</small>
                                                            </small>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="td-center">{{settlements1.ResignOn}}</td>
                                                <td class="td-center">{{Math.floor(settlements1.PayableSalary).toLocaleString()}}</td>
                                                <td class="td-center">
                                                    <span v-if="settlements1.Status=='Pending'" class="badge bg-gradient-warning">Pending</span>
                                                    <span v-if="settlements1.Status=='Approved'" class="badge bg-gradient-success">Approved</span>
                                                    <span v-if="settlements1.Status=='Paid'" class="badge bg-gradient-primary">Paid</span>
                                                    <span v-if="settlements1.Status=='Rejected'" class="badge bg-gradient-danger">Rejected</span>
                                                </td>
                                                <!--HR status-->
                                                <td class="td-center">
                                                    <span v-if="settlements1.HrStatus=='Approved'" class="badge bg-gradient-success">Approved</span>
                                                    <span @click="fetch_upSts( 'hr', settlements1.ID)" data-bs-toggle="modal" data-bs-target="#viewLoan" v-if="settlements1.PayableSalary>0 && settlements1.HrStatus=='Pending'" class="badge bg-gradient-warning">Pending</span>
                                                    <span v-else-if="settlements1.HrStatus=='Pending'" class="badge bg-gradient-warning">Pending</span>
                                                    <span v-if="settlements1.HrStatus=='Rejected'" class="badge bg-gradient-danger">Rejected</span>
                                                </td>
                                                <!--Finance status-->
                                                <td class="td-center">
                                                    <span v-if="settlements1.FStatus=='Approved'" class="badge bg-gradient-success">Approved</span>
                                                    <span @click="fetch_upSts( 'finance', settlements1.ID)" data-bs-toggle="modal" data-bs-target="#viewLoan" v-if="settlements1.HrStatus=='Approved' && settlements1.FStatus=='Pending' " class="badge bg-gradient-warning">Pending</span>
                                                    <span v-else-if="settlements1.FStatus=='Pending'" class="badge bg-gradient-warning">Pending</span>
                                                    <span v-if="settlements1.FStatus=='Rejected'" class="badge bg-gradient-danger">Rejected</span>
                                                </td>
                                                <td class="td-center">
                                                    <div class="btn-group">
                                                        <a data-bs-toggle="dropdown" class="btn btn-sm dropdown-toggle"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-more-vertical font-small-4"><circle cx="12" cy="12" r="1"></circle> <circle cx="12" cy="5" r="1"></circle> <circle cx="12" cy="19" r="1"></circle></svg></a>
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <a @click="fetch_settlement(settlements1.EmployeeID, settlements1.ID)" v-if="settlements1.Status != 'Rejected' && settlements1.FStatus!='Approved' " data-bs-toggle="modal" data-bs-target="#emploan" class="dropdown-item">
                                                                <i class="fa-solid fa-pen-to-square"></i>
                                                                Edit details
                                                            </a>
                                                            <a @click="fetch_upSts( 'view', settlements1.ID)" data-bs-toggle="modal" data-bs-target="#viewLoan" class="dropdown-item">
                                                                <i class="fa-solid fa-eye"></i>
                                                                View details
                                                            </a>
                                                            <a v-if="settlements1.PayableSalary <= 0" @click="fetch_upSts( 'view', settlements1.ID)" data-bs-toggle="modal" data-bs-target="#delete_setl" class="dropdown-item">
                                                                <i class="fa-solid fa-trash-can"></i>
                                                                Delete
                                                            </a>
                                                            <a @click="fetch_upSts('pay', settlements1.ID)" data-bs-toggle="modal" data-bs-target="#viewLoan" class="dropdown-item" v-if="settlements1.Status == 'Approved' ">
                                                            ...
                                                            <a v-bind:href="`settlement_slip/${settlements1.ID}`" class="dropdown-item" v-if="settlements1.Status == 'Paid' ">
                                ...
                                <div style="text-align:center;padding-top:20px">
                                    <pagination :limit="limit" :data="settlements" @pagination-change-page="getbyfilter"></pagination>
                                </div>
                                <!-- Hoverable rows end -->
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body pb-5 px-sm-5 pt-50">
                                            ...
                                            <section class="app-user-view-account">
                                                <div class="row">
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div class="info-container">
                                                                    <ul class="list-unstyled">
                                                                        ...
                                                                        <li class="mb-75">
                                                                            <span class="fw-bolder me-25">Employeement Status:</span>
                                                                            <span class="badge bg-light-success">{{emp_detail1.Status}}</span>
                                                                        </li>
                                                                        <li class="mb-75" v-for="final_settlementid1 in final_settlementid">
                                                                            <span class="fw-bolder me-25">Resigned On:</span>
                                                                            <span>{{final_settlementid1.ResignOn}}</span>
                                                                        </li>
                                                                        <li class="mb-75" v-for="final_settlementid1 in final_settlementid">
                                                                            <span class="fw-bolder me-25">Resigned By:</span>
                                                    ...
                                                    <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
                                                        <div v-for='emp_detail1 in emp_detail' v-if="man != 'pay'" class="card">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-xl-6 col-12">
                                                                        <dl class="row mb-0">
                                                                            ...
                                                                            <dt class="col-sm-5 fw-bolder mb-1">Salary:</dt>
                                                                            <dd class="col-sm-7 mb-1">{{Math.floor(emp_detail1.Salary).toLocaleString()}}</dd>
                                                                            <dt class="col-sm-5 fw-bolder mb-1">Stipend:</dt>
                                                                            <dd class="col-sm-7 mb-1">{{Math.floor(emp_detail1.Stipend).toLocaleString()}}</dd>
                                                                        </dl>
                                                                    </div>
                                                                    <div class="col-xl-6 col-12">
                                                                        <dl class="row mb-0">
                                                                            <dt class="col-sm-5 fw-bolder mb-1">Reporting To:</dt>
                                                                            <dd class="col-sm-7 mb-1"><label>{{rep_employees.rep1}}</label></dd>
                                                                            <dt class="col-sm-5 fw-bolder mb-1">Address:</dt>
                                                        ...
                                                        <div v-for='final_settlementid1 in final_settlementid' class="card">
                                                            <div class="card-header">
                                                                <div style="float:left">
                                                            ...
                                                            <div class="card-body">
                                                                <div class="row">
                                                                    <div class="col-xl-6 col-12">
                                                                        <dl class="row mb-0">
                                                                            <dt class="col-sm-5 fw-bolder mb-1">Settlement amount:</dt>
                                                                            <dd class="col-sm-7 mb-1">{{Math.floor(final_settlementid1.SettlementAmount).toLocaleString()}}</dd>
                                                                            <dt class="col-sm-5 fw-bolder mb-1">Loan:</dt>
                                                                            <dd class="col-sm-7 mb-1">{{Math.floor(final_settlementid1.LoanAmount).toLocaleString()}}</dd>
                                                                            <dt class="col-sm-5 fw-bolder mb-1">Dues:</dt>
                                                                            <dd class="col-sm-7 mb-1">{{Math.floor(final_settlementid1.DuesAmount).toLocaleString()}}</dd>
                                                                            <dt class="col-sm-5 fw-bolder mb-1">Allowance:</dt>
                                                                            <dd class="col-sm-7 mb-1">{{Math.floor(final_settlementid1.AllowanceAmount).toLocaleString()}}</dd>
                                                                            <dt class="col-sm-5 fw-bolder mb-1">Total Payable:</dt>
                                                                            <dd class="col-sm-7 mb-1"><label>{{Math.floor(final_settlementid1.PayableSalary).toLocaleString()}}</label></dd>
                                                                        </dl>
                                                                    </div>
                                                                    <div class="col-xl-6 col-12">
                                                                        <dl class="row mb-0">
                                                                            <dt class="col-sm-5 fw-bolder mb-1">Gratuity:</dt>
                                                                            <dd class="col-sm-7 mb-1">{{Math.floor(final_settlementid1.Gratuity).toLocaleString()}}</dd>
                                                                            <dt class="col-sm-5 fw-bolder mb-1">Fine:</dt>
                                                                            <dd class="col-sm-7 mb-1">{{Math.floor(final_settlementid1.Fine).toLocaleString()}}</dd>
                                                                            <dt class="col-sm-5 fw-bolder mb-1">Arrears:</dt>
                                                                            <dd class="col-sm-7 mb-1"><label>{{Math.floor(final_settlementid1.ArrearsAmount).toLocaleString()}}</label></dd>
                                                                            <dt class="col-sm-5 fw-bolder mb-1">Bonus:</dt>
                                                                            <dd class="col-sm-7 mb-1">{{Math.floor(final_settlementid1.BonusAmount).toLocaleString()}}</dd>

                                                                            <dt class="col-sm-5 fw-bolder mb-1">Remarks:</dt>
                                                                            <dd class="col-sm-7 mb-1">{{final_settlementid1.Remarks}}</dd>
                                                                        </dl>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="card-body" style="text-align:left;">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        ...
                                                                        <input readonly v-model="cash_amount" type="number" class="form-control" />
                                                                    </div>
                                                                    <div class="col-md-8">
                                                                        <label class="form-label">Bank Ledger</label>
                                                                        <multiselect dis style="margin-right: 10px;" v-model="bank_type" :options="options3"> </multiselect>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="col-xl-6 col-12 row" v-if="man!='view' && man!='pay'" style="float:left;">
                                                        ...
                                                        <div class="col-xl-6 col-12 row" v-if="man=='pay'" style="float:left;">
                                ...
                                <div class="col-12 text-center mt-2 pt-50">
                                    <button v-if="man!='view' && man!='pay' && man!=''" type="button" :disabled="disabled1" @click="delay1()" class="btn btn-primary waves-effect waves-float waves-light" data-bs-dismiss="modal" aria-label="Close">Update</button>
                                    <button v-if="man=='pay' && man!='' && us_man=='Paid'" type="button" :disabled="disabled1" @click="delay()" class="btn btn-success waves-effect waves-float waves-light" data-bs-dismiss="modal">Pay Settlement</button>
                                    <button v-else-if="man=='pay' && man!='' && us_man!='Paid'" type="button" :disabled="disabled1" @click="delay()" class="btn btn-success waves-effect waves-float waves-light">Pay Settlement</button>
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body pb-5 px-sm-3 mx-50">
                                <h1 class="address-title text-center mb-1" id="addNewAddressTitle">Add final settlement</h1>
                                ...
                                <form id="addNewAddressForm" style="text-align:left;" class="row gy-1 gx-2" onsubmit="return false">
                                    <div class="col-12 col-md-6">
                                        ...
                                        <select disabled v-model="name" class="form-select mb-md-0 mb-2">
                                            ...
                                            <option v-for="employees1 in employees" :value='employees1.EmployeeID'>{{employees1.Name}} - {{employees1.EmployeeCode}}</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-3">
                                        <label class="form-label"><span v-if="status=='Resigned'">Resignation</span><span v-else-if="status=='Terminated'">Termination</span> Date</label>
                                    ...
                                    <div class="col-12 col-md-2">
                                        ...
                                        <input type="number" class="form-control" v-model="loan" placeholder="Loan amount" />
                                    </div>
                                    <div class="col-12 col-md-2">
                                        <label class="form-label">Arrears</label>
                                        <input type="number" class="form-control" v-model="arrears" placeholder="Arrears" />
                                    </div>
                                    <div class="col-12 col-md-2">
                                        <label class="form-label">Allowance</label>
                                        <input type="number" class="form-control" v-model="allowance" placeholder="Allowance" />
                                        <span style="color: #DB4437; font-size: 11px;" v-if="allowance==''">{{e_allowance}}</span>
                                    </div>
                                    <div class="col-12 col-md-2">
                                        <label class="form-label">Gratuity</label>
                                        <input type="number" class="form-control" v-model="graduaty" placeholder="Graduaty" />
                                        <span style="color: #DB4437; font-size: 11px;" v-if="graduaty==''">{{e_graduaty}}</span>
                                    </div>
                                    <div class="col-12 col-md-2">
                                        <label class="form-label">Bonus</label>
                                        <input type="number" class="form-control" v-model="bonus" placeholder="Bonus" />
                                        <span style="color: #DB4437; font-size: 11px;" v-if="bonus==''">{{e_bonus}}</span>
                                    </div>
                                    <div class="col-12 col-md-2">
                                    ...
                                    <div class="col-12 col-md-3">
                                        ...
                                        <input type="number" class="form-control" v-model="set_amount" placeholder="Settlement" />
                                        <span style="color: #DB4437; font-size: 11px;" v-if="set_amount==''">{{e_set_amount}}</span>
                                    </div>
                                    <div class="col-12 col-md-7">
                                        <label class="form-label">Remarks</label>
                                        <input type="text" class="form-control" v-model="remarks" placeholder="Type remarks here" />
                                    </div>
                                    <div class="col-12 text-center">
                                        <button :disabled="disabled2" @click="delay2()" type="submit" class="btn btn-primary me-1 mt-2" data-bs-dismiss="modal" aria-label="Close">Apply</button>
                            ...
                            <div class="modal-body pb-5 px-sm-5 pt-50">
                                <div class="text-center mb-2">
                                    ...
                                    <div class="text-center">
                                        <button type="button" @click="delete_settlement(usid)" class="btn btn-primary waves-effect waves-float waves-light" data-bs-dismiss="modal" aria-label="Close">Yes</button>
