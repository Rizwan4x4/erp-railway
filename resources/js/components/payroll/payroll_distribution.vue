                                ...
                                <div class="row p-3">
                                    ...
                                    <div class="col-md-8">
                                        <ul class="nav nav-tabs justify-content-center" role="tablist">
                                            ...
                                            <li v-if="hasPermission('Payroll Bank Distribution List')"
                                                class="nav-item">
                                            ...
                                            <li v-if="hasPermission('Payroll Cash Distribution List')"
                                                class="nav-item">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="homeIcon" aria-labelledby="homeIcon-tab"
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="col-md-3 col-12 mb-2 pe-2">
                                                <input type="text" id="EmployeeName" v-model="keyword4"
                                                    class="form-control"
                                                    placeholder="Search By Employee Name, Code or CNIC">
                                            </div>
                                            <div class="col-md-1 col-12 mb-2">
                                                <button @click="getResults4()" class="btn btn-primary bg-primary">Search</button>
                                            </div>
                                            <div class="col-md-1 col-12 mb-2">
                                            </div>
                                                ...
                                                <table class="table">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th style="font-size:10px !important;">Basic<br />Salary
                                                            </th>
                                                            ...
                                                            <th style="font-size:10px !important;">Arrears<br />& Bonus
                                                            </th>
                                                            <th style="font-size:10px !important;">Allowance</th>
                                                            <th style="font-size:10px !important;">Payable<br />Salary
                                                            </th>
                                                    ...
                                                    <tbody>
                                                        <tr v-for="all_sals1 in emp_data">
                                                            ...
                                                            <td
                                                                style="font-size:10px !important;border-right:1px solid lightgrey">
                                                                <div
                                                                    ...
                                                                    <div class="d-flex flex-column">
                                                                        <a class="user_name text-truncate text-body"><span
                                                                            ...
                                                                            <span v-if="all_sals1.PostingCity != null">{{
                                                                                all_sals1.PostingCity }} - </span>
                                                                            <span v-else></span>
                                                            ...
                                                            <td v-if="all_sals1.SalaryStatus == 'Not Received'"
                                                                ...
                                                                <a @click="fetch_stipend_detail(all_sals1.DistributionID, all_sals1.Name, all_sals1.RemainingAmount, all_sals1.Department, all_sals1.EmpCode, all_sals1.EmployeeID)"
                                                                    ...
                                                                    <span class="badge badge-glow bg-info">Not
                                                                        Received</span>
                                                                </a>
                                                            </td>
                                                            <td v-else-if="all_sals1.SalaryStatus == 'Partially Received'"
                                                                ...
                                                                style="text-align:center;font-size:10px !important;border-right:1px solid lightgrey">
                                                                <span class="badge badge-glow bg-warning">Partially
                                                                    Received</span>
                                                            </td>
                                                            <td v-else
                                                                style="text-align:center;font-size:10px !important;border-right:1px solid lightgrey">
                                                                <span class="badge badge-glow bg-success">Fully
                                                                    Received</span>
                                                            </td>
                                                            <td>
                                                                <a v-if="hasPermission('Payroll View Salary Slip')"
                                                                ...
                                                                <a v-if="hasPermission('Payroll Generate Salary Slip') && all_sals1.ReceivedThrough != null"
                                                                    target="_blank"
                                                            ...
                                                            <table class="table" id="SalaryDist">
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th
                                                                            style="font-size:10px !important;width:150px">
                                                                            Employee Name
                                                                        </th>
                                                                ...
                                                                <tbody>
                                                                    <tr v-for="all_sals1 in all_sals">
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div class="d-flex flex-column">
                                                                                    <a
                                                                                        ...
                                                                                        class="emp_post text-muted">
                                                                                        <span
                                                                                            v-if="all_sals1.PostingCity != null">{{
                                                                                            all_sals1.PostingCity }} -
                                                                                        </span>
                                                                                        <span v-else></span>
                                                                                        <span
                                                                                            v-if="all_sals1.Department != null">{{
                                                                                            all_sals1.Department }} -
                                                                                        </span>
                                                                                        <span v-else></span>
                                                                                        <span
                                                                                            v-if="all_sals1.Designation != null">{{
                                                                                            all_sals1.Designation
                                                                                            }}</span>
                                                                                        <span v-else></span>
                                                                                    </small>
                                                                                </div>
                                                                        ...
                                                                        <td
                                                                            style="text-align:center;font-size:10px !important;border-right:1px solid lightgrey">
                                                                            {{
                                                                                sumStats(all_sals1.Fine,
                                                                                    all_sals1.DuesAmount)
                                                                            }}
                                                                        </td>
                                                                        <td
                                                                            style="text-align:center;font-size:10px !important;border-right:1px solid lightgrey">
                                                                            {{
                                                                                sumStats(all_sals1.ArrearsAmount,
                                                                                    all_sals1.BonusAmount)
                                                                            }}
                                                                        </td>
                                                                        <td
                                                                            style="text-align:center;font-size:10px !important;border-right:1px solid lightgrey">
                                                                        ...
                                                                        <td v-if="all_sals1.SalaryStatus == 'Not Received'"
                                                                            ...
                                                                            <a @click="fetch_stipend_detail(all_sals1.DistributionID, all_sals1.Name, all_sals1.RemainingAmount, all_sals1.Department, all_sals1.EmpCode, all_sals1.EmployeeID)"
                                                                                ...
                                                                                data-bs-target="#editpayroll">
                                                                                <span
                                                                                    class="badge badge-glow bg-info">Not
                                                                                    Received</span>
                                                                            </a>
                                                                        </td>
                                                                        ...
                                                                        <td v-else-if="all_sals1.SalaryStatus == 'Partially Received'"
                                                                            ...
                                                                            data-bs-target="#editpayroll">
                                                                            <span
                                                                                class="badge badge-glow bg-warning">Partially
                                                                                Received</span>
                                                                        </td>
                                                                        <td v-else
                                                                            style="text-align:center;font-size:10px !important;border-right:1px solid lightgrey">
                                    ...
                                    <div class="tab-pane" id="profileIcon" aria-labelledby="profileIcon-tab"
                                        role="tabpanel">
                                        <p>
                                        <div v-if="hasPermission('Payroll Bank Distribution List')"
                                                    ...
                                                    <tr v-for="all_sals11 in all_sals10">
                                                        ...
                                                        <td
                                                            ...
                                                            <div class="d-flex justify-content-left align-items-center">
                                                                <div class="avatar-wrapper">
                                                                    <div class="avatar  me-1">
                                                                        <img v-if="all_sals11.Photo == '' || all_sals11.Photo == null"
                                                                            src="public/images/profile_images/pro.png"
                                                                            alt="Avatar" height="32" width="32">
                                                                        <img v-else
                                                                ...
                                                                <div class="d-flex flex-column">
                                                                    <a class="user_name text-truncate text-body"><span
                                                                            class="fw-bolder">{{ all_sals11.Name }}
                                                                        </span></a><small class="emp_post text-muted">
                                                                        <span v-if="all_sals11.PostingCity != null">{{
                                                                            all_sals11.PostingCity }} - </span>
                                                                        <span v-else></span>
                                                                        <span v-if="all_sals11.Department != null">{{
                                                                            all_sals11.Department }} - </span>
                                                                        <span v-else></span>
                                                                        <span v-if="all_sals11.Designation != null">{{
                                                                            all_sals11.Designation }}</span>
                                                                        <span v-else></span>
                                                                    </small>
                                                                </div>
                                                            </div>
                                        ...
                                        <div class="accordion accordion-border accordion-flush" id="accordionBorder">
                                            <div class="accordion-item" v-for="date_list1 in date_list">
                                                ...
                                                <div :id="('accordionBorder' + date_list1)"
                                                    ...
                                                    data-bs-parent="#accordionBorder">
                                                    <div class="accordion-body">
                                                        <h6>Rs: {{ Number(total_deduct).toLocaleString() }} Cash has
                                                            been
                                                            distributed among {{ received_list.length }} Employees
                                                            Today: {{ date_list1 }}</h6>
                                                        <button type="button"
                                                            ...
                                                            <table class="table table-hover"
                                                                ...
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th class="sticky-th-center">Total Cash Paid
                                                                        </th>
                                                                ...
                                                                <tbody>
                                                                    <tr v-for="all_sals1 in received_list">
                                                                        <td class="td-center">{{ all_sals1.EmpCode }}
                                                                        </td>
                                                                        <td class="td-center">
                                                                            <div
                                                                                class="d-flex justify-content-left align-items-center">
                                                                        ...
                                                                        <td class="td-center">{{
                                                                            Number(all_sals1.PaidAmount).toLocaleString()
                                                                            }}</td>
                                                                        <td class="td-center">{{
                                                                            Number(all_sals1.CurrentPaidAmount).toLocaleString()
                                                                            }}</td>
                                    ...
                                    <table class="" style="width:100%">
                                        ...
                                        <tr>
                                            ...
                                            <td class="col-md-3" style="text-align: right;">
                                                ...
                                                Rs.
                                                {{ sumStats(view_employee_slip1.AllowanceAmount,
                                                view_employee_slip1.FuelAmount) }}/-
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="col-md-3">
                                        ...
                                        <tr>
                                            ...
                                            <td class="col-md-3" style="padding-left:30px">
                                                <span class="fw-bolder me-25">Installment {{
                                                    view_employee_slip1.InstallmentNo }}</span>
                                            </td>
                                            <td class="col-md-3" style="text-align: right;">
                                                Rs.
                                                {{ sumStats(view_employee_slip1.InstallmentAmount,
                                                view_employee_slip1.AdvanceAmount) }}/-
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="col-md-3">
                                        ...
                                        <tr>
                                            ...
                                            <td class="col-md-3" style="text-align: right;">
                                                Rs.
                                                {{ sumStats(view_employee_slip1.DuesAmount,
                                                view_employee_slip1.FuelReceivable) }}/-
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="col-md-3">
                    ...
                    <div class="modal-body pb-5 px-sm-5 pt-50">
                        <form class="row gy-1 gx-2 mt-75">
                            ...
                            <div class="col-md-8">
                                ...
                                <multiselect style="margin-right: 10px;" v-model="bank_type" :options="options">
                                </multiselect>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-12 text-center">
                                <button v-if="hasPermission('Payroll Update Status by Paying Salary')" type="submit"
                                    :disabled="disabled1" @click="delay1()" class="btn btn-primary bg-primary"
