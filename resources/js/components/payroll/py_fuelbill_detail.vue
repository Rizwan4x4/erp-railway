                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr v-for="all_sals1 in adsdata.data">
                                            ...
                                            <td style="text-align:center;border-right:1px solid lightgrey">
                                                {{ all_sals1.CreatedOn.slice(0, 10) }}</td>
                                            <td style="text-align:center;border-right:1px solid lightgrey">
                                                {{ all_sals1.BillAmount }}</td>
                                            <td style="text-align:center;border-right:1px solid lightgrey">
                                                {{ Math.floor(all_sals1.FuelQuantity) }} Liter<label
                                                    v-if="all_sals1.FuelQuantity > 1">s</label></td>
                                            <td style="text-align:center;border-right:1px solid lightgrey">
                                                {{ all_sals1.Description }}</td>
                                            <td>
                                                <a v-if="hasPermission('Fuel bill actions') && all_sals1.Status == 'Pending'"
                                                    @click="fetch_emp_payroll(all_sals1.AllowanceID)"
                                                    data-bs-toggle="modal" data-bs-target="#editpayroll"><i
                                                        style="color:#d42f2f"
                                                        class="fa-solid fa-pencil"></i><span></span></a>
                                                <a v-else><i style="color:#d42f2f"
                                                        class="fa-solid fa-pencil"></i><span></span></a>
                                            </td>
                                        </tr>
                                    </tbody>
