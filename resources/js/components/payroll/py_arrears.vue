                                    ...
                                    <table class="table table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="sticky-th-center">Arrears</th>
                                                <th class="sticky-th-center">Session<br />Date</th>
                                                ...
                                                <td class="text-center"style="text-align:center;border-right:1px solid lightgrey">
                                                    <div class="btn-group text-center">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <a class="dropdown-item" v-if="all_sals1.Status=='Pending'" @click="fetch_emp_payroll(all_sals1.ArrearsID)" data-bs-toggle="modal" data-bs-target="#editpayroll">
                                                                <i class="fa-solid fa-pencil-square-o"></i>Edit details
                                                            </a>
                                                            <a class="dropdown-item" @click="getid(all_sals1.ArrearsID)" data-bs-toggle="modal" data-bs-target="#delete_arrear">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body pb-5 px-sm-5 pt-50">
                                    <form class="row gy-1 gx-2 mt-75">
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label">Apply Date <span style="color: #DB4437; font-size: 11px;">*</span></label>
                                            <input v-model="emp_date" type="date" class="form-control" />
                                            <span style="color: #DB4437; font-size: 11px;" v-if="emp_date==''">{{e_emp_date}}</span>
                                        </div>
                                        <div class="col-12">
                                            <label class="form-label">Employee Name <span style="color: #DB4437; font-size: 11px;">*</span></label>
                                            ...
                                            <span style="color: #DB4437; font-size: 11px;" v-if="emp_name=='' || emp_name==null">{{e_emp_emp_id}}</span>
                                        </div>
                                        <div class="col-md-12">
                                            <label class="form-label">Amount <span style="color: #DB4437; font-size: 11px;">*</span></label>
                                            <input v-model="emp_amount" type="number" class="form-control" placeholder="Enter arrears amount" />
                                            <span style="color: #DB4437; font-size: 11px;" v-if="emp_amount==''">{{e_emp_amount}}</span>
                                        </div>
                                        <div class="col-md-12">
                                            <label class="form-label">Description</label>
                                            <input v-model="emp_description" type="text" class="form-control" placeholder="Type description here" />
                                        </div>
                                        <div class="col-12 text-center">
                                            <button v-if="emp_emp_id == '' || emp_amount=='' || emp_date==''" type="submit" :disabled="disabled" @click="delay()" class="btn btn-danger">Apply Now</button>
                                            <button v-else type="submit" :disabled="disabled" @click="delay()" class="btn btn-primary bg-primary" data-bs-dismiss="modal" aria-label="Close">Apply Now</button>
                    ...
                    <div class="modal-body pb-5 px-sm-5 pt-50">
                        <form id="addNewCardValidation" class="row gy-1 gx-2 mt-75" onsubmit="return false">
                            <div class="col-6">
                                ...
                                <input hidden v-model="edit_arrear_id" type="text" readonly class="form-control" />
                            </div>
                            <div class="col-md-6">
...
<script>
    ...
    export default {
        ...
        methods: {
            find_id(code_name) {
                if (code_name != '' && code_name != null) {
                    ...
                    axios.get('id_by_code/' + code[0])
                        .then(responce => {
                            this.emp_emp_id = responce.data;
                        })
                }
            },
            applyallowance() {
                if ((this.emp_name == '' || this.emp_name == null) || this.emp_amount == '' || this.emp_date == '' || this.emp_emp_id == '' || this.session_name == '') {
                    ...
                    if (this.emp_amount == '') {
                        this.e_emp_amount = 'Enter arrears amount';
                    }
                    else {
                        this.e_emp_amount = '';
                    }
                    if (this.emp_date == '') {
                        this.e_emp_date = 'Select date';
                    }
                    else {
                        this.e_emp_date = '';
                    }
            ...
            getResults(page = 1) {
                axios.get('./search_arrears?page=' + page, { params: { keyword1: this.keyword1 } })
