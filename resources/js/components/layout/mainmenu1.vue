<template>
    <!-- BEGIN: Main Menu-->
    <div class="top-radius bottom-radius main-menu menu-fixed menu-light menu-accordion menu-shadow shadow-sm"
            ...
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li v-if="hasPermission('Dashboard')" class="nav-item has-sub">
                    <a class="d-flex align-items-center"><i class="fa-solid fa-gauge"></i><span
                            class="menu-title text-truncate fw-semibold">Dashboards</span></a>
                ...
                <li class="nav-item has-sub" v-if="hasPermission('Recruitment')">
                    <a class="d-flex align-items-center">
                        ...
                        <span class="menu-title text-truncate fw-semibold">Hiring Management</span>
                    </a>
                    <ul class="menu-content">
                ...
                <li class="nav-item has-sub">
                    <a v-if="hasPermission('HRMS')" class="d-flex align-items-center"><i
                        ...
                        <!-- <span class="menu-title text-truncate">HRMS</span> -->
                        <span class="menu-title text-truncate fw-semibold">HR Operations</span>
                    </a>
                    <ul class="menu-content">
                        ...
                        <li @click="activate(71)" :class="{ active: active_el == 71 }"
                            ...
                            <router-link to="/hr/organization_cart" class="d-flex align-items-center"><i
                                    class="fa-regular fa-circle"></i><span class="menu-item text-truncate">Organization
                                    Chart</span>
                            </router-link>
                        </li>
                    </ul>
                ...
                <li v-if="hasPermission('Payroll')" class="nav-item has-sub">
                    <a class="d-flex align-items-center">
                        ...
                        <!-- <span class="menu-title text-truncate" data-i18n="Invoice">Payroll</span> -->
                        <span class="menu-title text-truncate fw-semibold" data-i18n="Invoice">Finance Operations</span>
                    </a>
                    <ul class="menu-content">
                            ...
                            <ul class="menu-content">
                                ...
                                <li v-if="hasPermission('Payroll employee Salary Details')" @click="activate(13)"
                                    ...
                                    <router-link class="d-flex align-items-center" to="/payroll/employees_detail"><i
                                            class="fa-regular fa-circle"></i><span class="menu-item text-truncate">Emp.
                                            Salaries</span>
                                    </router-link>
                                </li>
                        ...
                        <li v-if="hasPermission('Payroll Incentives')" class="has-sub">
                            <a class="d-flex align-items-center" href="#">
                                ...
                                <span class="menu-item text-truncate" data-i18n="Account Settings">Incentives</span></a>
                            <ul class="menu-content">
                ...
                <li v-if="hasPermission('Fuel')" class="nav-item has-sub">
                    <a class="d-flex align-items-center">
                        ...
                        <!-- <span class="menu-title text-truncate" data-i18n="Invoice">Fuel</span> -->
                        <span class="menu-title text-truncate fw-semibold" data-i18n="Invoice">Fuel Operations</span>
                    </a>
                    <ul class="menu-content">
                ...
                <li v-if="hasPermission('HR Configuration')" class="nav-item has-sub">
                    <a class="d-flex align-items-center">
                        ...
                        <!-- <span class="menu-title text-truncate">HR Configurations</span> -->
                        <span class="menu-title text-truncate fw-semibold">HR Controllers</span>
                    </a>
                    <ul class="menu-content">
                ...
                <li v-if="hasPermission('Purchase')" class="nav-item has-sub">
                    <a class="d-flex align-items-center"><i class="fa-solid fa-basket-shopping"></i><span
                            class="menu-title text-truncate fw-semibold">Purchase</span></a>
                    <ul class="menu-content">
                        ...
                        <li v-if="hasPermission('GRN View')" @click="activate(44)" :class="{ active: active_el == 44 }">
                ...
                <li class="nav-item has-sub">
                    <a v-if="hasPermission('Inventory')" class="d-flex align-items-center"><i
                            ...
                            class="menu-title text-truncate fw-semibold">Inventory</span></a>
                    <ul class="menu-content">
                ...
                <li v-if="this.$helpers.hasPermission('Inventory Assets readyOnly')" @click="activate(52)"
                    ...
                    <router-link class="d-flex align-items-center" to="/accounts/assets_detail"><i
                            class="fa-solid fa-car"></i><span class="menu-item text-truncate fw-semibold">Assets
                            Detail</span>
                    </router-link>
                </li>
                ...
                <li v-if="hasPermission('Inventory Account-Reports overall')" @click="activate(29)"
                    ...
                    <router-link to="/accounts/report" class="d-flex align-items-center"><i
                            class="fa-solid fa-chart-pie"></i><span class="menu-item text-truncate fw-semibold">Pro..
                            Reports</span>
                    </router-link>
                </li>
                <li v-if="hasPermission('Procurement Configurations')" class="nav-item has-sub">
                    <a class="d-flex align-items-center"><i class="fa-solid fa-sliders"></i><span
                            class="menu-title text-truncate fw-semibold">Pro.. Configurations</span></a>
                    <ul class="menu-content">
                        <li v-if="hasPermission('Accounting procurement-configuration Delivery')" @click="activate(50)"
                            :class="{ active: active_el == 50 }">
                            <router-link class="d-flex align-items-center" to="/accounts/delivery"><i
                                    class="fa-regular fa-circle"></i><span
                                    class="menu-item text-truncate">Delivery</span>
                            </router-link>
                        </li>
                        <li v-if="hasPermission('Accounting procurement-configuration general')" @click="activate(43)"
                        ...
                        <li v-if="hasPermission('Accounting procurement-configuration vendors')" @click="activate(26)"
                            :class="{ active: active_el == 26 }">
                ...
                <li v-if="hasPermission('Accounting')" class="nav-item has-sub">
                    <a class="d-flex align-items-center"><i class="fa-solid fa-receipt"></i><span
                            class="menu-title text-truncate fw-semibold">Accounting</span></a>
                    <ul class="menu-content">
                ...
                <li class="has-sub " v-if="hasPermission('Units-Management units-data readOnly')">
                    ...
                    <a class="d-flex align-items-center"><i class="fa-solid fa-receipt"></i><span
                            class="menu-title text-truncate fw-semibold">Units data</span></a>
                    <ul class="menu-content">
                ...
                <li v-if="hasPermission('Inventory Account-Reports overall')" @click="activate(74)"
                    ...
                    <router-link to="/accounts/report" class="d-flex align-items-center"><i
                            class="fa-solid fa-chart-pie"></i><span class="menu-item text-truncate fw-semibold">Accounts
                            Reports</span>
                    </router-link>
                </li>
                <li v-if="hasPermission('Accounts Configurations')" class="nav-item has-sub">
                    <a class="d-flex align-items-center"><i class="fa-solid fa-sliders"></i><span
                            class="menu-title text-truncate fw-semibold">Acc.. Configurations</span></a>
                    <ul class="menu-content">
                        ...
                        <li v-if="hasPermission('Accounts Configurations  department access')" @click="activate(54)"
                            ...
                            <router-link class="d-flex align-items-center" to="/Accounts/user_base_access"><i
                                    class="fa-regular fa-circle"></i><span class="menu-item text-truncate">Departments
                                    Access</span>
                            </router-link>
                        </li>
                    </ul>
                ...
                <li v-if="hasPermission('Settings')" class="nav-item has-sub">
                    <a class="d-flex align-items-center"><i class="fa-solid fa-gear"></i><span
                            class="menu-title text-truncate fw-semibold" data-i18n="Settings">Settings</span></a>
                    <ul class="menu-content">
                ...
                <li v-if="hasPermission('Admin')" class="nav-item has-sub">
                    <a v-if="hasPermission('Admin')" class="d-flex align-items-center mb-2"><i
                            class="fas fa-user-shield "></i><span class="menu-title text-truncate fw-semibold"
                        ...
                        <li class="nav-item has-sub">
                            ...
                            <ul class="menu-content">
                                ...
                                <li @click="activate(43)" :class="{ active: active_el == 43 }">
                                    <router-link class="d-flex align-items-center" to="/settings/rolesPermissions"><i
                                            class="fa-regular fa-circle"></i><span class="menu-item text-truncate"
                                            data-i18n="List">List Roles</span>
                                    </router-link>
                                </li>
                                <li @click="activate(99)" :class="{ active: active_el == 99 }">
                                    <router-link class="d-flex align-items-center mb-2" to="/settings/CreateRoles"><i
                                            class="fa-regular fa-circle"></i><span class="menu-item text-truncate"
                                            data-i18n="List">Create Roles</span>
                                    </router-link>
                                </li>
                                <li @click="activate(99)" :class="{ active: active_el == 101 }">
                                    <router-link class="d-flex align-items-center mb-2"
                                        :to="{ name: 'overall_companies' }">
                                        <i class="fa-regular fa-circle"></i>
                                        <span class="menu-item text-truncate" data-i18n="List">Overall Company</span>
                                    </router-link>
                                </li>
