                ...
                <div class="content-body">
                    ...
                    <section class="app-user-list">
                        <div class="card top-radius bottom-radius border-0">
                            ...
                            <div
                                class="d-flex justify-content-between align-items-center header-actions mx-2 row p-3">
                                <div class="col-sm-5 col-lg-7 ps-xl-75 ps-0 d-flex">
                                    <div class="dt-buttons d-inline-flex mt-50 me-50">
                                        <a style="float: left" data-bs-toggle="modal" data-bs-target="#addNewCard"
                                            class="btn btn-primary bg-primary waves-effect">Create New Depreciation</a>
                                    </div>
                                    <div class="dt-buttons d-inline-flex mt-50" style="min-width: 50px !important;">
                                        <router-link style="float:left" to="/Accounts/create_assets_depreciation"
                                            class="btn btn-primary bg-primary waves-effect">Proceed Asset
                                            Depreciation</router-link>
                                    </div>
                                </div>
                                <div class="col-sm-7 col-lg-5 ps-xl-75 ps-0">
                                    <div
                                        class="dt-action-buttons d-flex align-items-center justify-content-center justify-content-lg-center flex-lg-nowrap flex-wrap">
                                                ...
                                                <div class="dataTables_filter" style="margin-top:5px">
                                                    <label>
                                                        <input autocomplete="off" type="text" name="keyword1"
                                                            v-model="keyword1" class="form-control" style="width: 140px;"
                        ...
                        <form id="addNewCardValidation" class="row gy-1 gx-2 mt-75" onsubmit="return false">
                            ...
                            <div class="col-12">
                                ...
                                <select v-model="assets_category" class="form-select">
                                    ...
                                    <option v-for='category_detail1 in category_list' :value='category_detail1.ID'>{{
                                        category_detail1.CategoryName}}</option>
                                </select>
                                <span style="color: #db4437; font-size: 11px" v-if="assets_category == ''">{{
                                    e_assets_category }}</span>

                                <div class="form-group">
                                    <label class="form-label" for="modalAddCardName">Depreciation Name</label>
                                    <input type="text" v-model="depr_name" class="form-control"
                                        placeholder="Depreciation Name" style="" />
                                    <span style="color: #db4437; font-size: 11px" v-if="depr_name == ''">{{ e_depr_name
                                        }}</span>

                                </div>
                                <div class="form-group">
                                    <label class="form-label" for="modalAddCardName">Starting Date</label>
                                    <input type="date" v-model="starting_date" class="form-control"
                                        placeholder="Starting date" style="" />
                            ...
                            <div class="col-12">
                                ...
                                <span style="color: #db4437; font-size: 11px" v-if="depr_method == ''">{{ e_depr_method
                                    }}</span>
                            </div>
                            <div class="form-group" v-if="toggle">
                                ...
                                <input type="number" v-model="percentage" class="form-control"
                                    placeholder="type Percentage i.e 5,10,20" style="" />
                                <span style="color: #db4437; font-size: 11px" v-if="percentage == ''">{{ e_percentage
                                    }}</span>
