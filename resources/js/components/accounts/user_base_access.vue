                                ...
                                <div class="card top-radius bottom-radius border-0">
                                    <div class="card-header">
                                        ...
                                        <div style="text-align: right;width: 30% !important;">
                                            <a v-if="hasPermission('AccountinAccounts Configurations  allow-department-access')"
                                                style="float: left" data-bs-toggle="modal" data-bs-target="#leavetype2"
                                                class="btn btn-primary bg-primary">Allow access</a>
                                                            ...
                                                            <!-- <div class="card">
                                                                <div class="card-body"> -->
                                                                                ...
                                                                                <tr class="odd"
                                                                                    ...
                                                                                    <td>
                                                                                        ...
                                                                                        <span v-if="adsdata1.d2 != '0'"
                                                                                            class="badge badge-glow bg-success">{{ adsdata1.d2 }}</span>
                                                                                        <span v-if="adsdata1.d3 != '0'"
                                                                                            class="badge badge-glow bg-success">{{ adsdata1.d3 }}</span>
                                                                                        <span v-if="adsdata1.d4 != '0'"
                                                                                            class="badge badge-glow bg-success">{{ adsdata1.d4 }}</span>
                                                                                        <span v-if="adsdata1.d5 != '0'"
                                                                                            class="badge badge-glow bg-success">{{ adsdata1.d5 }}</span>
                                                                                        <span v-if="adsdata1.d6 != '0'"
                                                                                            class="badge badge-glow bg-success">{{ adsdata1.d6 }}</span>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    ...
                                                                    <div style="text-align:center;padding-top:20px">
                                                                        <pagination :limit="limit" :data="adsdata"
                        ...
                        <div id="addNewCardValidation" class="row gy-1 gx-2 mt-75">
                            <div class="col-12">
                                ...
                                <multiselect style="margin-right: 10px; font-size: 12px;" id="FilterTransaction"
                                    :show-labels="false" v-model="email_id" :options="options8">
                                </multiselect>
                            </div>
                            <div class="invoice-customer">
                                ...
                                <span style="color: #DB4437; font-size: 11px;">*</span>
                                <multiselect style="margin-right: 10px; font-size: 12px;" id="FilterTransaction"
                                    :show-labels="false" :multiple="true" v-model="dept_name" :options="options">
                                </multiselect>
                            </div>
