                        ...
                        <div class="row invoice-add">
                            ...
                            <div class="col-xl-9 col-md-8 col-12">
                                <div class="card invoice-preview-card">
                                    ...
                                    <!-- Header ends -->
                                    <div class="divider">
                                        <div class="divider-text" style="font-size: 24px;font-weight: 900;">Edit Petty Cash</div>
                                    </div>
                                ...
                                <input class="form-control" type="text" v-model="total_value" style="" />
                                    ...
                                    <div class="my-5">
                                        <div data-repeater-list="group-a"  v-for="get_grndata1 in get_grndata" :key="get_grndata1">
                            <div class="repeater-wrapper my-5" data-repeater-item>
                                <div class="row">
                                    <div class="col-12 d-flex product-details-border position-relative pe-0">
                                        <div class="row w-100 pe-lg-0 pe-1 py-2">
                                            <div class="col-lg-6 col-12 mb-lg-0 mb-2 mt-lg-0 mt-2">
                                                ...
                                                <textarea class="form-control" type="text" rows="1" name="first[]" style=""  >{{get_grndata1.VendorName}}</textarea>

                                                 <textarea class="form-control mt-2" rows="1" name="fourth[]" placeholder="Item Detail">{{get_grndata1.ItemDetail}}</textarea>
                                            </div>

                                            <div class="col-lg-4 col-12 my-lg-0 my-2">
                                                <p class="card-text col-title mb-md-2 mb-0">Bill No</p>
                                                <textarea type="text" class="form-control" rows="1"  placeholder="bill no..." name="second[]" >{{get_grndata1.BillNumber}}</textarea>
                                            </div>

                                            <div class="col-lg-2 col-12 my-lg-0 my-2">
                                                <p class="card-text col-title mb-md-2 mb-0">Amount</p>
                                                <textarea type="number" class="form-control" name="third[]" rows="1"  >{{Number(get_grndata1.Amount)}}</textarea>
                                            </div>
                                            <br/>
                                        </div>
...
axios.post('accounts/edit_pettycash', {
vendor_name: k,
bill_no: l,
amount: m,
item_detail: n,
...
if(data.data=="submitted"){
   this.$toastr.s("Petty Cash Updated Successfully", "Congratulations!");
    this.$router.push({ name: 'petty_cash_detail'})
            ...
            getResult(){
                axios.get('accounts/pettyitem_details/' + this.id)
                .then(response => {
                   this.dept_name=response.data[0].DeptName
                   this.date=response.data[0].PettyDate
                })

            axios.get('accounts/pettyitem_details1/' + this.id)
                .then(response => {
