                ...
                <div class="noprint content-header row">
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <router-link to="../purchase/payment_detail" style="text-decoration: none;">Payment Detail(s)</router-link>
                            </li>
                            ...
                            <div class="col-xl-9 col-md-8 col-12">
                                <div class="card invoice-preview-card">
                                    ...
                                    <div class="card-body invoice-padding pt-0">
                                        <div class="row row-bill-to invoice-spacing" style="margin-top:0px;margin-bottom:0px">
                                            <div class="row" style="margin-top:10px">
                                                <div class="col-md-6">
                                                    <h6 class="invoice-to-title" style="margin-bottom:5px">Payment Against:</h6>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="invoice-customer">
                                                        <multiselect @input="find_methodtype()" style="margin-right: 10px;" v-model="method_type" :options="options2"> </multiselect>
                                                        <span style="color: #db4437; font-size: 11px" v-if="method_type== ''">{{ e_method_type }}</span>
                                                    </div>
                                                    <div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6" v-if="this.filterby[0]!='101001001001'">
                                                    <h6 class="invoice-to-title" style="margin-bottom:5px">Instrument Date:</h6>
                                                    <div class="invoice-customer">
                                                        <input type="date" v-model="chq_date" class='form-control'>
                                                    </div>
                                                </div>
                                                <div class="col-md-6" v-if="this.filterby[0]!='101001001001'">
                                                    <h6 class="invoice-to-title" style="margin-bottom:5px">Instrument Number:</h6>
                                                    <div class="invoice-customer">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="mb-1">
                                                        <div class="row demo-inline-spacing my-2">
                                                            <div class="col-md-3 form-check form-check-inline" style="margin-top:0px">
                                                                <input class="form-check-input" type="radio" @change="taxHandler1()"  name="flexRadioDefault" id="inlineRadio7"   checked />
                                                                <label class="form-check-label" for="inlineRadio7">Without Tax</label>
                                                            </div>
                                                            <div class="col-md-3 form-check form-check-inline" style="margin-top:0px">
                                                                <input class="form-check-input" type="radio" @change="taxHandler()"   name="flexRadioDefault" id="inlineRadio8" >
                                                                <label class="form-check-label" for="inlineRadio8">With Tax</label>
                                                            </div>

                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-12" v-if="tax_check">
                                                    <h6 class="invoice-to-title" style="margin-bottom:5px">Tax Against:</h6>
                                                    <div class="invoice-customer">
                                                        <multiselect  style="margin-right: 10px;" v-model="tax_against" :options="options3" >
                                                        </multiselect>
                                                    </div>
                                                     <span style="color: #db4437; font-size: 11px" v-if="tax_against == ''">{{ e_tax_against }}</span>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="mb-1">
                                                        <label class="form-label" for="basicSelect">Payment Against</label>
                                                        ...
                                                        <div class="row demo-inline-spacing">
                                                            <div class="col-md-2 form-check form-check-inline" style="margin-top:0px">
                                                                <input @change="others()" class="form-check-input" type="radio" v-model="p_agnst" name="inlineRadioOptions" id="inlineRadio1" value="mis">
                                                                <label class="form-check-label" for="inlineRadio1">Others</label>
                                                            </div>
                                                            <div class="col-md-3 form-check form-check-inline" style="margin-top:0px">
                                                                <input class="form-check-input" type="radio" v-model="p_agnst" @change="find_against();pi()" name="inlineRadioOptions" id="inlineRadio3" value="po_">
                                                                <label class="form-check-label" for="inlineRadio3">Purchase Order</label>
                                                            </div>
                                                            <div class="col-md-3 form-check form-check-inline" style="margin-top:0px">
                                                                <input class="form-check-input" type="radio" v-model="p_agnst" @change="find_against();pi()" name="inlineRadioOptions" id="inlineRadio2" value="pi_">
                                                                <label class="form-check-label" for="inlineRadio2">Purchase Invoice</label>
                                                            </div>
                                                            <div class="col-md-3 form-check form-check-inline" style="margin-top:0px">
                                                                <input class="form-check-input" type="radio" v-model="p_agnst" @change="find_against();pi()" name="inlineRadioOptions" id="inlineRadio4" value="jv_">
                                                                <label class="form-check-label" for="inlineRadio4">Journals</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div v-if="p_agnst!='mis'" class="form-group xz_form  row animated slideInDown" v-for="count in counter" :id="count" style="margin-top:10px">
                                          ...
                                          <div class="col-xl-4 mb-lg-1 col-bill-to ps-0" v-if="p_agnst=='po_'">

                                                        <multiselect @input="search_po_detail(first[count],[count])" style="margin-right: 10px;" v-model="first[count]" :options="options8"> </multiselect>

                                                    </div>
                                                    <div class="col-xl-4 mb-lg-1 col-bill-to ps-0" v-if="p_agnst=='pi_'">

                                                        <multiselect style="margin-right: 10px;" @input="search_po_detail(first[count],[count])" v-model="first[count]"
                                                         :options="options9"> </multiselect>

                                                    </div>
                                                    <div class="col-xl-4 mb-lg-1 col-bill-to ps-0" v-if="p_agnst=='jv_'">

                                                        <multiselect style="margin-right: 10px;" @input="search_po_detail(first[count],[count])" v-model="first[count]"
                                                         :options="options10"> </multiselect>

                                                    </div>


                                                    <div class="col-xl-4 mb-lg-1 col-bill-to ps-0" >
                                                      <input  type="number" name="fourth[]" class="form-control ms-50" readonly :id="'demo_'+(count)" placeholder="Remaining Amount" />

                                                      </div>
                                                     <div class="col-xl-2 mb-lg-1 col-bill-to ps-0" >
                                                      <input  type="number" name="third[]" class="form-control ms-50" id="salesperson" placeholder="Paid Amount" />
                                                      </div>
                                                       <div class="col-xl-2 mb-lg-1 col-bill-to ps-0" v-if="tax_check">
                                                      <input  type="number" name="fifth[]" class="form-control ms-50" placeholder="Tax Amount" />
                                                      </div>
                                        ...
                                        <div v-if="p_agnst!='jv_'" class="row mt-1">
                                            <div v-if="p_agnst!='mis'" class="col-12 px-0">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="invoice-total-item">
                                                        <label for="salesperson" class="form-label">Total Amount:</label>
                                                        <p class="invoice-total-amount">

                                                            <input  type="number" v-model="amount" class="form-control ms-50" id="salesperson" placeholder="" />
                                                            <span style="color: #db4437; font-size: 11px" v-if="amount == ''">{{ e_amount }}</span>
                                                        </p>
                                                    </div>
                                                </div>
                                                <div class="col-md-4" v-if="p_agnst=='mis'">
                                                 ...
                                                 <div class="col-md-4" >
                                                    <div class="invoice-total-item" v-if="tax_check">
                                                        <label for="salesperson" class="form-label">Total Tax Amount:</label>
                                                        <p class="invoice-total-amount">

                                                            <input  type="number" v-model="tax_amount" class="form-control ms-50" id="salesperson" placeholder="" />

                                                        </p>
                                                    </div>
                                                </div>
                                                <div class="col-md-4" >
                                                    <h6 class="invoice-to-title" style="margin-bottom:5px">Received By</h6>
                                                    <div class="invoice-customer">
                                                        <input type="text" v-model="salesperson" class='form-control'>
                                                        <span style="color: #db4437; font-size: 11px" v-if="salesperson == ''">{{ e_salesperson }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-xl-3 col-md-4 col-12">
                                ...
                                <table v-if="ledger_method_detail.length>0">
                                    ...
                                    <tbody v-for="ledger_method_detail1 in ledger_method_detail">
                                        ...
                                        <tr>
                                            <td class="pe-1">Total Balance:</td>
                                            <td><strong>Rs.{{Math.round(ledger_method_detail1.am).toLocaleString()}}</strong></td>
                                        </tr>
                                    </tbody>
                                </table>
                                ...
                                <table v-if="inv_balance.total_value>0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Rs. {{Math.round(inv_balance.total_value).toLocaleString()}}</td>
                                        </tr>
                                        <tr>
                                            <td class="pe-1">Remaining Balance:</td>
                                            <td><strong>Rs.{{Math.round(inv_balance.remaining_value).toLocaleString()}}</strong></td>
                                        </tr>
                                    </tbody>
                                </table>
                                ...
                                <hr v-if="received_detail.length>0">
                                <div v-if="received_detail.length>0">
                                    <h6 class="mb-2" style="font-weight:bold">Received Details:</h6>
                                    <table v-for="received_detail1 in received_detail">
                                        <tbody>
                                            <tr>
                                                <td class="pe-1">ReceivedID:</td>
                                                <td>{{received_detail1.RVNO}}</td>
                                            </tr>
                                            <tr>
                                                <td class="pe-1">Date:</td>
                                                <td>{{received_detail1.Date}}</td>
                                            </tr>


                                            <tr>
                                                <td class="pe-1">Received Amount:</td>
                                                <td>Rs. {{Math.round(received_detail1.Amount).toLocaleString()}}</td>
                                            </tr>
    ...
    this.tax_against='';
      ...
      issue_pv() {
            ...
            this.filterby = this.method_type.split("_");
                if (this.test_remaining==1||this.date == '' || this.amount == '' || this.narration == ''  || this.vendor_name == '' || this.method_type == ''||this.salesperson == ''|| (this.tax_check && this.tax_against=='')) {
                    if (this.vendor_name == '') {
                    ...
                    if (this.salesperson == '') {
                        this.e_salesperson = "Please type Receiver Name";
                    }
                    if(this.tax_check && this.tax_against==''){
                  this.e_tax_against='Select Tax Against'
                   }
                    this.$toastr.e("Please fill required fields!", "Caution!");


                }
   //else if (this.filterby[0]=='101001001001' && this.method_detail_bal < this.amount) {
        //   this.$toastr.e("Your Balance Is Less Than Payment Voucher Amount!", "Caution!");
              //  }

                else {
                 var amount = document.getElementsByName('third[]');
                var remaining = document.getElementsByName('fourth[]');
                var taxes_amount = document.getElementsByName('fifth[]');
...
loop: for (var i = 1; i < this.first.length; i++) {
                            ...
                            if (this.first[i] == '' || this.first[i] == null) {
                                var j = i;
                                this.$toastr.e("Please select Invoice at index " + j + "!", "Error!");
                                return;
                            }
                            var a = this.first[i];
                            k = k + "|" + a;
...
for (var j = 0; j < taxes_amount.length; j++) {
var e = taxes_amount[j];
o = o + "|" + e.value;
}
...
n = n + "|" + d.value;
                    ...
                    axios.post('./accounts/submit_payment_voucher', {
                            date: this.date,
                            ...
                            p_agnst: this.p_agnst,
                            invoices:k,
                            invoice_amount:m,
                            remaining_amount:n,
                            tax_amount:o,
                             tax_totalamount:this.tax_amount,
                            against_invoice:this.against_invoice,
                            salesperson:this.salesperson,
                            tax_against:this.tax_against
                        })
                        .then(data => {
                            if (data.data == "submitted") {
                                this.$toastr.s("Payment Voucher added Successfully", "Congratulations!");
                                this.$router.push({ name: 'purchase_payment_voucher_detail' })
                            }
                            else {
                        ...
                        .catch(error => {
                           if(error.response.data.message=='Payment Voucher Already Exists.'){
    ...
    add_xz_repeater() {
                ...
                axios.get('./accounts/fetch_po_value/' + id + '/' + this.vendor_name)
                    .then(response => {
                        if (response.data == 'notexists') {
                            ...
                            document.getElementById("demo_" + position).value = Math.round(this.inv_balance.remaining_value);
                            ...
                            axios.get('./accounts/fetch_rcvd_details/' + id)
                                .then(response => {
                                    this.received_detail = response.data;
                                })
        ...
        find_against() {
            ...
            this.agnstpo = {};
                this.inv_detail = {};
                this.inv_balance = {};
                axios.get('accounts/fetch_journals_detail/'+this.vendor_name)
                    .then(response => {
                        ...
                        for (var i = 0; i < $this.agnstpo.length; i++) {
                            this.options10.push($this.agnstpo[i].PoCode);
                        }
                    })
            }
            else if (this.p_agnst == 'pi_') {
                this.agnstpo = {};
                axios.get('accounts/fetch_pi_detailpv/' + this.vendor_name)
                    .then(response => {
                        this.agnstpo = response.data
                        this.options9 = [];
                ...
                this.inv_detail = {};
                this.inv_balance = {};
                axios.get('accounts/fetch_po_detail/' + this.vendor_name)
                    .then(response => {
                        this.agnstpo = response.data
                        this.options8 = [];
    ...
    mounted() {
        ...
        axios.get('accounts/fetch_methods')
            ...
            axios.get('accounts/fetch_payable_tax_head')
            .then(response => {
                this.agnsttax = response.data
                this.options3 = [];

                var $this = this;
                for (var i = 0; i < $this.agnsttax.length; i++) {
                    this.options3.push($this.agnsttax[i].ID + '_' + $this.agnsttax[i].AccountName);
                }
            })
