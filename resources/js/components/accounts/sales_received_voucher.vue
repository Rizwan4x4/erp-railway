                ...
                <div class="noprint content-header row">
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <router-link to="../sales/received_voucher_detail" style="text-decoration: none;">Receipt vouchers</router-link>
                            </li>
                                    ...
                                    <div class="card-body invoice-padding pt-0">
                                        <div class="row row-bill-to invoice-spacing" style="margin-top:0px;margin-bottom:0px">
                                            <div class="row" style="margin-top:10px">
                                                <div class="col-md-6">
                                                    <h6 class="invoice-to-title" style="margin-bottom:5px">Received From:</h6>
                                                ...
                                                <div class="col-md-4" v-if="this.filterby[0]!='101001001001'">
                                                ...
                                                <div class="col-md-4" v-if="this.filterby[0]!='101001001001'">
                        <h6 class="invoice-to-title" style="margin-bottom:5px">Bank Instrument:</h6>
                        <div class="invoice-customer">
                         <select class="form-control"  v-model="Bank_name"><option value="">Choose..</option>
                         <option value="Online_Cash">Online_Cash</option>
                          <option value="Al Baraka Bank">Al Baraka Bank</option> <option value="Allied Bank">Allied Bank</option> <option value="Apna Microfinance Bank">Apna Microfinance Bank</option> <option value="Askari Bank">Askari Bank</option> <option value="Bank Al Habib">Bank Al Habib</option> <option value="Bank Alfalah">Bank Alfalah</option> <option value="Bank Islami">Bank Islami</option> <option value="Bank of Punjab">Bank of Punjab</option> <option value="Barclays">Barclays</option> <option value="Burj Bank">Burj Bank</option> <option value="Citibank N.A.">Citibank N.A.</option> <option value="Dubai Islamic Bank">Dubai Islamic Bank</option> <option value="FINCA Microfinance Bank">FINCA Microfinance Bank</option> <option value="Faysal Bank">Faysal Bank</option> <option value="First Women Bank Limited">First Women Bank Limited</option> <option value="First Microfinance Bank">First Microfinance Bank</option> <option value="Habib Bank">Habib Bank</option> <option value="Habib Metropolitan Bank">Habib Metropolitan Bank</option> <option value="ICBC">ICBC</option> <option value="JS Bank">JS Bank</option> <option value="KASB Bank Limited">KASB Bank Limited</option> <option value="MCB">MCB</option> <option value="MIB">MIB</option> <option value="Meezan Bank Limited">Meezan Bank Limited</option> <option value="Mobilink Microfinance Bank LTD">Mobilink Microfinance Bank LTD</option> <option value="NIB">NIB</option> <option value="National Bank of Pakistan">National Bank of Pakistan</option> <option value="Standard Chartered">Standard Chartered</option> <option value="Samba Bank">Samba Bank</option> <option value="Silk Bank">Silk Bank</option> <option value="Sindh Bank">Sindh Bank</option> <option value="Soneri Bank">Soneri Bank</option> <option value="Summit Bank">Summit Bank</option> <option value="Tameer Bank">Tameer Bank</option> <option value="U Microfinance Bank">U Microfinance Bank</option> <option value="United Bank">United Bank</option> <option value="UnCategorized">UnCategorized</option> </select>
                           <span style="color: #db4437; font-size: 11px" v-if="Bank_name == ''">{{ e_Bankname }}</span>
                        </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="mb-1">
                                                        ...
                                                        <div class="row demo-inline-spacing">
                                                            <div class="col-md-4 form-check form-check-inline" style="margin-top:0px">
                                                            ...
                                                            <div class="col-md-3 form-check form-check-inline" style="margin-top:0px">
                                                                ...
                                                                <label class="form-check-label" for="inlineRadio2">Customer Invoice</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                                        ...
                                                                        <div class="col-12 d-flex product-details-border position-relative pe-0">
                                                                            <div class="row w-100 pe-lg-0 pe-1 py-2">
                                                                                ...
                                                                                <div class="col-xl-4 mb-lg-1 col-bill-to ps-0" v-if="p_agnst=='pi_'">
                                                                                    <multiselect style="margin-right: 10px;" @input="search_po_detail(first[count],[count])" v-model="first[count]" :options="options9"> </multiselect>
                                                                                </div>
                                                                            ...
                                                                            <div style="margin-left:10px" class="d-flex flex-column align-items-centerjustify-content-between border-start invoice-product-actions py-50 px-25">
                                                                                <div class="delete_btn" style="border-radius:14px;display:none">
                            ...
                            <div class="col-xl-3 col-md-4 col-12">
                                ...
                                <table v-if="ledger_method_detail.length>0">
                                    ...
                                    <tbody v-for="ledger_method_detail1 in ledger_method_detail">
                                        ...
                                        <tr>
                                            <td class="pe-1">Total Balance:</td>
                                            <td><strong>Rs.{{Number(ledger_method_detail1.am).toLocaleString()}}</strong></td>
                                        </tr>
                                    </tbody>
                                </table>
                                ...
                                <table v-if="inv_balance.total_value>0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><strong>Rs.{{Number(inv_balance.remaining_value).toLocaleString()}}</strong></td>
                                        </tr>
                                    </tbody>
                                </table>
                                    ...
                                    <table v-for="inv_detail1 in inv_detail">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>{{inv_detail1.PVID}}</td>
                                            </tr>
                                            <tr>
                                                <td class="pe-1">Date:</td>
                                                <td>{{inv_detail1.VoucherDate}}</td>
                                            </tr>
                                            <tr>
                                                <td class="pe-1">Method Type:</td>
                                                <td>{{inv_detail1.MethodType}}</td>
                                            </tr>
                                            <tr>
                                                <td class="pe-1">Payment AccountID:</td>
                                                <td>{{inv_detail1.MethodAccountID}}</td>
                                            </tr>
                                            <tr>
...
e_Bankname:'',
    ...
    methods: {
       ...
       // alert(this.Bank_name);
            ...
            if (this.Bank_name==''||this.test_remaining == 1 || this.date == '' || this.amount == '' || this.narration == '' || this.vendor_name == '' || this.method_type == '') {
                if (this.vendor_name == '') {
                ...
                for (var i = 1; i < this.first.length; i++) {
                    var a = this.first[i];
                    k = k + "|" + a;
                }
                ...
                axios.post('./accounts/submit_received_voucher', {
                        date: this.date,
                    ...
                    .then(data => {
                        if (data.data == "submitted") {
                            this.$toastr.s("Received Voucher added Successfully", "Congratulations!");
                ...
                axios.get('./accounts/fetch_po_value/' + id + '/' + this.vendor_name)
                    .then(response => {
                        if (response.data == 'notexists') {
                            ...
                            document.getElementById("demo_" + position).value = this.inv_balance.remaining_value;
