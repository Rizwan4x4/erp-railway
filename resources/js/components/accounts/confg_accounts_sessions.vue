                                    ...
                                    <div class="card-header pb-0">
                                        ...
                                        <div style="text-align: right;width: 32% !important;">
                                            <a v-if="hasPermission('Accounts Configurations  session create new')"
                                                ...
                                                class="btn btn-outline-primary waves-effect" type="button">Create
                                                New</a>
                                            ...
                                            <section id="accordion-with-border">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xl-6 col-lg-6 col-md-6 order-1 order-md-0"
                                                        v-if="hasPermission('Units-Management units-data fetch-data')">
                                                        <div class="top-radius bottom-radius shadow">
                                                        <div class="card border-0">
                                                            <div class="card-header">
                                                                <h2 style="font-size:24px" class="card-title">Transfer
                                                                    Receipt Data</h2>
                                                            </div>
                                                            <div class="card-body">
                                                                <form class="form form-vertical"
                                                                    v-if="hasPermission('Accounts Configurations  session transfer receipt data')">
                                                                    <div class="row">
                                                                        <div class="col-12">
                                                                            <div class="mb-1">
                                                                                <div class="table-responsive">
                                                                        ...
                                                                        <div class="col-12">
                                                                            <button type="button" :disabled="disabled"
                                                                                @click="delay()"
                                                                                class="btn btn-primary bg-primary me-1 waves-effect waves-float waves-light">Submit</button>
                                                                            <button type="reset"
    ...
    methods: {
        ...
        submit_receipt() {
            if (this.receipt_start == '' || this.receipt_end == '') {
                ...
                axios.post('Accounts/update_receipt_data/' + this.receipt_start + '/' + this.receipt_end)
                    .then(response => {
