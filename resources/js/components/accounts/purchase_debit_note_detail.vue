                            ...
                            <div style="margin-bottom:20px;padding-top:20px"
                                ...
                                <div class="col-sm-6 col-lg-6 ps-xl-75 ps-0">
                                    <div class="dt-buttons d-inline-flex mt-50">
                                        <router-link v-if="hasPermission('Accounting debit-notes create-dn')"
                                            style="float:left" to="/purchase/create_debit_notes"
                                            class="btn btn-primary bg-primary waves-effect">New Debit Notes</router-link>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-lg-6 ps-xl-75 ps-0">
                                    <div
                                        ...
                                        <div class="me-1">
                                            <div class="dataTables_filter" style="margin-top:5px">
                                                <label>
                                                    <input autocomplete="off" type="text" style="min-width: 400px;"
                                                        name="keyword1" v-model="keyword1" class="form-control"
                                                        placeholder="Search By Invoice ID/Debit Notes ID/ Vendor Name" />
                                                </label>
                                            </div>
                                        </div>
                                                ...
                                                <div class="d-flex align-items-center col-actions">
                                                    ...
                                                    <div class="dropdown"><a
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <a v-bind:href="`debit_note_letter/${adsdata1.ID}`"
                        ...
                        <div class="modal-content">
                            ...
                            <div class="col-xl-12 col-md-12 col-12">
                                <div class="card invoice-preview-card" v-for="paymentVchrs1 in paymentVchrs">
                                        ...
                                        <div
                                            ...
                                            <div class="mt-md-0 mt-2">
                                                ...
                                                <div class="invoice-date-wrapper row">
                                                    <p class="invoice-date-title" style="width:35%">Total Debit Amount:
                                                    </p>
                                    ...
                                    <div class="divider">
                                        <div class="divider-text" style="font-size: 24px;font-weight: 900;">Debit Note
                                            Detail</div>
                                    </div>
                                                ...
                                                <tr v-for="paymentVchrs_items1 in paymentVchrs_items">
                                                    <td class="py-1">
                                                        <p class="card-text fw-bold mb-25">
                                                            {{ paymentVchrs_items1.ItemName }}</p>

                                                    </td>
                                                    <td class="py-1">
                                                        <span
                                                            class="fw-bold">{{ Number(paymentVchrs_items1.SubTotal).toLocaleString() }}</span>
                                                    </td>
                                                    <td class="py-1">
                                                        <span
                                                            class="fw-bold">{{ Number(paymentVchrs_items1.DebitAmount) }}</span>
                                                    </td>
                                                    <td class="py-1">
                                                        <p class="card-text fw-bold mb-25">
                                                            {{ paymentVchrs_items1.Detail }}</p>
