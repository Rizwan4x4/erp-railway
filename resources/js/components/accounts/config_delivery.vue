                                ...
                                <div class="card top-radius bottom-radius border-0">
                                    <div class="card-header top-radius">
                                        ...
                                        <div style="text-align: right; width: 32% !important">
                                            <a v-if="hasPermission('Accounting procurement-configuration create-Delivery')"
                                                                                        ...
                                                                                        <div class="btn-group">
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                <a v-if="adsdata1.Status == 'true'"
                                                                                                    @click="changeStatus(adsdata1.DID, '0')"
                                                                                                    class="dropdown-item">
                                                                                                    <i
                                                                                                ...
                                                                                                <a v-else
                                                                                                    @click="changeStatus(adsdata1.DID, 'true')"
                                                                                                    class="dropdown-item">
                                                                                                    <i
                                                                                                        class="fa-brands fa-creative-commons-sa"></i>
                                                                                                    Active
                    ...
                    <div class="modal-body px-sm-5 mx-50 pb-5">
                        <form id="addNewCardValidation" class="row gy-1 gx-2 mt-75" onsubmit="return false">
                            ...
                            <div class="col-md-6 col-12" v-if="this.tax_computation == 'Fixed'">
                                ...
                                <input type="number" placeholder="Type Fixed Value of Delivery" v-model="tax_amount"
                                    class="form-control" style="" />
                            ...
                            <div class="col-md-6 col-12" v-if="this.tax_computation == 'Percentage'">
                                <label class="form-label" for="modalAddCardName">Amount</label>
                                <input type="number" v-model="tax_amount"
                                    placeholder="Type Percentage Value of Delivery" class="form-control" style="" />
                                <span style="color: #db4437; font-size: 11px" v-if="Amount_error != ''">{{ Amount_error
                                    }}</span>
                            </div>
                            <div class="col-md-6 col-12">
