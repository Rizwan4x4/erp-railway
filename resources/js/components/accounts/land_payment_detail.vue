                                ...
                                <div class="card top-radius bottom-radius border-0">
                                    <div class="card-header">
                                        ...
                                        <div style="text-align: right; width: 50% !important">
                                            <router-link style="float: left" to="/accounts/seller_detail"
                                                class="btn btn-primary bg-primary waves-effect"
                                                v-if="hasPermission('Units-Management units-data supervision')"
                                                type="button">Seller Detail</router-link>
                                            <router-link to="/accounts/add_land_record"
                                                style="float: left;margin-left:20px !important"
                                                v-if="hasPermission('Units-Management units-data supervision')"
                                                class="btn btn-primary bg-primary waves-effect" type="button">Add Land
                                                Record</router-link>
                                            <div class="" style="float: right">
                                                <div style="">
                                                    <label>
                                                        <input autocomplete="off" type="text" name="keyword1"
                                                            v-model="keyword1" @change="search_by_name()"
                                                                        ...
                                                                        <table class="table table-hover">
                                                                            <thead>
                                                                                <tr>
                                                                                    ...
                                                                                    <th
                                                                                        class="reports-th-center d-flex">
                                                                                        <div
                                                                                            class="col-md-1  mb-3  mx-1">
                                                                                            Deal No. </div>
                                                                                        <div
                                                                                            class="col-md-2  mb-3  mx-1">
                                                                                            Seller Name</div>
                                                                                        <div
                                                                                            class="col-md-2  mb-3  mx-1">
                                                                                            Area Bought </div>
                                                                                        ...
                                                                                        <div
                                                                                            class="col-md-2  mb-3  mx-1">
                                                                                            Additional<br />Charges
                                                                                        </div>
                                                                                        <div
                                                                                            class="col-md-1  mb-3  mx-1">
                                                                                            Status</div>
                                                                                        <div class="col-md-1  mb-3  mx-1"
                                                                                            v-if="hasPermission('Units-Management units-data supervision')">
                                                                                            Action </div>
                                                                                    </th>
                                                                                    ...
                                                                                    <div class="accordion accordion-border"
                                                                                        ...
                                                                                        <div class="accordion-item"
                                                                                            ...
                                                                                            <div class="accordion-header  d-flex"
                                                                                                :id="'headingBorder' + adsdata1.ID">

                                                                                                <div
                                                                                                    class="col-md-1  mb-3 position-relative mx-1 sorting_1">
                                                                                                    <a class="fw-bold">
                                                                                                        {{ adsdata1.DealNo }}</a>
                                                                                                </div>
                                                                                                <div
                                                                                                    class="col-md-2  mb-3 position-relative mx-1">
                                                                                                    {{ adsdata1.SellerName }}
                                                                                                </div>
                                                                                                <div
                                                                                                    class="col-md-2  mb-3 position-relative mx-1">
                                                                                                    {{ Number(adsdata1.TotalArea).toLocaleString() }}
                                                                                                </div>
                                                                                                <div
                                                                                                    class="col-md-2  mb-3 position-relative mx-1">
                                                                                                    <h6
                                                                                                        class="user-name text-truncate mb-0">
                                                                                                        {{ Number(adsdata1.TotalPrice).toLocaleString() }}
                                                                                                    </h6><small
                                                                                                        class="text-truncate text-muted">{{ Number(adsdata1.AcrePrice).toLocaleString() }}</small>

                                                                                                </div>
                                                                                                <div
                                                                                                    class="col-md-2  mb-3 position-relative mx-1">
                                                                                                    {{ Number(adsdata1.AdditionalCharges).toLocaleString() }}
                                                                                                </div>
                                                                                                <div
                                                                                                    class="col-md-1  mb-3 position-relative mx-1">

                                                                                                    <span
                                                                                                        v-if="adsdata1.Status == 'Verified'"
                                                                                                        class="badge bg-light-success">{{ adsdata1.Status }}</span>
                                                                                                    <span
                                                                                                        v-else-if="adsdata1.Status == 'Pending'"
                                                                                                        @click="editgrn2(adsdata1.ID)"
                                                                                                        data-bs-toggle="modal"
                                                                                                        data-bs-target="#PREQ_status2"
                                                                                                        class="badge bg-light-primary">{{ adsdata1.Status }}</span>


                                                                                                </div>
                                                                                                <a v-if="adsdata1.Status == 'Verified'"
                                                                                                    target="_blank"
                                                                                                    v-bind:href="`Accounts/land_paymentdetail_letter/${adsdata1.ID}`"
                                                                                                    class="btn btn-sm">
                                                                                                    <i
                                                                                                ...
                                                                                                <div
                                                                                                    class="col-md-1  mb-3 position-relative mx-1">
                                                                                                    <a class=" collapsed mx-1"
                                                                                                        @click="editReq(adsdata1.ID)"
                                                                                                    ...
                                                                                                    <div class="btn-group"
                                                                                                        ...
                                                                                                        <a v-if="adsdata1.Status == 'Verified'"
                                                                                                            ...
                                                                                                            class="btn btn-sm dropdown-toggle hide-arrow"><svg
                                                                                                                ...
                                                                                                                class="feather feather-more-vertical font-small-4 mb-2">
                                                                                                                <circle
                                                                                                                    cx="12"
                                                                                                                    cy="12"
                                                                                                                    r="1">
                                                                                                        ...
                                                                                                        <div
                                                                                                            ...
                                                                                                            <a @click="fetch_pcashid(adsdata1.ID)"
                                                                                                                data-bs-toggle="modal"
                                                                                                                data-bs-target="#apprfinance"
                                                                                                                class="dropdown-item"
                                                                                                                v-if="adsdata1.Status == 'Verified' && adsdata1.Remaining != 0">
                                                                                                                <i
                                                                                                                    class="fa-brands fa-amazon-pay"></i>
                                                                                                                Pay
                                                                                                            </a>
                                                                                                            <a target="_blank"
                                                                                                                v-if="adsdata1.PaidAmount != 0"
                                                                                                                v-bind:href="`Accounts/landpayment_pvletter/${adsdata1.ID}`"
                                                                                                                class="btn ">
                                                                                                                <i
                                                                                                                    class="fa-solid fa-print"></i>
                                                                                                                Print
                                                                                            ...
                                                                                            <div :id="'accordionBorder' + adsdata1.ID"
                                                                                                ...
                                                                                                :data-bs-parent="'#accordionBorder' + adsdata1.ID">
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <table
                                                                                                        ...
                                                                                                        <tbody>
                                                                                                            <tr
                                                                                                                v-for="get_regqdata11 in get_reqdata1">
                                                                                                                <td
                                                                                                                    class="td-center py-1">
                                                                                                                    <p
                                                                                                                        class="card-text fw-bold mb-25">
                                                                                                                        {{ get_regqdata11.InstallmentDate }}
                                                                                                                    </p>
                                                                                                                    <p
                                                                                                                ...
                                                                                                                <td
                                                                                                                    class="td-center py-1">
                                                                                                                    <span
                                                                                                                        class="fw-bold">{{ Number(get_regqdata11.InstallmentAmount).toLocaleString() }}</span>
                                                                                                                </td>
                                                                                                                <td
                                                                                                                    class="td-center py-1">
                                                                                                                    <span
                                                                                                                        v-if="get_regqdata11.istatus == 'paid'"
                                                                                                                        class="badge bg-light-success">{{ get_regqdata11.istatus }}</span>
                                                                                                                    <span
                                                                                                                        v-else-if="get_regqdata11.istatus == 'partial'"
                                                                                                                        class="badge bg-light-info">{{ get_regqdata11.istatus }}</span>
                                                                                                                    <span
                                                                                                                        v-else-if="get_regqdata11.istatus == 'Pending'"
                                                                                                                        class="badge bg-light-primary">{{ get_regqdata11.istatus }}</span>
                ...
                <div class="modal-content">
                    ...
                    <div class="col-xl-12 col-md-12 col-12">
                        <div class="card invoice-preview-card" v-for="get_grndata8111 in get_grndata81">
                                    ...
                                    <div class="mt-md-0 mt-2" style="min-width:25%">
                                        ...
                                        <div class="invoice-date-wrapper row">
                                            ...
                                            <p style="width:65%" class="invoice-date">
                                                ...
                                                <span v-if="get_grndata8111.Status == 'Pending'"
                                                    class="badge badge-glow bg-warning">Pending</span>
                            ...
                            <div class="divider">
                                <div class="divider-text" style="font-size: 24px;font-weight: 900;">Update Land
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr v-for="get_grndata711 in get_grndata7">
                                            <td class="py-1">
                                                <p class="card-text fw-bold mb-25">{{ get_grndata711.InstallmentDate }}
                                                </p>
                                            </td>
                                            <td class="py-1">
                                ...
                                <div class="row">
                                    <div class="col-md-12 d-flex justify-content-end order-md-2 order-1">
                                        <p class="card-text mb-0" style="width:100%">
                                            <span style="width:100%" class="fw-bold">Additional Charges:
                                                {{ Number(get_grndata8111.AdditionalCharges).toLocaleString() }}</span>
                                        </p>

                                        <br>
                                        <p class="card-text mb-0" style="width:100%">
                                            <span style="width:100%" class="fw-bold">Per Acre:
                                                {{ Number(get_grndata8111.AcrePrice).toLocaleString() }}</span>
                                        </p>

                                        <br>
                                        <p class="card-text mb-0" style="width:100%">
                                            <span class="fw-bold">Total Amount:
                                                {{ Number(get_grndata8111.TotalPrice).toLocaleString() }}</span>
                                        </p>
                    ...
                    <div class="modal-body pb-5 px-sm-5 pt-50">
                        <div class="mb-2">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="invoice-customer">
                                        <multiselect style="margin-right: 10px;" v-model="method_type"
                                            :options="options2"> </multiselect>
                                        <span style="color: #db4437; font-size: 11px" v-if="method_type == ''">{{
                                            e_method_type }}</span>
                                    </div>
                                    <div>
                                    </div>
                                ...
                                <div class="col-md-6" v-if="this.method_type != '101001001001_Cash in Hand'">
                                    ...
                                    <div class="invoice-customer">
                                        ...
                                        <input v-model="chq_date" type="date" id="modalAddCardName"
                                            class="form-control" />
                                    </div>
                                    <div>
                                    </div>
                                ...
                                <div class="col-md-6" v-if="this.method_type != '101001001001_Cash in Hand'">
                                    ...
                                    <div class="invoice-customer">
                                        <label class="form-label" for="modalAddCardNumber">Chq Number</label><input
                                            v-model="chq_number" type="number" id="modalAddCardName"
                                            class="form-control" />
                                    </div>
                                    <div>
                            ...
                            <div class="text-center" style="text-align:center">
                                <button type="button" :disabled="disabled3" @click="delay3()"
