                    ...
                    <section class="invoice-add-wrapper">
                        <div class="row invoice-add">
                                    ...
                                    <div class="card-body invoice-padding invoice-product-details">
                                                                    ...
                                                                    <div class="row w-100 pe-lg-0 pe-1 py-2">
                                                                        <div class="col-lg-8 col-12 mb-lg-0 mb-2 mt-lg-0 mt-2">
                                                                            <multiselect style="margin-right: 10px;"
                                                                                         v-model="first[count]" :options="options">
                                                                            </multiselect>
                                                                        </div>
                                                                        <div class="col-lg-2 col-12 mt-lg-0 mt-2">
                                                                            <input style="min-height:40px" type="number" step="0.01" class="form-control" value="0" name="third[]" v-on:focus ="handleFocus($event)" v-on:focusout="handleFocusOut($event)" @change="sum_total()" />
                                                                        </div>
                                                                        <div class="col-lg-2 col-12 my-lg-0 my-2">

                                                                            <input type="number" style="min-height:40px" step="0.01" class="form-control" value="0" name="fourth[]" v-on:focus="handleFocus1($event)" v-on:focusout="handleFocusOut1($event)" @change="sum_total()" />
                                                                        </div>
                                        ...
                                        <div class="row" style="position:relative !important;">
                                            ...
                                            <div class="col-lg-2 col-12 mt-lg-0 mt-2" style="margin-left:6%">
                                                <input type="number" readonly step="0.01" v-model="cre_sum" class="form-control" value="0"    />
                                            </div>
                                            <div class="col-lg-2 col-12 my-lg-0 my-2">
                                                <input type="number" readonly step="0.01" class="form-control" value="0" v-model="deb_sum" />
                                            </div>
                            ...
                            <div class="col-xl-3 col-md-4 col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <button class="btn btn-primary bg-primary w-100 mb-75" @click="delay()">Post </button>
    ...
    handleEmpty(){
           ...
           for (var h = 0; h < fourth.length; h++) {
            ...
            issue_jv() {
                this.handleEmpty();
                if (this.empty){
                 this.$toastr.e('Please fill all credit/debit fields', 'Error');
               return;
               }

                if (this.cre_sum != this.deb_sum) {
              return this.$toastr.e("Credit Value And Debit Value Not Equal", "Caution!");
                }
                else {
                    ...
                    axios.post('./accounts/insert_jv', {
                        ...
                        .then(res => {
                            if (res.data.data == "submitted") {
                                this.$toastr.s("New Journal Voucher added Successfully", "Congratulations!");
                                this.$router.push({ name: 'accounting_jv_detail' })
                            }
                            else{
                                this.$toastr.e(res.data.data, "Catuion!");
                            }
                        })
                        .catch(error=>{
                                console.log(error.response);
                            this.$toastr.e("Error creating JV!", "Error!");
                            });
                }
            },
            sum_total() {
