                ...
                <div class="content-header row">
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Taxes Detail</li>
                        </ol>
                    </div>
                </div>
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 order-1 order-md-0">
                                ...
                                <div class="card top-radius bottom-radius border-0">
                                    <div class="card-header">
                                        <h4 class="card-title">Taxes Detail</h4>
                                        <div style="text-align: right; width: 32% !important">
                                            <a v-if="hasPermission('Accounts Configurations  create-tax')"
                                                                                    ...
                                                                                    <td style="text-align: center; border-right: 1px solid lightgrey;">
                                                                                        <div class="btn-group">
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                <a v-if="adsdata1.Status == 'true'"
                                                                                                    @click="changeStatus(adsdata1.TaxID, '0')"
                                                                                                    class="dropdown-item">
                                                                                                    <i
                                                                                                ...
                                                                                                <a v-else
                                                                                                    @click="changeStatus(adsdata1.TaxID, 'true')"
                                                                                                    class="dropdown-item">
                                                                                                    <i
                                                                                                        class="fa-brands fa-creative-commons-sa"></i>
                                                                                                    Active
                    ...
                    <div class="modal-body px-sm-5 mx-50 pb-5">
                        <form id="addNewCardValidation" class="row gy-1 gx-2 mt-75" onsubmit="return false">
                            <div class="col-md-6 col-12">
                                <label class="form-label" for="modalAddCardName">Tax Name</label>
                                <input type="text" v-model="tax_name" class="form-control" style="" />
                                <span style="color: #db4437; font-size: 11px" v-if="tax_name == ''">{{ tax_name_error
                                    }}</span>
                            </div>
                            <div class="col-md-6 col-12">
                                <label class="form-label" for="modalAddCardName">Tax Type</label>
                                <select class="form-select" v-model="tax_type">
                                    <option value="Sales">Sales</option>
                                    <option value="Purchase">Purchase</option>
                                    <option value="Purchase">Both</option>
                                </select>
                                <span style="color: #db4437; font-size: 11px" v-if="tax_type == ''">{{ tax_type_error
                                    }}</span>
                            </div>
                            <div class="col-md-6 col-12">
                                <label class="form-label" for="modalAddCardName">Tax Computation</label>
                                <select class="form-select" v-model="tax_computation">
                                    <option value="Fixed">Fixed</option>
                                    <option value="Percentage">Percentage of Price</option>
                                </select>
                                <span style="color: #db4437; font-size: 11px" v-if="tax_computation == ''">{{
                                    tax_computation_error }}</span>
                            </div>
                            <div class="col-md-6 col-12" v-if="this.tax_computation == 'Fixed'">
                                <label class="form-label" for="modalAddCardName">Amount</label>
                                <input type="number" placeholder="Type Fixed Value of Tax" v-model="tax_amount"
                                    class="form-control" style="" />
                                <span style="color: #db4437; font-size: 11px" v-if="Amount_error != ''">{{ Amount_error
                                    }}</span>
                            </div>
                            <div class="col-md-6 col-12" v-if="this.tax_computation == 'Percentage'">
                                <label class="form-label" for="modalAddCardName">Amount</label>
                                <input type="number" v-model="tax_amount" placeholder="Type Percentage Value of Tax"
                                    class="form-control" style="" />
                                <span style="color: #db4437; font-size: 11px" v-if="Amount_error != ''">{{ Amount_error
                                    }}</span>
                            </div>
                            <div class="col-md-6 col-12">
                                ...
                                <div style="margin-bottom: 10px; margin-top: 5px"
                                    ...
                                    <input style="width: 50px" type="checkbox" v-model="tax_status"
...
export default {
    ...
    methods: {
        ...
        changeStatus(id, sts) {
            axios.post('./accounts/accounts_update_taxes_status', {
                id: id,
                status: sts,
            })
                .then(data => {
        ...
        submit_taxes() {
            ...
            if (this.tax_name == "" || this.tax_amount == 0) {
                ...
                axios.post('./accounts/submit_tax', {
                    ...
                    .then(data => {
                        if (data.data == "Tax added successfully") {
                            this.$toastr.s("Tax Added Successfully", "Congratulations!");
                            ...
                            this.$toastr.e("Tax already exists!", "Caution!");
                        }
        ...
        getResult(page = 1) {
            axios
                .get("accounts/taxes_detail/?page=" + page)
