...
<a v-if="hasPermission('Accounts Configurations  create-tax')" style="float: left" data-bs-toggle="modal" data-bs-target="#addNewCard" class="btn btn-outline-primary waves-effect" type="button">Create New</a>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <tr class="odd" v-for="adsdata1 in adsdata.data">
                                        <td><span class="badge  rounded-pill badge-light-primary">{{adsdata1.TaxName}}</span></td>
                                        <td>{{adsdata1.TaxType}}</td>
                                        <td>{{adsdata1.TaxComputation}}</td>
                                        <td v-if="adsdata1.TaxComputation=='Percentage'">{{adsdata1.TaxAmount}}%</td>
                                        <td v-else> Rs.{{adsdata1.TaxAmount}}</td>
                                        <td>
                                      ...
                                      <div class="dropdown-menu dropdown-menu-end">
                                          ...
                                          <a v-if="adsdata1.Status=='true'" @click="changeStatus(adsdata1.TaxID, '0')" class="dropdown-item">
                                              <i class="fa-brands fa-creative-commons-sa"></i>
                                              Disable
                                          </a>
                                          <a v-else @click="changeStatus(adsdata1.TaxID, 'true')" class="dropdown-item">
                                              <i class="fa-brands fa-creative-commons-sa"></i>
                                              Active
                                          </a>
                                      </div>
...
<input type="number" placeholder="Type Fixed Value of Tax" v-model="tax_amount" class="form-control" style="" />
