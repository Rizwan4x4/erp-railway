            ...
            <div class="content-wrapper container-xxl p-0">
                ...
                <div class="content-body">
                    <section class="app-user-view-account">
                        <div class="row">
                            <!-- User Sidebar -->
                            <div v-if="hasPermission('Inventory Product-Categories create-category')"
                                class="col-xl-5 col-lg-5 col-md-5 order-1 col-12 order-md-0">
                                <!-- User Card -->
                                <div class="card top-radius bottom-radius border-0">
                                    <div class="card-header top-riadus">
                                                            ...
                                                            <form id="addNewCardValidation" class="row gy-1 gx-2 mt-75"
                                                                ...
                                                                <div class="col-12">
                                                                    <label class="form-label"
                                                                        for="modalAddCardName">Category
                                                                        Name</label>
                                                                    <input autocomplete="off" v-model="cateogory_name"
                                                                ...
                                                                <div class="col-12">
                                                                    <label class="form-label"
                                                                        for="modalAddCardName">Category
                                                                        Code</label>
                                                                    <input autocomplete="off" v-model="shortcode"
                                                                        class="form-control" style=""
                                                                        placeholder="Type Short Code Here i.e AE" />
                                                                    <span style="color: #db4437; font-size: 11px"
                                                                        v-if="shortcode == ''">{{
                                                                            shortcode_error }}</span>
                                                                </div>
                                                                <div class="col-12">
                                                                    <label class="form-label"
                                                                        for="modalAddCardName">Opening
                                                                        Date</label>
                                                                    <input autocomplete="off" type="date"
                                                                        v-model="opening_date" class="form-control"
                                                                        style="" placeholder="Opening Date Here" />
                                                                    <span style="color: #db4437; font-size: 11px"
                                                                        v-if="opening_date == ''">{{
                                                                            e_opening_date }}</span>
                                                                </div>
                                                                <div class="col-12">
                                                                    <label class="form-label"
                                                                        for="modalAddCardName">Closing
                                                                        Date</label>
                                                                    <input autocomplete="off" type="month"
                                                                        v-model="closing_date" class="form-control"
                                                                        style="" placeholder="Closing Date Here" />
                                                                    <span style="color: #db4437; font-size: 11px"
                                                                        v-if="closing_date == ''">{{
                                                                            e_closing_date }}</span>
                                                                </div>
                                                                <div class="col-12">
                                                                    <label class="form-label"
                                                                        for="modalAddCardName">Description</label>
                                                                        ...
                                                                        <div class="demo-inline-spacing">
                                                                            <div class="form-check form-check-inline"
                                                                                ...
                                                                                <input class="form-check-input"
                                                                                    type="radio" v-model="c_type"
                                                                                    name="inlineRadioOptions"
                                                                                    id="inlineRadio1" value="Goods">
                                                                                <label class="form-check-label"
                                                                                    for="inlineRadio1">Goods</label>
                                                                            </div>
                                                                            <div class="form-check form-check-inline"
                                                                                style="margin-top:0px">
                                                                                <input class="form-check-input"
                                                                                    type="radio" v-model="c_type"
                                                                                    name="inlineRadioOptions"
                                                                                    id="inlineRadio2" value="Assets">
                                                                                <label class="form-check-label"
                                                                                    for="inlineRadio2">Assets</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                ...
                                                <div style="">
                                                    <label>
                                                        <input autocomplete="off" id="name" type="text" name="name"
                                                            v-model="name" class="form-control" @change="getByName()"
