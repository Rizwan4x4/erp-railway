                    ...
                    <section class="app-user-list">
                        <div class="card top-radius bottom-radius border-0">
                            <div
                                ...
                                <div class="col-sm-9 col-lg-10 ps-xl-75 ps-0">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-2 col-12">
                                                <label class="form-label"><img class="px-1" :src="images.solar_filter_linear" alt="icon">Date From <span
                                                        style="color: #DB4437; font-size: 11px;">*</span></label>
                                                <input style="width: 115%;" type="date" v-model="datefrom"
                                                    class="form-control">
                                            </div>
                                            <div class="col-md-2 col-12">
                                                <label class="form-label"><img class="px-1" :src="images.solar_filter_linear" alt="icon">Date To <span
                                                        style="color: #DB4437; font-size: 11px;">*</span></label>
                                ...
                                <div class="col-sm-3 col-lg-2 ps-xl-75 ps-0">
                                    <div class="dt-buttons d-inline-flex mt-50">
                                        <router-link v-if="hasPermission('Accounting Payment-voucher pdc')"
                                            to="/accounting/PdcPayable" class="btn btn-primary bg-primary waves-effect">PDC
                                            Payables</router-link>
                                    </div>
                                    <div class="dt-buttons d-inline-flex mt-50">
                                        <router-link v-if="hasPermission('Accounting Payment-voucher create-pv')"
                                            to="/purchase/create_payment_voucher" class="btn btn-primary bg-primary waves-effect">+
                                            New P. Voucher</router-link>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <tr v-for="adsdata1 in adsdata.data">
                                            ...
                                            <td style="text-align: center; border-right: 1px solid lightgrey;" class="td-center">
                                                ...
                                                <span @click="editPV(adsdata1.PaymentVoucherID)" data-bs-toggle="modal"
                                                    data-bs-target="#viewPV2" v-else-if="adsdata1.Status == 'Pending'"
                                            ...
                                            <td style="text-align: center; border-right: 1px solid lightgrey;" class="td-center">
                                                <div class="d-flex align-items-center col-actions">
                                                    ...
                                                    <div class="dropdown">
                                                        <a v-if="hasPermission('Accounting Payment-voucher actions')"
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <a v-bind:href="`payment_letter/${adsdata1.PaymentVoucherID}/${adsdata1.PVID}`"
                                                                target="__blank" class="dropdown-item">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                    height="24" viewBox="0 0 24 24" fill="none"
                                                                    stroke="currentColor" stroke-width="2"
                                                                    stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <div style="text-align:center;padding-top:20px">
                                <pagination :limit="limit" :data="adsdata" v-if="pageN == 1"
                                    @pagination-change-page="filtered_GRN"></pagination>
                                <pagination :limit="limit" :data="adsdata" v-else-if="pageN == 2"
                                    @pagination-change-page="getResults"></pagination>
                                <pagination :limit="limit" :data="adsdata" v-else-if="pageN == 3"
                ...
                <div class="modal-content">
                    ...
                    <div class="col-xl-12 col-md-12 col-12">
                        <div class="card invoice-preview-card" v-for="paymentVchrs1 in paymentVchrs">
                                    ...
                                    <div class="mt-md-0 mt-2" style="min-width:30%">
                                        ...
                                        <div class="invoice-date-wrapper row">
                                            ...
                                            <p style="width:65%" class="invoice-date">
                                                <span v-if="paymentVchrs1.Status == 'Approved'"
                                                    class="badge badge-glow bg-primary">Approved</span>

                                                <span v-if="paymentVchrs1.Status == 'Pending'"
                            ...
                            <div class="divider">
                                <div class="divider-text" style="font-size: 24px;font-weight: 900;">Payment Voucher
                                </div>
                            </div>
