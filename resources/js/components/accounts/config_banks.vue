                                ...
                                <div class="card top-radius bottom-radius border-0">
                                    <div class="card-header">
                                        ...
                                        <div style="text-align: right; width: 32% !important">
                                            <a v-if="hasPermission('Accounts Configurations  create-bank')"
                                                                        ...
                                                                        <table class="table table-hover">
                                                                            ...
                                                                            <tbody>
                                                                                <tr class="odd"
                                                                                    ...
                                                                                    <td><span
                                                                                            class="badge  rounded-pill badge-light-primary">{{ adsdata1.AccountTitle }}</span>
                                                                                    </td>
                                                                                    ...
                                                                                    <td>
                                                                                        <div class="btn-group">
                                                                                            <a v-if="hasPermission('Accounts Configurations  bank-details actions')"
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                <a v-if="adsdata1.Status == 'true'"
                                                                                                    @click="changeStatus(adsdata1.BankID, '0')"
                                                                                                    class="dropdown-item">
                                                                                                    <i
                                                                                                ...
                                                                                                <a v-else
                                                                                                    @click="changeStatus(adsdata1.BankID, 'true')"
                                                                                                    class="dropdown-item">
                                                                                                    <i
                                                                                                        class="fa-brands fa-creative-commons-sa"></i>
                                                                                                    Active
                    ...
                    <div class="modal-body px-sm-5 mx-50 pb-5">
                        <form id="addNewCardValidation" class="row gy-1 gx-2 mt-75" onsubmit="return false">
                            <div class="col-md-6 col-12">
                                ...
                                <span style="color: #db4437; font-size: 11px" v-if="bank_name == ''">{{ bank_name_error
                                    }}</span>
                            </div>
                            <div class="col-md-6 col-12">
                                ...
                                <span style="color: #db4437; font-size: 11px" v-if="bank_type == ''">{{ bank_type_error
                                    }}</span>
                            </div>
                            <div class="col-md-6 col-12">
                                ...
                                <span style="color: #db4437; font-size: 11px" v-if="bank_branch == ''">{{
                                    bank_branch_error }}</span>
                            </div>
                            <div class="col-md-6 col-12">
                                <label class="form-label" for="modalAddCardName">Account Title</label>
                                <input type="text" placeholder="" v-model="account_name" class="form-control"
                                    style="" />
                                <span style="color: #db4437; font-size: 11px" v-if="account_name == ''">{{
                                    account_name_error }}</span>
                            </div>
                            <div class="col-md-6 col-12">
                                <label class="form-label" for="modalAddCardName">Account Number</label>
                                <input type="text" v-model="account_number" placeholder="" class="form-control"
                                    style="" />
                                <span style="color: #db4437; font-size: 11px" v-if="account_number == ''">{{
                                    account_number_error }}</span>
                                ...
                                <div class="invoice-customer">
                                    ...
                                    <multiselect style="margin-right: 10px; font-size: 12px;" id="FilterTransaction"
                                        :show-labels="false" v-model="p_account_idname" :options="options2">
                                    </multiselect>
                                </div>

                                <span style="color: #db4437; font-size: 11px" v-if="p_account_idname == ''">{{
                                    p_account_idname_error }}</span>
                            </div>
                            ...
                            <div class="col-md-6 col-12">
                                ...
                                <div style="margin-bottom: 10px; margin-top: 5px"
                                    ...
                                    <input style="width: 50px" type="checkbox" v-model="bank_status"
