                ...
                <div class="content-header row">
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Units Credit/Debit Receivable
                            </li>
                        </ol>
                    </div>
                </div>
                                        ...
                                        <tr class="odd" v-for="adsdata1 in adsdata">
                                           <td class=" control" tabindex="0" style="display: none;"></td>
                                            ...
                                            <td>
                                                ...
                                                <input style="margin-top: 10px;margin-left: 5px;" class="form-check-input" type="checkbox" v-if="toggle" @change="sum_total(adsdata1.Amount,adsdata1.DbtID)"
                                                           name="second[]"
                                                           :id="('inlineRadio1'+adsdata1.DbtID)" checked />
                                                    <input style="margin-top: 10px;margin-left: 5px;" v-else class="form-check-input" type="checkbox" @change="sum_total(adsdata1.Amount,adsdata1.DbtID)"
                                                           name="second[]"
                                                           :id="('inlineRadio1'+adsdata1.DbtID)" />
                                                </div>
                                            </td>
                                        </tr>
                                    </tbody>
   ...
   toggling() {
    this.toggle = !this.toggle;
       ...
       var k = 'zero';
        ...
        getResult() {
            axios.get('accounts/pending_debt_detail/'+this.dated)
