                ...
                <div class="content-body">
                    ...
                    <section class="app-user-list">
                        <div class="card top-radius bottom-radius border-0">
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 col-12 mb-3">
                                                <label>
                                                    <input style="margin-top: 27px !important;" autocomplete="off"
                                                        type="text" name="keyword1" v-model="keyword1"
                                                        class="form-control" placeholder="Search By Name / Po / RVID" />
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="d-flex align-items-center col-actions">
                                                    ...
                                                    <div class="dropdown"><a
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <a v-bind:href="`received_letter/${adsdata1.ReceivedVoucherID}/${adsdata1.RVID}`"
                            ...
                            <div
                                style="text-align:center;padding-top:20px; display: flex; justify-content: center; align-items: center;">
                                <pagination :limit="limit" :data="adsdata" v-if="pageNo == 1"
                                    @pagination-change-page="getResult"></pagination>
                                <pagination :limit="limit" :data="adsdata" v-else-if="pageNo == 2"
                                    @pagination-change-page="filtered_GRN"></pagination>
                                <pagination :limit="limit" :data="adsdata" v-else-if="pageNo == 3"
                ...
                <div class="modal-content">
                    ...
                    <div class="col-xl-12 col-md-12 col-12">
                        <div class="card invoice-preview-card" v-for="rcVouchers1 in rcVouchers">
                            ...
                            <div class="divider">
                                <div class="divider-text" style="font-size: 24px;font-weight: 900;">Received Voucher
                                </div>
                            </div>
