                                ...
                                <div class="card top-radius bottom-radius border-0">
                                    <div class="card-header top-radius">
                                        ...
                                        <div style="text-align: right; width: 32% !important">
                                            <a v-if="hasPermission('Accounting pettycash_access create-pettyaccess')"
                                                style="float: left" data-bs-toggle="modal" data-bs-target="#addNewCard"
                                                class="btn btn-primary bg-primary waves-effect">Create New</a>
                                                                                ...
                                                                                <tr class="odd"
                                                                                    ...
                                                                                    <td style="text-align: center; border-right: 1px solid lightgrey;"
                                                                                        ...
                                                                                        <a @click="fetch_pcashid(adsdata1.ID, adsdata1.Name)"
                                                                                            ...
                                                                                            data-bs-target="#edit_Pcash_access"
                                                                                            class=""><i
...
">
        ...
        <div class="modal fade" id="edit_Pcash_access" tabindex="-1" aria-labelledby="addNewCardTitle"
            aria-hidden="true">
                    ...
                    <div class="modal-body px-sm-5 mx-50 pb-5">
                        <div id="addNewCardValidation" class="row gy-1 gx-2 mt-75">
                            ...
                            <div class="invoice-customer">
                                ...
                                <multiselect style="margin-right: 10px; font-size: 12px;" v-model="account_id"
                                    :options="options" id="FilterTransaction" :show-labels="false">
                                </multiselect>
                                <span style="color: #db4437; font-size: 11px" v-if="account_id == ''">{{ e_account_id
                                    }}</span>
                            </div>
                            <div class="invoice-customer">
                                <label class="form-label" for="modalAddCardName">Link COA ID</label>
                                <multiselect style="margin-right: 10px; font-size: 12px;" v-model="coa_id"
                                    :options="options2">
                                </multiselect>
                                <span style="color: #db4437; font-size: 11px" v-if="coa_id == ''">{{ e_coa_id }}</span>
                                <label hidden
                                    v-if="edit_name != '' && account_id != '' && coa_id != ''">{{ close_model1='modal' }}</label>
                            </div>
                            <div class="col-12 text-center">
                                <button type="submit" :disabled="disabled1" @click="delay1()"
                                    class="btn btn-primary bg-primary me-1 mt-1" :data-bs-dismiss='close_model1'
                    ...
                    <div class="modal-body px-sm-5 mx-50 pb-5">
                        <form id="addNewCardValidation" class="row gy-1 gx-2 mt-75" onsubmit="return false">
                            <div class="col-md-6 col-12">
                                <label class="form-label" for="modalAddCardName">Employee Name</label>
                                <input type="text" readonly v-model="emp_name"
                                    placeholder="Please select employee code to get name" class="form-control"
                                    style="" />
                            </div>
                            <div class="col-md-6 col-12">
                                <label class="form-label" for="modalAddCardName">Employee Code<span
                                        style="color: red;">*</span></label>
                                <multiselect @input="get_name()" style="margin-right: 10px;" v-model="emp_code"
                                    :options="emp_codes"></multiselect>
                                <span style="color: #db4437; font-size: 11px" v-if="emp_code == '' || emp_name == ''">{{
                                    e_emp_code }}</span>
                            </div>
                            <div class="col-md-6 col-12">
                                <label class="form-label" for="modalAddCardName">Petty Cash Limit<span
                                        style="color: red;">*</span></label>
                                <input type="number" placeholder="Type Patty Cash Limit" v-model="pcash_amount"
                                    class="form-control" style="" />
                                <span style="color: #db4437; font-size: 11px" v-if="pcash_amount == ''">{{ Amount_error
                                    }}</span>
                                <label hidden
                                    v-if="pcash_amount != '' && emp_code != '' && emp_name != ''">{{ close_model='modal' }}</label>
                            </div>
                            <div class="col-12 text-center">
                                <button type="submit" :disabled="disabled" @click="delay()"
                                    class="btn btn-primary bg-primary me-1 mt-1" :data-bs-dismiss='close_model'>
                                    Create
                                </button>
                                <button type="reset" class="btn btn-outline-secondary mt-1" data-bs-dismiss="modal"
                                    aria-label="Close">
                        ...
                        <div class="mb-2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" readonly class="form-control"  v-model="p_accountid" />
                                </div>
                                <div class="col-md-6">
