    ...
    <div>
        ...
        <div class="app-content content">
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-md-12 order-1 order-md-0">
                                    <!-- User Card -->
                                    <div v-if="hasPermission('Accounts Configurations  general Accounts Configuration')"
                                        class="card top-radius bottom-radius border-0">
                                        <div class="card-body">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-12 col-sm-3 mb-1">
                                                                            <label class="form-label"
                                                                                for="accountFirstName">Customer
                                                                                Invoice</label>
                                                                            <label style="color: #d93025">*</label>
                                                                            <input class="form-control"
                                                                                v-model="customer_inv" placeholder="" />
                                                                            <span
                                                                        ...
                                                                        <div class="col-12 col-sm-2 mb-1">
                                                                            <label class="form-label"
                                                                                for="accountFirstName">Customer</label>
                                                                            <label style="color: #d93025">*</label>
                                                                            <input class="form-control"
                                                                                v-model="customer_pre" placeholder="" />
                                                                            <span
                                                                                style="color: #db4437; font-size: 11px"
                                                                                v-if="
                                                                                    customer_pre == '' ||
                                                                        ...
                                                                        <div class="col-12 col-sm-2 mb-1">
                                                                            <label class="form-label"
                                                                                for="accountFirstName">Quotation</label>
                                                                            <label style="color: #d93025">*</label>
                                                                            <input class="form-control"
                                                                                v-model="quotation" placeholder="" />
                                                                            <span
                                                                                style="color: #db4437; font-size: 11px"
                                                                                v-if="
                                                                                    quotation == '' ||
                                                                        ...
                                                                        <div class="col-12 col-sm-3 mb-1">
                                                                            <label class="form-label"
                                                                                for="accountFirstName">Purchase
                                                                                Order</label>
                                                                            <label style="color: #d93025">*</label>
                                                                            <input class="form-control"
                                                                                v-model="vendor_inv" placeholder="" />
                                                                            <span
                                                                                style="color: #db4437; font-size: 11px"
                                                                                v-if="
                                                                                    vendor_inv == '' ||
                                                                        ...
                                                                        <div class="col-12 col-sm-3 mb-1">
                                                                            <label class="form-label"
                                                                                for="accountFirstName">Debit
                                                                                Notes</label>
                                                                            <label style="color: #d93025">*</label>
                                                                            <input class="form-control"
                                                                                v-model="vendor_debit" placeholder="" />
                                                                            <span
                                                                                style="color: #db4437; font-size: 11px"
                                                                                v-if="
                                                                                    vendor_debit == '' ||
                                                                        ...
                                                                        <div class="col-12 col-sm-2 mb-1">
                                                                            <label class="form-label"
                                                                                for="accountFirstName">Vendor</label>
                                                                            <label style="color: #d93025">*</label>
                                                                            <input class="form-control"
                                                                        ...
                                                                        <div class="col-12 col-sm-2 mb-1">
                                                                            <label class="form-label"
                                                                                for="accountFirstName">Payment
                                                                                Voucher</label>
                                                                            <label style="color: #d93025">*</label>
                                                                            <input class="form-control"
                                                                                v-model="vendor_pre" placeholder="" />
                                                                            <span
                                                                                style="color: #db4437; font-size: 11px"
                                                                                v-if="
                                                                                    vendor_pre == '' ||
                                                                        ...
                                                                        <div class="col-12 col-sm-2 mb-1">
                                                                            <label class="form-label"
                                                                                for="accountFirstName">Requistion</label>
                                                                            <label style="color: #d93025">*</label>
                                                                            <input class="form-control"
                                                                                v-model="requistion" placeholder="" />
                                                                            <span
                                                                                style="color: #db4437; font-size: 11px"
                                                                                v-if="requistion == '' || requistion.length > 4">{{
                                                                        ...
                                                                        <div class="col-12 col-sm-2 mb-1">
                                                                            ...
                                                                            <span
                                                                                style="color: #db4437; font-size: 11px"
                                                                                v-if="journal_voucher == '' || journal_voucher.length > 4">{{
                                                                                journal_voucher_error }}</span>
                                                                        </div>
                                                                        <div class="col-12 col-sm-2 mb-1">
                                                                            <label class="form-label"
                                                                                for="accountFirstName">Curriences</label>
                                                                            <label style="color: #d93025">*</label>
                                                                            <input class="form-control"
                                                                                v-model="currency" placeholder="" />
                                                                            <span
                                                                                style="color: #db4437; font-size: 11px"
                                                                                v-if="currency == ''">{{ currency_error
                                                                                }}</span>
                                                                        </div>
                                                                        <div class="col-12 col-sm-2 mb-1">
                                                                            <label class="form-label"
                                                                                for="accountFirstName">GRN</label>
                                                                            <label style="color: #d93025">*</label>
                                                                            <input class="form-control" v-model="grn"
                                                                                placeholder="" />
                                                                            <span
                                                                                style="color: #db4437; font-size: 11px"
                                                                                v-if="grn == ''">{{ grn_error }}</span>
                                                                        </div>
                                                                        <div class="col-12 col-sm-4 mb-1"></div>
                                                                        <div class="col-12 col-sm-3 mb-1"
                                                                            style="padding-top: 25px">
                                                                            <button type="submit" :disabled="disabled"
                                                                                @click="delay()" style="width: 100%"
                                                                                class="btn btn-primary bg-primary me-1 mt-1">
                                                                                Update
                                                                            </button>
                                                                        </div>
                                                                    </div>
                                    ...
                                    <section class="app-user-view-account">
                                        <div class="row">
                                            <!-- User Sidebar -->
                                            <div v-if="hasPermission('Accounts Configurations  general Child Companies')"
                                                class="col-xl-6 col-lg-6 col-md-7 order-1 order-md-0">
                                            ...
                                            <!--/ User Sidebar -->
                                            <!-- User Sidebar -->
                                            <div v-if="hasPermission('Accounts Configurations  general Departments')"
                                            ...
                                            <div v-if="hasPermission('Accounts Configurations  general Units')"
                                                class="col-xl-6 col-lg-6 col-md-6 order-1 order-md-0">
                                                <div class="card top-radius bottom-radius border-0">
                                                    <div class="card-body">
                                                        <section id="accordion-with-border">
                                            ...
                                            <!--/ User Sidebar -->
                                            <div v-if="hasPermission('Accounts Configurations  general Purchase Orders')"
                                                class="col-xl-6 col-lg-6 col-md-6 order-1 order-md-0">
                                                <div class="card top-radius bottom-radius border-0">
                                                    <div class="card-body">
                                                        <section id="accordion-with-border">
                                                                                            ...
                                                                                            <tr
                                                                                                ...
                                                                                                <td
                                                                                                    ...
                                                                                                    <span
                                                                                                        ...
                                                                                                        data-bs-target="#po_close"
                                                                                                        style="cursor:pointer;"
                                                                                                        class="badge  rounded-pill badge-light-danger">Open</span>
                                                                                                </td>
                                                                                                <td v-else>
                                                                                                    <span
                                                                                                        style="cursor:context-menu;"
                                                                                                        class="badge  rounded-pill badge-light-success">Working</span>
                                                                                                </td>
                                                                                            </tr>
                                                                                        </tbody>
                                                                                    </table>
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header bg-transparent">
                                                            <h3 class="text-center mb-1" id="addNewCardTitle">Create
                                                                Child Company</h3>
                                                        ...
                                                        <div class="modal-body px-sm-5 mx-50 pb-5">
                                                            <div id="addNewCardValidation" class="row gy-1 gx-2 mt-75">
                                                                <div class="col-12">
                                                                    <label class="form-label"
                                                                        for="modalAddCardName">Company Name</label>
                                                                    <span
                                                                    ...
                                                                    <span style="color: #db4437; font-size: 11px"
                                                                        v-if="company_name == ''">{{ company_name_error
                                                                        }}</span>
                                                                </div>
                                                                <div class="col-md-12">
                                                                    <label class="form-label"
                                                                        for="modalAddCardName">Phone No.</label>
                                                                    <span
                                                                        style="color: #DB4437; font-size: 11px;">*</span>
                                                                    <input v-model="phone_no" type="number"
                                                                        id="modalAddCardName" class="form-control"
                                                                        placeholder="Please type phone number" />
                                                                    <span style="color: #db4437; font-size: 11px"
                                                                        v-if="phone_no == ''">{{ phone_no_error
                                                                        }}</span>
                                                                </div>
                                                                <div class="col-12 col-sm-12 mb-1">
                                                                    <label class="form-label" for="basicSelect">Email
                                                                        Address</label>
                                                                    <input v-model="company_email" type="email"
                                                                        id="modalAddCardName" class="form-control"
                                                                ...
                                                                <div class="col-md-12">
                                                                    <label class="form-label"
                                                                        for="modalAddCardName">Address</label>
                                                                    <input v-model="company_address" type="text"
                                                                        id="modalAddCardName" class="form-control"
                                            ...
                                            <div class="modal fade" id="po_close" tabindex="-1"
                                                aria-labelledby="addNewCardTitle" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h4 class="modal-title" id="myModalLabel18">Confirm closing
                                                                of Purchase Order</h4>
                                                            <button type="button" class="btn-close"
                                                                data-bs-dismiss="modal" aria-label="Close"></button>
                                                        </div>
                                                        <div class="modal-body">
                                                            Do you want to close purchase order
                                                            <label>{{ this.pocode }}</label>?
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" @click="close_po(p_orders1)"
                                            ...
                                            <div class="modal fade" id="leavetype" tabindex="-1"
                                                aria-labelledby="addNewCardTitle" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header bg-transparent">
                                                            <h3 class="text-center mb-1" id="addNewCardTitle">Add New
                                                                Project</h3>
                                                            <button type="button" class="btn-close"
                                                                data-bs-dismiss="modal" aria-label="Close"></button>
                                                        </div>
                                                        <div class="modal-body px-sm-5 mx-50 pb-5">
                                                            <div id="addNewCardValidation" class="row gy-1 gx-2 mt-75">
                                                                <div class="col-12">
                                                                    <label class="form-label"
                                                                        for="modalAddCardName">Project Name</label>
                                                                    <span
                                                                        style="color: #DB4437; font-size: 11px;">*</span>
                                                                    ...
                                                                    <span style="color: #db4437; font-size: 11px"
                                                                        v-if="project_name == ''">{{ project_name_error
                                                                        }}</span>
                                                                </div>

                                                                <div class="col-12 text-center">
                                                                    <button type="submit" :disabled="disabled2"
                                                                        @click="delay2()"
                                                                        class="btn btn-primary bg-primary me-1 mt-1">Submit</button>
                                                                    <button type="reset"
                                                                        class="btn btn-outline-secondary mt-1"
                                                                        data-bs-dismiss="modal" aria-label="Close">
                                                                        Close
                                            ...
                                            <div class="modal fade" id="leavetype2" tabindex="-1"
                                                aria-labelledby="addNewCardTitle" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header bg-transparent">
                                                            <h3 class="text-center mb-1" id="addNewCardTitle">Link New
                                                                Project</h3>
                                                            <button type="button" class="btn-close"
                                                                data-bs-dismiss="modal" aria-label="Close"></button>
                                                        </div>
                                                        <div class="modal-body px-sm-5 mx-50 pb-5">
                                                            <div id="addNewCardValidation" class="row gy-1 gx-2 mt-75">
                                                                <div class="col-12">
                                                                    ...
                                                                    <span
                                                                        style="color: #DB4437; font-size: 11px;">*</span>
                                                                    <input type="text" v-model="project_name1" readonly
                                                                        class="form-control"
                                                                        placeholder="Project Names">
                                                                    <span style="color: #db4437; font-size: 11px"
                                                                        v-if="project_name == ''">{{ project_name_error
                                                                ...
                                                                <div class="invoice-customer">
                                                                    <multiselect
                                                                        ...
                                                                        id="FilterTransaction" :show-labels="false"
                                                                        :multiple="true" v-model="dept_name"
                                                                        :options="options">
                                                                    </multiselect>
                                                                </div>
                                                                <div class="invoice-customer">
                                                                    <multiselect
                                                                        style="margin-right: 10px; font-size: 12px;"
                                                                        id="FilterTransaction" :show-labels="false"
                                                                        v-model="account_idname" :options="options2">
                                                                    </multiselect>
                                                                </div>


                                                                <div class="col-12 text-center">
                                                                    <button type="submit" :disabled="disabled3"
                                                                        @click="delay3()"
                                                                        class="btn btn-primary bg-primary me-1 mt-1">Submit</button>
                                                                    <button type="reset"
                                                                        class="btn btn-outline-secondary mt-1"
            ...
            <div class="row">
                ...
                <div v-if="hasPermission('Accounts Configurations  general Link COA & Department')"
                    ...
                    <div class="modal-body px-sm-5 mx-50 pb-5">
                        <div id="addNewCardValidation" class="row gy-1 gx-2 mt-75">
                            <div class="col-12">
                                ...
                                <span style="color: #db4437; font-size: 11px" v-if="department == ''">{{
                                    department_name_error }}</span>
                            </div>
                            <div class="col-12 text-center">
                                <button type="submit" :disabled="disabled6" @click="delay6()"
                                    class="btn btn-primary bg-primary me-1 mt-1">Submit</button>
                    ...
                    <div class="modal-body px-sm-5 mx-50 pb-5">
                        <div id="addNewCardValidation" class="row gy-1 gx-2 mt-75">
                            <div class="col-12">
                                ...
                                <span style="color: #db4437; font-size: 11px" v-if="unit_name == ''">{{ unit_name_error
                                    }}</span>
                            </div>
                            <div class="col-12 text-center">
                                <button type="submit" :disabled="disabled6" @click="delay7()"
                                    class="btn btn-primary bg-primary me-1 mt-1">Submit</button>
                                <button type="reset" class="btn btn-outline-secondary mt-1" data-bs-dismiss="modal"
                                    aria-label="Close">
                                    Close
