<template>
                    ...
                    <div class="card border-0 top-radius bottom-radius bottom-0 m-0 p-3">
                        <div class="card-body  pt-3 pb-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2 d-flex align-items-center btn_m_top">
                                    <!-- <div style="height:27px;"></div> -->
                                    <button @click="search_candidate()"
                                        class="dt-button add-new btn btn-primary bg-primary bg-primary py-2 px-5"
                                        tabindex="0" type="button"><span>Search</span></button>
                                </div>
                                <div
                                    class="col-sm-12 col-md-3 col-lg-3 ps-xl-75 ps-0  d-flex align-items-center justify-content-end btn_m_top">
                                    <div v-if="hasPermission('Add new Candidates')" style="float:left;">
                                        <router-link to=""
                                            class="dt-button add-new btn btn-primary bg-primary bg-primary p-2"
                    ...
                    <div class="container my-4 p-0">
                        ...
                        <div v-for='candidates1 in candidates'
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <img :src="candidates1.Photo ? '/uploads/candidate_photos/' + candidates1.Photo : '/app-assets/images/portrait/small/avatar-s-9.jpg'"
                                    alt="avatar" class="rounded-circle me-3" height="55" width="55" />
                                <div class="flex-grow-1">

                                    <h5 class="mb-1">{{ candidates1.CandName }}</h5>
                                    <small class=" text-primary btn-outline-info top-radius bottom-radius px-2 mb-2 ">{{
                                        candidates1.totalScore }}%
                                        Overall</small>
                                    <p class="mb-0 mt-2 text-muted">Applied at</p>
                                    <small class="text-muted"><strong>{{ formatDate(candidates1.CreatedOn) }}
                                            — {{ candidates1.City }}, {{ candidates1.Country }}</strong></small>
                                </div>
                                ...
                                <div class="modal-body pb-5 px-sm-5 pt-50">
                                    ...
                                    <form id="editUserForm" class="row gy-1 pt-75" onsubmit="return false">
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <input type="date" v-model="a_c_dob" class="form-control" />
                                        </div>
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <input type="text" v-model="a_c_university" class="form-control"
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <multiselect v-model="a_c_city" :options="cities" placeholder="Select city"
                                                label="city_name" track-by="id">
                                            </multiselect>
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <input type="text" v-model="a_c_country" class="form-control"
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <multiselect v-model="applied_via" :options="appliedViaOptions"
                                                placeholder="Select source" label="label" track-by="value"
  ...
  View Candidate
                    ...
                    <div id="view_candidate" class="offcanvas offcanvas-end " tabindex="-1"
                        ...
                        <div class="offcanvas-body">
                            ...
                            <div class="d-flex align-items-center mb-4">
                                <img :src="e_c_photo ? '/uploads/candidate_photos/' + e_c_photo : '/app-assets/images/portrait/small/avatar-s-9.jpg'"
                                    alt="avatar" class="rounded-circle me-3" height="55" width="55" />
                                <div class="ms-3">

                                    <p class="mb-0 fw-bolder" style="font-size: 1.2rem;">{{ e_c_name }} <span
                                            style="font-size: 0.9rem; margin-left: 2rem;"
                                            class=" btn-outline-primary top-radius bottom-radius px-2 mb-1 "> {{
                                ...
                                <div class="ms-auto d-flex align-items-center gap-2">
                                    ...
                                    <!-- <button class="btn btn-primary bg-primary btn-lg" data-bs-target="#sentmail"
                                        data-bs-toggle="modal">Send Mail</button> -->

                                    <button @click="openModal" class="btn btn-primary">Send Mail</button>
                            ...
                            <div class="row g-3">
                                <div class="col-md-8">
                                    <div class="card top-radius bottom-radius border-0 p-3">
                                        ...
                                        <div class="row text-muted">
                                            ...
                                            <div class="col-4">
                                                ...
                                                <p class="fw-bold">{{ applied_via_ui }}</p>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Candidate Score -->
                                    ...
                                    <div class="card p-3 mt-4 top-radius bottom-radius border-0">
                                        ...
                                        <div class="d-flex align-items-center gap-4">
                                            <div class="text-center">
                                                <h1 class="text-primary fw-bold mb-0">{{ candidate_score.TotalScore }}%
                                                </h1>
                                                <small class="text-muted">Overall Score</small>
                                            </div>
                                            <div class="flex-grow-1">
                                                <div class="d-flex justify-content-between small mb-1">
                                                    <span>Applying</span><span>{{ candidate_score.Progress.Applying
                                                    }}%</span>
                                                </div>
                                                <div class="progress mb-2" style="height: 6px;">
                                                    <div class="progress-bar bg-warning"
                                                        :style="{ width: candidate_score.Progress.Applying + '%' }">
                                                    </div>
                                                </div>

                                                <div class="d-flex justify-content-between small mb-1">
                                                    <span>First Interview</span><span>{{
                                                        candidate_score.Progress.FirstInterview }}%</span>
                                                </div>
                                                <div class="progress mb-2" style="height: 6px;">
                                                    <div class="progress-bar bg-warning"
                                                        :style="{ width: candidate_score.Progress.FirstInterview + '%' }">
                                                    </div>
                                                </div>

                                                <div class="d-flex justify-content-between small mb-1">
                                                    <span>Second Interview</span><span>{{
                                                        candidate_score.Progress.SecondInterview }}%</span>
                                                </div>
                                                <div class="progress mb-2" style="height: 6px;">
                                                    <div class="progress-bar bg-warning"
                                                        :style="{ width: candidate_score.Progress.SecondInterview + '%' }">
                                                    </div>
                                                </div>

                                                <div class="d-flex justify-content-between small mb-1">
                                                    <span>Final Interview</span><span>{{
                                                        candidate_score.Progress.FinalInterview }}%</span>
                                                </div>
                                                <div class="progress mb-2" style="height: 6px;">
                                                    <div class="progress-bar bg-warning"
                                                        :style="{ width: candidate_score.Progress.FinalInterview + '%' }">
                                                    </div>
                                                </div>

                                                <div class="d-flex justify-content-between small mb-1">
                                                    <span>Onboard</span><span>{{ candidate_score.Progress.Onboard
                                                    }}%</span>
                                                </div>
                                                <div class="progress" style="height: 6px;">
                                                    <div class="progress-bar bg-warning"
                                                        :style="{ width: candidate_score.Progress.Onboard + '%' }">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-4">
                                    <div class="card p-3 mb-3 top-radius bottom-radius border-0">
                                        ...
                                        <div class="text-muted small">
                                            ...
                                            <p>DOB: <span class="text-dark fw-bold"> {{ e_c_dob }}</span></p>
                                            <p>Gender: <span class="text-dark fw-bold">{{ e_c_gender }}</span></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card p-3 top-radius bottom-radius border-0">
                                        ...
                                        <div class="text-muted small">
                                            <p>University: <span class="text-dark fw-bold">{{ e_c_university }}</span>
                                            </p>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body pb-5 px-sm-5 pt-50">
                                    ...
                                    <form id="editUserForm" class="row gy-1 pt-75" onsubmit="return false">
                                        ...
                                        <div class="col-12 text-center mt-2 pt-50">
                                            <button :disabled="disabled1 || isSending" @click="sentmail" type="submit"
                    ...
                    <div id="sentmail" class="modal fade" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog modal-lg modal-dialog-centered modal-edit-user">
                            <div class="modal-content">
                                <div class="modal-header bg-transparent">
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                ...
                                <div class="modal-body pb-5 px-sm-5 pt-50">
                                    <div class="text-center mb-2">
                                        <h2 class="mb-1">Sent mail to <label>{{ e_c_name_h }}</label></h2>
                                    </div>
                                    <form id="sentMailForm" class="row gy-1 pt-75" onsubmit="return false">
                                        <div class="col-12 col-md-6">
                                            <label class="form-label">Candidate Name</label>
                                            <input disabled type="text" v-model="e_c_name" class="form-control"
                                                placeholder="Enter full name" />
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <select disabled v-model="e_c_post_title" class="form-select"
                                                aria-label="Default select example">
                                        ...
                                        <div class="col-12 col-md-6">
                                            <label class="form-label">Email</label>
                                            <input disabled type="text" v-model="e_c_email" class="form-control"
                                                placeholder="abc@xyz.com" />
                                            <span style="color: #DB4437; font-size: 11px;"
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <input type="text" v-model="e_c_contact_person" class="form-control"
                                        ...
                                        <div class="col-12">
                                            ...
                                            <textarea v-model="e_c_instructions" class="form-control" rows="3"
                    ...
                    <div class="offcanvas offcanvas-end" style="width: 70%;" tabindex="-1" id="editcandidate"
                        ...
                        <div class="offcanvas-body">
                            <form id="editUserForm" class="row gy-1" onsubmit="return false">
                                ...
                                <div class="col-12 col-md-6">
                                    <label class="form-label">Date of Birth</label>
                                    <input type="date" v-model="e_c_dob" class="form-control" />
                                </div>

                                <div class="col-12 col-md-6">
                                    <label class="form-label">Gender</label><br />
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" value="Male" v-model="e_c_gender">
                                ...
                                <div class="col-12 col-md-6">
                                    <label class="form-label">University</label>
                                    <input type="text" v-model="e_c_university" class="form-control"
                                        placeholder="University name" />
                                </div>
                                ...
                                <div class="col-12 col-md-6">
                                    <label class="form-label">City</label>
                                    <select v-model="e_c_city" class="form-select">
                                        <option disabled value="">Select City</option>
                                        <option v-for="city in cities" :value="city.city_name">{{ city.city_name }}
                                        </option>
                                    </select>
                                </div>
                                ...
                                <div class="col-12 col-md-6">
                                    <label class="form-label">Country</label>
                                    <input type="text" v-model="e_c_country" class="form-control"
                                        placeholder="Country name" />
                                </div>
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <span class="text-danger small"
                                        v-if="e_c_post_title == '' || e_c_post_title == 'Select'">{{ ed_pst_error
                                        }}</span>
                                </div>
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <!-- <input type="text" v-model="applied_via" class="form-control"
                                        placeholder="Applied via" /> -->
                                    <multiselect v-model="applied_via" :options="appliedViaOptions"
                                        placeholder="Select source" label="label" track-by="value"></multiselect>
                                </div>
                                ...
                                <div class="col-12" style="margin-top:50px !important;">
                                    <label class="form-label">Skill Set</label>
                                    <vue-editor v-model="e_c_skill" placeholder="Add Skills"></vue-editor>
                                </div>

                                <div class="col-12 text-center mt-2 pt-2" style="margin-top:50px !important;">
                    ...
                    <div id="editcandidate" class="modal fade" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog modal-lg modal-dialog-centered modal-edit-user">
                            <div class="modal-content">
                                ...
                                <div class="modal-body pb-5 px-sm-5 pt-50">
                                    <div class="text-center mb-2">
                                        <h2 class="mb-1">Send Mail to <label>{{ e_c_name_h }}</label></h2>
                                    </div>
                                    <form id="editUserForm" class="row gy-1 pt-75" onsubmit="return false">
                                        <div class="col-12 col-md-6">
                                            <label class="form-label">Candidate Name</label>
                                    ...
                                    <div class="text-center mb-2">
                                        ...
                                        <div class="col-12 text-center" style="float:right; text-align:center;">
                                            <select id="modalAddressCountry" v-model="e_c_status" class=" form-select">
                                                <option
                                                    v-if="e_c_status !== 'Applied' && e_c_status !== 'Shortlisted' && e_c_status !== 'Rejected' && e_c_status !== 'Pending'"
                                                    :value="e_c_status" hidden>
                                                    {{ e_c_status }}
                                                </option>
...
export default {
    ...
    data() {
        return {
            ...
            formKeys: [
                'a_c_name', 'a_c_father', 'a_c_mobile', 'a_c_email', 'a_c_dob', 'a_c_gender',
                'a_c_university', 'a_c_city', 'a_c_country', 'a_c_address', 'a_c_crt_salary',
                'a_c_job_title', 'a_c_post_title', 'a_c_qualification', 'a_c_skill',
                'a_c_experiance', 'a_c_exp_salary', 'applied_via'
            ],
    ...
    watch: {
        a_c_name(val) { localStorage.setItem('a_c_name', val); },
        a_c_father(val) { localStorage.setItem('a_c_father', val); },
        a_c_mobile(val) { localStorage.setItem('a_c_mobile', val); },
        a_c_email(val) { localStorage.setItem('a_c_email', val); },
        a_c_dob(val) { localStorage.setItem('a_c_dob', val); },
        a_c_gender(val) { localStorage.setItem('a_c_gender', val); },
        a_c_university(val) { localStorage.setItem('a_c_university', val); },
        a_c_city(val) { localStorage.setItem('a_c_city', JSON.stringify(val)); },
        a_c_country(val) { localStorage.setItem('a_c_country', val); },
        a_c_address(val) { localStorage.setItem('a_c_address', val); },
        a_c_crt_salary(val) { localStorage.setItem('a_c_crt_salary', val); },
        a_c_job_title(val) { localStorage.setItem('a_c_job_title', val); },
        a_c_post_title(val) { localStorage.setItem('a_c_post_title', val); },
        a_c_qualification(val) { localStorage.setItem('a_c_qualification', val); },
        a_c_skill(val) { localStorage.setItem('a_c_skill', val); },
        a_c_experiance(val) { localStorage.setItem('a_c_experiance', val); },
        a_c_exp_salary(val) { localStorage.setItem('a_c_exp_salary', val); },
        applied_via(val) { localStorage.setItem('applied_via', val); }
    },
    methods: {
        ...
        delay2() {
            this.disabled2 = true
            console.log(this.e_c_status, "status ha ye ");
        ...
        openModal() {
            // this.cid = this.cid;
            // this.fetch_interview_detail(this.cid);
            const modal = new bootstrap.Modal(document.getElementById('sentmail'), {
                backdrop: 'static',
                keyboard: false
            });
            modal.show();
        ...
        sentmail() {
            this.isSending = true;
            axios.post('/send_candidate_mail', {
                mycid: this.cid,
                name: this.e_c_name,
                email: this.e_c_email,
                post_title: this.e_c_post_title,
                contact_person: this.e_c_contact_person,
                location: this.ed_i_location,
                comments: this.ed_i_comment,
                date: this.ed_i_date,
                from: this.ed_i_from,
                to: this.ed_i_to,
                instructions: this.e_c_instructions
            })
                .then(response => {
                    if (response.data.message === 'Candidate already shortlisted!') {
                        this.$toastr.e(response.data.message, 'Notice');
                    } else {
                        this.$toastr.s(response.data.message, 'Success');

                        // Modal close & cleanup
                        const modalEl = document.getElementById('sentmail');
                ...
                .catch(error => {
                    this.isSending = false;
                    console.error(error);
                    this.$toastr.e("Failed to send email", "Error");
                });
        },
        // fetch_interview_detail(id) {
        //     this.id2 = id;
        //     axios.get('/fetch_interviews_cand/' + this.id2)
        //         .then(responce => {
        ...
        // },
        getCitiesList() {
            axios.get('view_all_cities')
                .then(response => {
                    this.cities = response.data;
                    console.log(this.cities, "all citys ");
                    // agar response.data.data me cities ka array ho
                })
                .catch(error => { });
        },
        fetch_candidate_detail(id, candidate) {
            ...
            axios.get('fetch_candidates/' + this.id1)
                .then(responce => {
                    ...
                    this.applied_via = this.appliedViaOptions.find(opt => opt.value === responce.data[0].AppliedVia) || null;

                    this.applied_via_ui = (this.appliedViaOptions.find(opt => opt.value === responce.data[0].AppliedVia) || {}).value || '';
                    ...
                    this.e_c_dob = responce.data[0].DOB;
                    this.e_c_gender = responce.data[0].Gender;
                    this.e_c_university = responce.data[0].University;
                    this.e_c_city = responce.data[0].City;
                    this.e_c_country = responce.data[0].Country;
                    this.e_c_photo = responce.data[0].Photo;


                    let score = 0;

                    // normalize statuses
                    let firstStatus = (responce.data[0].firstInterviewstatus || '').toLowerCase();
                    let secondStatus = (responce.data[0].secondInterviewstatus || '').toLowerCase();
                    let finalStatus = (responce.data[0].finalInterviewstatus || '').toLowerCase();
                    let hireStatus = responce.data[0].hire_sts;

                    // score calculation
                    if (firstStatus === 'passed') score += 25;
                    if (secondStatus === 'passed') score += 25;
                    if (finalStatus === 'passed') score += 25;
                    if (hireStatus == 1) score += 25;

                    // assign to candidate_score object
                    this.candidate_score = {
                        OverallRating: responce.data[0].Rating,
                        Progress: {
                            Applying: 20,
                            FirstInterview: firstStatus === 'passed' ? 100 : 0,
                            SecondInterview: secondStatus === 'passed' ? 100 : 0,
                            FinalInterview: finalStatus === 'passed' ? 100 : 0,
                            Onboard: hireStatus == 1 ? 100 : 0
                        },
                        TotalScore: score
                    };
            ...
            axios.post('./update_status', {
                ...
                .then(data => {
                    if (data.data == 'Status updated!') {
                        ...
                        this.getCandidates(this.pagination.current_page);
                    }
                })
        ...
        //             applied_via: this.applied_via?.value || '',


        //             e_c_dob: this.e_c_dob,
        //             e_c_gender: this.e_c_gender,
        //             e_c_university: this.e_c_university,
        //             e_c_city: this.e_c_city,
        //             e_c_country: this.e_c_country,
        //         })
        //             .then(data => {
        ...
        update_candidate() {
            ...
            if (this.e_c_name == '' || this.e_c_father == '' || !this.validEmail(this.e_c_email) || this.e_c_mobile == '' || this.e_c_post_title == '' || this.e_c_post_title == "Select") {
                ...
                this.e_c_qualification = this.e_c_qualification.replace(/<\/?p[^>]*>/gi, '').trim();
                this.e_c_skill = this.e_c_skill.replace(/<\/?p[^>]*>/gi, '').trim();
                console.log("Applied Via Value: ", this.applied_via?.value);
                axios.post('./update_candidate', {
                    mycid: this.cid,
                    e_c_name: this.e_c_name,
                    e_c_father: this.e_c_father,
        ...
        //             a_c_dob: this.a_c_dob,
        //             a_c_gender: this.a_c_gender,
        //             a_c_university: this.a_c_university,
        //             a_c_city: this.a_c_city,
        //             a_c_country: this.a_c_country
        //         })
        //             .then(data => {
        ...
        add_cdt() {
            ...
            if (this.a_c_name == '' || this.a_c_father == '' || this.a_c_mobile == '' || this.a_c_email == '' || this.a_c_experiance == '' || !this.validEmail(this.a_c_email) || this.a_c_post_title == '' || this.a_c_qualification == '') {
                ...
                if (this.a_c_name == '') this.name_error = 'Full name required.'; else this.name_error = '';
                if (this.a_c_father == '') this.father_error = 'Father name required.'; else this.father_error = '';
                if (this.a_c_email == '') this.a_email_error = 'Email required.';
                else if (!this.validEmail(this.a_c_email)) this.a_email_error = 'Enter valid e-mail address!';
                else this.a_email_error = '';
                if (this.a_c_experiance == '') this.exp_error = 'Experiance required.'; else this.exp_error = '';
                if (this.a_c_mobile == '') this.mobile_error = 'Mobile number required.'; else this.mobile_error = '';
                if (this.a_c_post_title == '') this.pst_error = 'Select post to apply.'; else this.pst_error = '';
                if (this.a_c_qualification == '') this.qual_error = 'Please enter latest qualification.'; else this.qual_error = '';
            }
            else {
                let formData = new FormData();

                formData.append("a_c_name", this.a_c_name);
                formData.append("a_c_father", this.a_c_father);
                formData.append("a_c_mobile", this.a_c_mobile);
                formData.append("a_c_email", this.a_c_email);
                formData.append("a_c_address", this.a_c_address);
                formData.append("a_c_job_title", this.a_c_job_title);
                formData.append("a_c_experiance", this.a_c_experiance);
                formData.append("star_value", this.star_value);
                formData.append("a_c_crt_salary", this.a_c_crt_salary);
                formData.append("a_c_job_id", this.a_c_post_title);
                formData.append("a_c_qualification", this.a_c_qualification);
                formData.append("a_c_skill", this.a_c_skill);
                formData.append("a_c_exp_salary", this.a_c_exp_salary);
                // formData.append("applied_via", this.applied_via);
                formData.append("applied_via", this.applied_via?.value || '');

                formData.append("a_c_dob", this.a_c_dob);
                formData.append("a_c_gender", this.a_c_gender);
                formData.append("a_c_university", this.a_c_university);
                // formData.append("a_c_city", this.a_c_city);
                formData.append("a_c_city", this.a_c_city.city_name);
                formData.append("a_c_country", this.a_c_country);
                if (this.image) {
                    formData.append("photo", this.image);
                }

                axios.post('./candidate', formData, {
                    ...
                    .then(data => {
                        if (data.data == 'Candidate added Successfully!') {
                            ...
                            this.a_c_city = [];
                            this.a_c_country = '';
                            this.image = ''; // ✅ image bhi reset kar do
                            this.url = null;
                            this.name_error = '';
                            this.father_error = '';
                            this.a_email_error = '';
                            ...
                            localStorage.removeItem('a_c_name');
                            localStorage.removeItem('a_c_father');
                            localStorage.removeItem('a_c_mobile');
                            localStorage.removeItem('a_c_email');
                            localStorage.removeItem('a_c_dob');
                            localStorage.removeItem('a_c_gender');
                            localStorage.removeItem('a_c_university');
                            localStorage.removeItem('a_c_city');
                            localStorage.removeItem('a_c_country');
                            localStorage.removeItem('a_c_address');
                            localStorage.removeItem('a_c_crt_salary');
                            localStorage.removeItem('a_c_job_title');
                            localStorage.removeItem('a_c_post_title');
                            localStorage.removeItem('a_c_qualification');
                            localStorage.removeItem('a_c_skill');
                            localStorage.removeItem('a_c_experiance');
                            localStorage.removeItem('a_c_exp_salary');
                            localStorage.removeItem('applied_via');
        ...
        getCandidates(page) {
            axios.get(`candidate_detail2?page=${page}`)
                .then(response => {
                    ...
                    //     let score = 0;
                    //     if ((candidate.firstInterviewstatus || '').toLowerCase() === 'passed') score += 25;
                    //     if ((candidate.secondInterviewstatus || '').toLowerCase() === 'passed') score += 25;
                    //     if ((candidate.finalInterviewstatus || '').toLowerCase() === 'passed') score += 25;
                    //     if (candidate.hire_sts == 1) score += 25;
    ...
    mounted() {
        ...
        this.a_c_name = localStorage.getItem('a_c_name') || '';
        this.a_c_father = localStorage.getItem('a_c_father') || '';
        this.a_c_mobile = localStorage.getItem('a_c_mobile') || '';
        this.a_c_email = localStorage.getItem('a_c_email') || '';
        this.a_c_dob = localStorage.getItem('a_c_dob') || '';
        this.a_c_gender = localStorage.getItem('a_c_gender') || '';
        this.a_c_university = localStorage.getItem('a_c_university') || '';
        this.a_c_city = JSON.parse(localStorage.getItem('a_c_city')) || [];
        this.a_c_country = localStorage.getItem('a_c_country') || '';
        this.a_c_address = localStorage.getItem('a_c_address') || '';
        this.a_c_crt_salary = localStorage.getItem('a_c_crt_salary') || '';
        this.a_c_job_title = localStorage.getItem('a_c_job_title') || '';
        this.a_c_post_title = localStorage.getItem('a_c_post_title') || '';
        this.a_c_qualification = localStorage.getItem('a_c_qualification') || '';
        this.a_c_skill = localStorage.getItem('a_c_skill') || '';
        this.a_c_experiance = localStorage.getItem('a_c_experiance') || '';
        this.a_c_exp_salary = localStorage.getItem('a_c_exp_salary') || '';
        this.applied_via = localStorage.getItem('applied_via') || '';
