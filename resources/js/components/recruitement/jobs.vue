        ...
        <div class="app-content content ">
            ...
            <div class="content-wrapper container-xxl p-0">
                ...
                <div class="content-body">
                    ...
                    <p class="mb-2">
                        Search for a role that equips you with the tools you need to deliver pioneering products to the
                        world. And embark on a journey that takes you from ambitious <br />
                        entrepreneur to global tastemaker. Be a force for change and a force for good. Find the career
                        for you.
                    </p> -->
                    <!-- Role cards -->
                    <div class="row pb-3">
                        <div class="col-xl-4 col-lg-6 col-md-6 ms-auto">
                            ...
                            <!-- <div class="col-sm-5">
                                        <div class="d-flex align-items-end justify-content-center h-100">
                                            <img src="app-assets/images/pages/job_open1.jpg" class="img-fluid mt-2"
                                                alt="Image" width="85" />
                                        </div>
                                    </div> -->
                            <!-- <div class="col-sm-7"> -->
                            ...
                            <div class="card border-0">
                                <div class="card-body ">
                                    <div class="d-flex justify-content-between ">
                                        <span><span v-if="jobs1.JobNumber < 2">Only</span><span v-else>Total</span>
                                            {{ jobs1.JobNumber }} <span v-if="jobs1.JobNumber < 2">vacancy</span><span
                                        ...
                                        <div class="dropdown chart-dropdown ">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end" style="">
                                                <a class="dropdown-item" @click="fetch_job_detail(jobs1.JobID)"
                                                    data-bs-toggle="modal" data-bs-target="#editjob">Edit</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="d-flex justify-content-between align-items-end mt-1 pt-25">
                                        <div class="role-heading">
                                            <router-link
                                                :to="{ name: 'recruitment_job_detail', params: { id: jobs1.JobID } }"
                                                style="text-decoration:none; color:black;">
                                                <h4 class="fw-bolder" title="View details" style="cursor:pointer;">
                                                    {{ jobs1.PostTitle }}</h4>
                                            </router-link>
                                            <small class="fw-bolder" style="color: #b9b9c3">
                                                <cite title="View applications"> Last date to apply is:
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-6 col-md-6" v-for="jobs1 in jobs" :key="jobs1.JobID">
                            <div class="card border-0  top-radius bottom-radius">
                                <div class="card-body">
                                    <div class="job_card top-radius bottom-radius px-3 py-3"
                                        ...
                                        <div class="d-flex justify-content-between align-items-start">
                                            <div>
                                                ...
                                                <small class="text-muted">{{ jobs1.Address }}</small>
                                            </div>
                                            <div class="dropdown">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                                    ...
                                                    <path
                                                        d="M9.5 2a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0zm0 6a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0zm0 6a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0z" />
                                                </svg>
                                        ...
                                        <div class="mt-2 d-flex flex-wrap gap-1">
                                            <span class="badge rounded-pill border border-warning text-warning">{{
                                                jobs1.Experience }}</span>
                                            <!-- <span class="badge rounded-pill border border-warning text-warning">Project
                                                work</span>
                                            <span
                                                class="badge rounded-pill border border-warning text-warning">Midlevel</span> -->
                                        </div>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mt-3 py-2 px-4">
                                        <div>
                                            <h4 class="fw-bolder mb-0">0{{ jobs1.JobNumber }}</h4>
                                            <small class="text-muted">Number of posts</small>
                                        </div>
                                        <router-link
                                            :to="{ name: 'recruitment_job_detail', params: { id: jobs1.JobID } }">
                                            <button class="btn btn-dark rounded-pill px-3">Details</button>
                                        </router-link>
                                    </div>
                                    <!-- data-bs-toggle="modal" data-bs-target="#deletejob" -->
                                </div>
                ...
                <!-- Post job modal -->
                <div class="modal fade" id="postjob" tabindex="-1" aria-labelledby="addNewAddressTitle"
                    aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body pb-5 px-sm-4 mx-50">
                                <h1 class="address-title text-center mb-1" id="addNewAddressTitle">Post a new job</h1>
                                ...
                                <form id="addNewAddressForm" style="text-align:left;" class="row gy-1 gx-2"
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <input type="text" v-model="posting_title" class="form-control"
                                            placeholder="Designation" />
                                        <span style="color: #DB4437; font-size: 11px;" v-if="posting_title == ''">{{
                                            title_error }}</span>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        ...
                                        <span style="color: #DB4437; font-size: 11px;" v-if="job_dept == ''">{{
                                            dept_error }}</span>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <label class="form-label">Number of posts</label>
                                        <span style="color: #DB4437; font-size: 11px;">*</span>
                                        <input type="number" v-model="no_post" class="form-control"
                                            placeholder="Number of posts" />
                                        <span style="color: #DB4437; font-size: 11px;" v-if="no_post == ''">{{ rec_error
                                            }}</span>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        ...
                                        <multiselect style="margin-right: 10px;" v-model="experiance"
                                            :show-labels="false" placeholder="Select" :options="options2">
                                        </multiselect>
                                        <span style="color: #DB4437; font-size: 11px;" v-if="experiance == ''">{{
                                            exp_error }}</span>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <label class="form-label">Date opened</label>
                                        <span style="color: #DB4437; font-size: 11px;">*</span>
                                        <input class="form-control date-mask" v-model="date_opened"
                                            placeholder="October 14, 2020" tabindex="0" type="date">
                                        <span style="color: #DB4437; font-size: 11px;" v-if="date_opened == ''">{{
                                            date_error }}</span>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <label class="form-label">Target date</label>
                                        <input class="form-control flatpickr-human-friendly input active"
                                            v-model="target_date" placeholder="October 14, 2020" tabindex="0"
                                            type="date">
                                    </div>
                                    <div class="col-12">
                                        <label class="form-label">Educational Requirement</label>
                                        <span style="color: #DB4437; font-size: 11px;">*</span>
                                        <vue-editor style="height:200px;" v-model="educational_requirements"
                                            placeholder="Add Educational Requirements"></vue-editor>
                                    </div>
                                    <div style="height:80px;"></div>
                                    <span style="color: #DB4437; font-size: 11px;"
                                        v-if="educational_requirements == ''">{{ edu_error }}</span>
                                    <div class="col-12 col-md-12">
                                        <label class="form-label">Skill set</label>
                                        <span style="color: #DB4437; font-size: 11px;">*</span>
                                        <vue-editor style="height:200px;" v-model="skill_set"
                                            placeholder="Add skillset"></vue-editor>
                                    </div>
                                    <div style="height:80px;"></div>
                                    <span style="color: #DB4437; font-size: 11px;" v-if="skill_set == ''">{{ skill_error
                                        }}</span>
                                    <div class="col-12 col-md-12">
                                        <label class="form-label">Duties & Responsibilities</label>
                                        <vue-editor style="height:200px;" v-model="duties"
                ...
                <!-- / Post job modal -->
                <!-- Edit job modal -->
                <div class="modal fade" id="editjob" tabindex="-1" aria-labelledby="addNewAddressTitle"
                    aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="modal-content">
                            <div class="modal-header bg-transparent">
                            ...
                            <div class="modal-body pb-5 px-sm-4 mx-50">
                                ...
                                <form id="addNewAddressForm" style="text-align:left;" class="row gy-1 gx-2"
                                    ...
                                    <div class="col-12 col-md-6">
                                        <label class="form-label">Posting title</label>
                                        <span style="color: #DB4437; font-size: 11px;">*</span>
                                        <input type="text" v-model="ed_post_title" class="form-control"
                                            placeholder="Posting title" />
                                        <span style="color: #DB4437; font-size:11px;" v-if="ed_post_title == ''">{{
                                            ed_title_error }}</span>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <label class="form-label">Department</label>
                                        ...
                                        <multiselect style="margin-right: 10px;" :show-labels="false"
                                            id="modalAddressCountry" placeholder="Select" v-model="ed_job_dept"
                                            :options="options1">
                                        </multiselect>
                                        <span style="color: #DB4437; font-size: 11px;" v-if="ed_job_dept == ''">{{
                                            ed_dept_error }}</span>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <label class="form-label">Number of posts</label>
                                        <span style="color: #DB4437; font-size: 11px;">*</span>
                                        <input type="number" v-model="ed_job_number" id="title_id" class="form-control"
                                            placeholder="Number of Posts" />
                                        <span style="color: #DB4437; font-size: 11px;" v-if="ed_job_number == ''">{{
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <multiselect style="margin-right: 10px;" v-model="ed_experiance"
                                            :show-labels="false" placeholder="Select" :options="options2">
                                        </multiselect>
                                        <span style="color: #DB4437; font-size: 11px;" v-if="ed_experiance == ''">{{
                                            ed_exp_error }}</span>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <label class="form-label">Date opened</label>
                                        <span style="color: #DB4437; font-size: 11px;">*</span>
                                        <input class="form-control date-mask" v-model="ed_date_opened"
                                            placeholder="October 14, 2020" tabindex="0" type="date">
                                        <span style="color: #DB4437; font-size: 11px;" v-if="ed_date_opened == ''">{{
                                            ed_date_error }}</span>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <label class="form-label">Target date</label>
                                        <input class="form-control flatpickr-human-friendly input active"
                                            v-model="ed_target_date" placeholder="October 14, 2020" tabindex="0"
                                            type="date">
                                    </div>
                                    <div class="col-12">
                                        <label class="form-label">Educational Requirement</label>
                                        <span style="color: #DB4437; font-size: 11px;">*</span>
                                        <vue-editor style="height:200px;" v-model="ed_educational_requirements"
                                            placeholder="Add Educational Requirements"></vue-editor>
                                    </div>
                                    <div style="height:80px;"></div>
                                    <span style="color: #DB4437; font-size: 11px;"
                                        v-if="ed_educational_requirements == ''">{{ ed_edu_error }}</span>
                                    <div class="col-12 col-md-12">
                                        <label class="form-label">Skill set</label>
                                        <span style="color: #DB4437; font-size: 11px;">*</span>
                                        <vue-editor style="height:200px;" v-model="ed_skill_set"
                                            placeholder="Add skillset"></vue-editor>
                                    </div>
                                    <div style="height:80px;"></div>
                                    <span style="color: #DB4437; font-size: 11px;" v-if="ed_skill_set == ''">{{
                                        ed_skill_error }}</span>
                                    <div class="col-12 col-md-12">
                                        <label class="form-label">Duties & Responsibilities</label>
                                        <vue-editor style="height:200px;" v-model="ed_duties"
                                            placeholder="Duties & Responsibilities"></vue-editor>
                                    </div>
                                    <div style="height:80px;"></div>
                                    <div class="col-12">
...
export default {
    ...
    methods: {
        ...
        submit_new_post() {
            if (this.no_post == '' || this.job_dept == '' || this.posting_title == '' || this.experiance == ''
