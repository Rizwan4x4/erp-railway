                    ...
                    <div class="auth-inner row m-0">
                        ...
                        <router-link class="brand-logo" style="width:300px;text-decoration:none" to="/">
                            <h2 class="brand-text text-primary ms-1">
                                <img class="img-fluid"
                                    src="app-assets/images/loginLogo.png" height="60" width="150" />
                                    <!-- app-assets/images/pages/art.png -->
                                <!-- <img class="img-fluid"
                        ...
                        <!-- <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                            <div class="w-100 d-lg-flex align-items-center justify-content-center px-5">
                                <img class="img-fluid" src="/public/app-assets/images/pages/login-v2.svg"
                                    alt="Login V2" />
                            </div>
                        </div> -->
                        <!-- /Left Text-->
                        ...
                        <div class="d-flex col-lg-6 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-6 px-xl-2 mx-auto">
                                <h2 class="card-title fw-bold mb-1">Welcome to ! 👋</h2>
                                ...
                                <div class="auth-login-form mt-2">
                                    ...
                                    <div class=" mb-3">
                                        ...
                                        <input type="text" v-model="username" class="form-control p-2"
                                            id="floatingInput" placeholder="abc@company.com">
                                    </div>
                                    <div class="mb-3">
                                        <label for="password" class="form-label">Password</label>
                                        <div class="input-group input-group-merge">
                                            <input :type="showPassword ? 'text' : 'password'" v-model="password"
                                                class="form-control p-2" id="password"
                                    ...
                                    <button @click="loginform()" class="btn btn-primary bg-primary w-100" tabindex="4">Sign
                                        in</button>
                        ...
                        <!-- /Login-->
                        <!-- Left Text-->
                        <div class="d-none d-lg-flex col-lg-6 align-items-center  bg-white" style="height: 100vh;">
                            <div class="w-100 d-lg-flex align-items-center justify-content-center p-3 bg-primary"
                                style="height: 96vh; background: url('app-assets/images/pages/art.png') no-repeat center center; background-size: cover; border-radius: 20px;">
                                <!-- content yahan -->
                            </div>
