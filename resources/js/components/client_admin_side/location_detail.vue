                                    ...
                                    <div class="card-body">
                                        <form class="form form-vertical">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="mb-1">
                                                        <label class="form-label" for="first-name-vertical">Location
                                                            Name</label>
                                                        <input id="first-name-vertical" v-model='location_name'
                                                            class="form-control" placeholder="Must Be Unique"
                                                            type="text">
                                                ...
                                                <div class="col-12">
                                                    <div class="mb-1">
                                                        <label class="form-label" for="email-id-vertical">Location
                                                            Address</label>
                                                        <input id="email-id-vertical" v-model="l_address"
                                                            class="form-control" placeholder="Complete Location Address"
                                                            type="text">
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                ...
                                                <div class="col-12">
                                                    <button v-if="hasPermission('Add new Location')"
                                                        class="btn btn-primary bg-primary me-1 waves-effect waves-float waves-light bg-primary"
                                                        type="button" @click="submit_location()">
                                                        Submit
                                                    </button>
                                ...
                                <div class="card top-radius bottom-radius border-0">
                                    <div class="card-body">
                                                ...
                                                <div
                                                    ...
                                                    <div class="me-1">
                                                        <div id="DataTables_Table_0_filter" class="dataTables_filter"
                                                            ...
                                                            <label>
                                                                <input v-model="keyword1" autocomplete="off"
                                                        ...
                                                        <td>
                                                            <div class="btn-group">
                                                                <a v-if="hasPermission('Location actions')"
                                                                    ...
                                                                    <svg class="feather feather-more-vertical font-small-4"
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-end">
                                                                    <button v-if="adsdata1.l_status == 'Active'"
                                                                        ...
                                                                        <svg class="feather feather-trash font-small-4 me-50"
                                                                            fill="none" height="24"
                                        ...
                                        <div style="text-align:center;padding-top:20px">
                                            <pagination :data="adsdata" :limit="limit"
                                                    ...
                                                    <div id="accordionWrapa50" aria-multiselectable="true"
                                                        ...
                                                        <!-- <div class="card"> -->
                                                            <div class="card-header px-0 py-3">
                                                                ...
                                                                <a v-if="hasPermission('Add new city')"
                                                                    class="btn btn-outline-primary waves-effect"
                                                                    data-bs-target="#addCity" data-bs-toggle="modal"
                                ...
                                <div class="modal-body px-sm-5 mx-50 pb-5">
                                    <form id="addNewCardValidation" class="row gy-1 gx-2 mt-75" onsubmit="return false">
                                        ...
                                        <div class="col-12 text-center">
                                            <button aria-label="Close" class="btn btn-primary bg-primary me-1 mt-1"
                                                data-bs-dismiss="modal" type="submit" @click="submit_cities()">Submit
                                            </button>
                                ...
                                <div class="modal-body px-sm-5 mx-50 pb-5">
                                    <form id="addNewCardValidation" class="row gy-1 gx-2 mt-75" onsubmit="return false">
                                        <div class="col-12">
                                            ...
                                            <input v-model="ed_location_name" class="form-control"
                                                placeholder="Location name" type="text">
                                            <span style="color:red;">{{ e_location_name }}</span>
                                        </div>
                                        <div class="col-12">
                                            <label class="form-label" for="modalAddCardName">Location Address</label>
                                            <input v-model="ed_l_address" class="form-control"
                                                placeholder="Location address" type="text">
                                        </div>
                                        <div class="col-12 text-center">
                                            <button aria-label="Close" class="btn btn-primary bg-primary me-1 mt-1"
                                                data-bs-dismiss="modal" type="submit" @click="update_location()">Submit
                                            </button>
                                            <button aria-label="Close" class="btn btn-outline-secondary mt-1"
                                                data-bs-dismiss="modal" type="reset">
                                                Cancel
